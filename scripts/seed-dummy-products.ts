...
const DUMMY_PRODUCTS = [
  // Mutual Funds
  {
    ...
    image_url:
      "https://via.placeholder.com/400x250/0f172a/10b981?text=HDFC+Flexi+Cap",
    rating: 4.8,
  ...
  // Loans
  {
    ...
    image_url:
      "https://via.placeholder.com/400x250/0f172a/3b82f6?text=SBI+Loan",
    rating: 4.5,
    features: {
      interest_rate: "11.00%",
      processing_fee: "1%",
  ...
  // Insurance
  {
    ...
    image_url:
      "https://via.placeholder.com/400x250/0f172a/ef4444?text=HDFC+Insurance",
    rating: 4.7,
    features: {
      cover: "₹5L - ₹50L",
...
async function seed() {
  ...
  if (
    ...
    console.error(
      "SAFETY ABORT: This seed script inserts dummy/placeholder data.",
    );
