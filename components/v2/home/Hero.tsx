  ...
  return (
    <section className="relative py-12 md:py-16 lg:py-20 px-4 lg:px-8 text-center overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(rgba(22,163,74,.03) 1px, transparent 1px), linear-gradient(90deg, rgba(22,163,74,.03) 1px, transparent 1px)",
          backgroundSize: "48px 48px",
        }}
      />
      {/* Green radial glow */}
      <div
        className="absolute top-[-20%] left-1/2 -translate-x-1/2 w-[800px] h-[600px] bg-[radial-gradient(ellipse,rgba(22,163,74,.06)_0%,rgba(22,163,74,.02)_40%,transparent_70%)] pointer-events-none"
        aria-hidden="true"
      />
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <p className="text-base md:text-lg text-gray-500 max-w-[560px] mx-auto mb-7 leading-relaxed">
          Compare credit cards, mutual funds, loans, and more across 50+ banks.
          Independent research. Free forever.
        </p>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2.5 md:gap-3 max-w-[840px] mx-auto">
          {CATEGORIES.map((cat) => {
            ...
            return (
              ...
              >
                <div
                  className="absolute inset-0 bg-gradient-to-br from-green-500/[.03] to-transparent opacity-0 group-hover:opacity-100 transition-opacity"
                  aria-hidden="true"
                />
                <div className="relative">
                  ...
                  <div className="text-xs font-semibold text-[--v2-ink]">
                    {cat.label}
                  </div>
