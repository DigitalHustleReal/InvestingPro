...
export default function ContextualNewsWidget({
  category,
  title,
}: ContextualNewsWidgetProps) {
                  ...
                  <div className="flex gap-2 mb-2">
                    {item.tags?.slice(0, 2).map((tag) => (
                      <Badge
                        key={tag}
                        variant="secondary"
                        className="text-[10px] px-1.5 py-0 h-5 bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 font-medium"
                      >
                        {tag}
                      </Badge>
                    ))}
...
const MOCK_FALLBACK: Record<string, NewsItem[]> = {
  general: [
    {
      id: "1",
      title: "Sensex Crosses 75,000 Mark for the First Time History",
      source: "BSE",
      timestamp: "Just Now",
      tags: ["Market"],
      url: "#",
    ...
    {
      id: "2",
      title: "Income Tax Filing Deadline Extended? Fact Check",
      source: "TaxGuru",
      timestamp: "2d ago",
      tags: ["Tax"],
      url: "#",
  ...
  credit_card: [
    {
      id: "1",
      title: "HDFC Bank Devalues Regalia Gold Rewards",
      source: "CardExpert",
      timestamp: "2h ago",
      tags: ["HDFC"],
      url: "#",
    ...
    {
      id: "2",
      title: "SBI Card Launches New 'Sprint' Application",
      source: "LiveMint",
      timestamp: "5h ago",
      tags: ["SBI"],
      url: "#",
