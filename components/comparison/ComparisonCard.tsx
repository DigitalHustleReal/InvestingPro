    ...
    <Card
      className={cn(
        ...
        isSelected
          ...
          : "border-stone-200 hover:border-primary-500 hover:-translate-y-1 hover:shadow-lg",
    ...
    >
      ...
      <div className="flex items-start justify-between mb-4">
        <div className="flex items-start gap-3 flex-1">
          {/* Logo */}
          {product.logo ? (
            <div className="flex-shrink-0 w-16 h-16 bg-white rounded-lg border border-stone-200 p-2 flex items-center justify-center">
              <Image
                src={product.logo}
                alt={product.name}
                width={60}
          ...
          <div className="flex-1 min-w-0">
            <h3 className={cn(
              "font-bold text-stone-900 tracking-tight leading-tight",
              isCompact ? "text-lg" : "text-xl"
            )}>
              {product.name}
            </h3>
            <p className={cn(
              "text-stone-600 mt-0.5",
