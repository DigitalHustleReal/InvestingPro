      ...
      <div className={`hidden lg:block ${className}`}>
        <div className="sticky top-24 animate-fadeIn">
          ...
          <div className="relative group">
            ...
            <div className="absolute -inset-0.5 bg-gradient-to-r from-emerald-500 via-blue-500 to-emerald-500 rounded-2xl opacity-30 group-hover:opacity-50 blur transition duration-500 animate-gradient-x"></div>
      ...
      <div className="lg:hidden fixed bottom-6 right-6 z-50">
        {!isVisible && (
          <button
            ...
            className="group relative p-4 bg-gradient-to-r from-emerald-500 to-blue-500 text-white rounded-full shadow-2xl hover:shadow-emerald-500/50 transition-all duration-300 hover:scale-110 animate-bounce-slow"
          >
            <div className="absolute -inset-1 bg-gradient-to-r from-emerald-500 to-blue-500 rounded-full blur opacity-50 group-hover:opacity-75 transition duration-300 animate-pulse"></div>
