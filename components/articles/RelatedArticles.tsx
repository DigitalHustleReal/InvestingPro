                            ...
                            <div className="p-5">
                                <div className="flex items-start gap-4">
                                    {article.featured_image ? (
                                        ...
                                        <div className="w-16 h-16 rounded-lg bg-gradient-to-br from-primary-500/20 to-secondary-500/20 flex items-center justify-center flex-shrink-0">
                                            <FileText className="w-6 h-6 text-primary-500/50" />
                                        </div>
                                    )}
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <h4 className="font-semibold text-slate-900 dark:text-white line-clamp-2 group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-colors">
                                            {article.title}
                                        </h4>
                                    </div>
                                </div>
                                ...
                                <div className="mt-4 flex items-center justify-between">
                                    ...
                                    <ArrowRight className="w-4 h-4 text-slate-400 group-hover:text-primary-500 group-hover:translate-x-1 transition-all flex-shrink-0 ml-2" />
                                </div>
                            </div>
                        </Card>
                    </Link>
