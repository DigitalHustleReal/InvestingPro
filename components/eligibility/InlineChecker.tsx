  ...
  return (
    <div className={cn(
      ...
      <div className="flex items-center gap-2 mb-4">
        ...
        <h3 className="font-bold text-slate-900 dark:text-white">Check Eligibility</h3>
      </div>
      ...
      {!showResult ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 border border-slate-200 dark:border-slate-700 rounded-lg bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary-500"
                required
              />
            </div>
        ...
        <>
          ...
          <div className="space-y-4">
            {/* Status Icon & Message */}
            <div className="flex items-start gap-3 p-4 rounded-xl bg-white dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700">
              {result?.eligible ? (
