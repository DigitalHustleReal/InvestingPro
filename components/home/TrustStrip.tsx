...
const trustSignals = [
    { icon: Database, label: "Data-Driven Analysis", desc: "Expert Research" },
    { icon: RefreshCw, label: "Updated Regularly", desc: "Monthly updates" },
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-x-8 gap-y-6">
                        {trustSignals.map((signal, i) => (
                            <div key={i} className="flex items-center gap-3 text-white/60">
                                <signal.icon className="w-5 h-5 text-primary-500" />
