    ...
    return (
        <section className="py-20 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 relative overflow-hidden">
            ...
            <div className="absolute inset-0">
                <div className="absolute top-0 left-1/4 w-72 h-72 bg-teal-500/10 rounded-full blur-3xl opacity-50" />
                <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-blue-500/10 rounded-full blur-3xl opacity-50" />
            </div>

            <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-teal-500 to-emerald-600 mb-8 shadow-lg shadow-teal-500/25">
                    ...
                    {!subscribed ? (
                        <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4">
                            <Input
                                ...
                                className="flex-1 h-14 bg-white/5 border-white/20 text-white placeholder:text-slate-400 rounded-xl focus:border-teal-400 focus:ring-teal-400 focus:bg-white/10 transition-all outline-none"
                                required
                            />
                            <Button
                                type="submit"
                                size="lg"
                                className="h-14 px-8 bg-gradient-to-r from-teal-500 to-emerald-500 hover:from-teal-600 hover:to-emerald-600 rounded-xl shadow-lg shadow-teal-500/25 border-0 text-white font-semibold"
                            >
                                Subscribe
