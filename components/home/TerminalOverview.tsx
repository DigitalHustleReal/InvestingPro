                    ...
                    <div className="lg:col-span-8 space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {opportunities.map((item, i) => (
                                <Card key={i} className="bg-slate-900/40 border-slate-800/60 hover:border-primary-500/30 transition-all group rounded-[2rem] overflow-hidden">
                                    <CardContent className="p-8">
                                        <div className="flex justify-between items-start mb-6">
                                            ...
                                            <Badge className={`px-3 py-1 border-0 rounded-full text-[10px] font-bold uppercase ${item.status === 'bullish' ? 'bg-primary-500/10 text-primary-400' : 'bg-rose-500/10 text-rose-400'
                                                }`}>
                                                {item.signal}
                                            </Badge>
                                        </div>
                            ...
                            <Card className="bg-gradient-to-br from-indigo-600 to-primary-700 border-0 rounded-[2rem] overflow-hidden group cursor-pointer relative">
                                ...
                                <CardContent className="p-8 h-full flex flex-col justify-between relative z-10">
                                    <div>
                                        ...
                                        <p className="text-white/70 text-sm font-medium leading-relaxed">Access expert product reviews and comparison tools for smarter financial decisions.</p>
                                    </div>
