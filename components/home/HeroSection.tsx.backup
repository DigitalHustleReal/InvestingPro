                ...
                <div className="flex flex-col lg:flex-row items-center gap-16">
                    ...
                    <div className="lg:w-3/5 text-left">
                        ...
                        <p className="text-xl text-slate-400 mb-10 max-w-2xl leading-relaxed">
                            An independent research and education platform to help you discover, compare, and make informed decisions about financial products. Compare credit cards, loans, investments, and more with unbiased data and tools.
                        </p>
                        ...
                        {/* 3-Step Strip */}
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 py-8 border-t border-slate-800/60">
                            {[
                                { step: "01", title: "Tell us your goal", desc: "Short/long term needs" },
                                { step: "02", title: "See curated options", desc: "Data-backed shortlists" },
                            ...
                            <div className="space-y-8">
                                {[
                                    ...
                                    <div key={i} className="flex gap-5 group">
                                        <div className={`w-14 h-14 rounded-2xl bg-slate-950 border border-slate-800 flex items-center justify-center shrink-0 group-hover:border-slate-700 transition-colors`}>
