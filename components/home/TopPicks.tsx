                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            ...
                            {topPicks.mutualFunds?.map((fund, index) => (
                                <div key={index} className={`py-4 ${index !== (topPicks.mutualFunds?.length || 0) - 1 ? 'border-b border-slate-100' : ''}`}>
                                    <div className="flex justify-between items-start mb-2">
                                        ...
                                        <Badge className="bg-primary-100 text-primary-700 hover:bg-primary-100 border-0">
                                            {fund.returns} 3Y
                                        </Badge>
                                    </div>
                    ...
                    <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col">
                        ...
                        <div className="p-6 flex-1 flex flex-col">
                            ...
                            <Link
                                href="/demat-accounts"
                                className="flex items-center justify-center gap-2 text-primary-600 font-semibold mt-auto pt-6 hover:text-primary-700 transition-colors"
                            >
                        ...
                        <div className="p-6 flex-1 flex flex-col">
                            {topPicks.creditCards?.map((card, index) => (
                                <div key={index} className={`py-4 ${index !== (topPicks.creditCards?.length || 0) - 1 ? 'border-b border-slate-100' : ''}`}>
                                    <div className="flex justify-between items-center mb-1">
                                        <div>
                                            <p className="font-semibold text-slate-900 dark:text-white">{card.name}</p>
