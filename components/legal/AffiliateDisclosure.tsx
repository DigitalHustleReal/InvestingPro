...
export default function AffiliateDisclosure({ 
  ...
  if (variant === 'tooltip') {
    return (
      <span className={`inline-flex items-center gap-1 text-xs text-gray-500 dark:text-gray-600 ${className}`} title="We may earn a commission if you apply through this link">
