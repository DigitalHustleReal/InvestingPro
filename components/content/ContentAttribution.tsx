                    ...
                    {showAuthor && author && (
                        <div className="author-byline">
                            ...
                            <div className="author-details">
                                ...
                                <Link href={`/author/${author.slug}`} className="author-name font-semibold hover:text-primary">
                                    {author.name}
                                </Link>
                                {author.title && (
    ...
    return (
        <div className="editorial-disclosure border-t pt-6 mt-8">
            ...
            <p className="text-sm text-gray-600">
                ...
                combined years of experience. We update content quarterly and immediately when 
                regulations change.
            </p>
            <Link href="/about/editorial-standards" className="text-sm text-primary hover:underline mt-2 inline-block">
