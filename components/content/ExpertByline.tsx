...
export function ExpertByline({
  ...
  return (
    <div 
      className={cn(
        "flex items-start gap-3 p-4 bg-stone-50 border-l-4 border-primary-600 rounded-lg",
        isCompact && "p-3 gap-2",
        className
      )}
      itemScope
    ...
    >
      ...
      {photoUrl ? (
        <div className={cn(
          "flex-shrink-0 rounded-full overflow-hidden border-2 border-stone-200 bg-stone-100",
...
export function ExpertReviewByline(
  ...
  return (
    <div className="space-y-3">
      ...
      {(rating || reviewDate) && (
        <div className="flex items-center gap-4 px-4 py-2 bg-amber-50 border border-amber-200 rounded-lg">
          {rating && (
            <div className="flex items-center gap-2">
              <span className="text-xs font-medium text-stone-700">Expert Rating:</span>
              <div className="flex items-center gap-1">
                ...
                <span className="text-sm font-bold text-stone-900 ml-1">
                  {rating.toFixed(1)}
                </span>
              </div>
            </div>
