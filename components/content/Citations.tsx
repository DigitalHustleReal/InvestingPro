...
export function CitationList({ citations, title = "Sources & Citations", className = "" }: CitationListProps) {
    ...
    return (
        <div className={`citations-list border-t border-gray-200 dark:border-gray-800 pt-8 mt-12 ${className}`}>
            ...
            <ol className="space-y-4">
                {citations.map((citation) => (
                    <li
                        ...
                        className="text-sm text-gray-700 dark:text-gray-300 scroll-mt-20"
                    >
...
export function SourceCard({ citation, showNumber = true }: SourceCardProps) {
    ...
    return (
        <div className="source-card border border-gray-200 dark:border-gray-800 rounded-lg p-4 hover:border-primary-300 dark:hover:border-primary-700 transition-colors">
            <div className="flex gap-3">
                {showNumber && (
...
export function InlineSource({ source, url }: { source: string; url?: string }) {
    ...
    return (
        <span className="inline-source text-gray-700 dark:text-gray-300 font-medium">
            ({source})
        </span>
    );
}
