            ...
            <article className="min-h-screen bg-white">
                ...
                <section className="bg-gradient-to-br from-gray-900 to-gray-800 text-white py-20">
                    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <p className="text-xl text-gray-300 mb-8">{sections.hero.subheadline}</p>
                ...
                <section className="py-16 bg-gray-50">
                    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="prose prose-lg max-w-none">
                            <p className="text-gray-700 leading-relaxed">{sections.overview.content}</p>
                                    ...
                                    {sections.overview.key_statistics.map((stat, idx) => (
                                        <Card key={idx} className="border-0 shadow-sm">
                                            <CardContent className="p-6 text-center">
                                                ...
                                                {stat.source && (
                                                    <div className="text-xs text-gray-600 mt-2">Source: {stat.source}</div>
                                                )}
                                            </CardContent>
                                        </Card>
                                    ))}
                ...
                <section className="py-16">
                    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                        <h2 className="text-3xl font-bold text-gray-900 mb-12 text-center">Types & Variants</h2>
                ...
                <section className="py-16 bg-gradient-to-br from-primary-600 to-secondary-600 text-white">
                    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                        ...
                        <Link href={sections.cta.cta_url}>
                            <button className="bg-white text-primary-600 hover:bg-gray-100 font-bold px-8 py-4 rounded-xl inline-flex items-center gap-2">
