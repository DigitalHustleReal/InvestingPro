...
export default function LimitedAdSlot({
    ...
    const getPositionStyles = () => {
        switch (position) {
            ...
            case 'between-cards':
                return 'bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-xl';
            default:
    ...
    return (
        <div className={`relative ${getPositionStyles()} ${className} overflow-hidden`}>
            ...
            {/* Clear "Ad" label */}
            <div className="text-[10px] uppercase font-bold tracking-widest text-slate-400 px-3 pt-2">
                Advertisement
            </div>
