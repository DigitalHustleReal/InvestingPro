...
import { FileSpreadsheet, Download, Mail, CheckCircle2, Lock } from 'lucide-react';
...
export default function LeadMagnet({ title, description, downloadUrl, type }: LeadMagnetProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (error) {
                ...
                if (error.code === '23505') {
                    toast.info("You've already requested this resource! Sending it again.");
                } else {
                    throw error;
                }
            }
