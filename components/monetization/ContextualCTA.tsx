...
export default function ContextualCTA({
    ...
    if (placement === 'end') {
        return (
            <Card className={cn(
                "bg-gradient-to-br from-indigo-500/5 via-purple-500/5 to-pink-500/5 border-indigo-500/20",
                className
            )}>
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                        {links.map(link => (
                            <a
                                ...
                                className="flex items-center justify-between p-4 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 hover:border-indigo-500/30 hover:shadow-lg transition-all group"
                            >
    ...
    return (
        <div className={cn(
            "my-8 p-6 rounded-2xl bg-gradient-to-r from-teal-500/5 to-indigo-500/5 border border-teal-500/10",
            className
        )}>
