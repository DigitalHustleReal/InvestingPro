...
export default function EngagementHooks({
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      const elementScrollBottom = Math.min(
        targetHeight,
        scrollTop + windowHeight - targetTop,
      );
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">
                    Get expert financial tips delivered free every week.
                  </p>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2">
                    <Button
                      ...
                      asChild
                    >
                      <a href={getCalculatorUrl()}>Open Calculator</a>
                    </Button>
                    <button
