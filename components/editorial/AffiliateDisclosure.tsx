        ...
        <div className="flex items-start gap-3 mb-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed mb-3">
              We're an independent comparison platform supported by affiliate
              commissions. When you apply for a product through our links, we
              may earn a fee.
            </p>
            <div className="space-y-1.5 mb-4">
              ...
              <div className="flex items-start gap-2 text-sm text-gray-700 dark:text-gray-300">
                ...
                <span>
                  We analyze products across 50+ banks, only recommend the best
                </span>
              </div>
              <div className="flex items-start gap-2 text-sm text-gray-700 dark:text-gray-300">
                <span className="text-primary-600 dark:text-primary-400 font-bold">
                ...
                <span>
                  Our editorial team has ZERO access to commercial deals
                </span>
              </div>
              <div className="flex items-start gap-2 text-sm text-gray-700 dark:text-gray-300">
                <span className="text-primary-600 dark:text-primary-400 font-bold">
      ...
      <div className="flex items-start gap-2">
        ...
        <div>
          ...
          <span className="text-primary-800 dark:text-primary-300">
            We may earn affiliate commissions from products on this page, but
