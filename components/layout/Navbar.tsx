                                                                ...
                                                                return (
                                                                    ...
                                                                    >
                                                                        <div className="flex flex-col">
                                                                            ...
                                                                            {intent.description && (
                                                                                <span className={`text-[11px] mt-0.5 line-clamp-1 ${isActive ? 'text-primary-600/80' : 'text-slate-400'}`}>
                                                                                    {intent.description}
                                                                                </span>
                                                                            )}
                                                                        </div>
                                                                    ...
                                                                    <nav className="space-y-1" role="list">
                                                                        {activeIntent.collections.map((collection) => (
                                                                            <Link
                                                                                ...
                                                                                className="flex items-center justify-between group px-3 py-2 rounded-lg text-sm text-slate-700 hover:text-primary-700 hover:bg-primary-50 transition-all"
                                                                                role="listitem"
                                                                            >
                                                                ...
                                                                return (
                                                                    <div>
                                                                        ...
                                                                        <nav className="space-y-2" role="list">
                                                                            <Link href="/calculators/sip" className="block p-3 bg-white rounded-lg border border-slate-200 shadow-sm hover:border-primary-300 hover:shadow-md transition-all">
                                                                            ...
                                                                            <Link href="/calculators/emi" className="block p-3 bg-white rounded-lg border border-slate-200 shadow-sm hover:border-primary-300 hover:shadow-md transition-all">
                                                                ...
                                                                return (
                                                                    <div>
                                                                        ...
                                                                        <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
                                                                            <Link 
                                                                                href={`/${category.slug}/${activeIntent.slug}`}
                                                                                className="block text-sm font-bold text-slate-900 hover:text-primary-600 mb-2 leading-snug"
                                                                            >
                                                                            ...
                                                                            <Link
                                                                                href={`/${category.slug}/${activeIntent.slug}`}
                                                                                className="inline-flex items-center text-xs text-primary-600 hover:text-primary-700 font-bold uppercase tracking-wide"
                                                                            >
