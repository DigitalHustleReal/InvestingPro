...
function SearchButton({ variant = 'desktop' }: { variant?: 'desktop' | 'mobile' }) {
    ...
    if (variant === 'mobile') {
        return (
            ...
            >
                ...
                <kbd className="px-2 py-0.5 text-xs bg-white dark:bg-gray-700 rounded border border-gray-200 dark:border-gray-600 text-gray-600">⌘K</kbd>
            </button>
        );
    }
    ...
    return (
        ...
        >
            <Search className="w-4 h-4 text-green-700 dark:text-green-400 flex-shrink-0" />
            <span className="text-sm text-gray-600 dark:text-gray-400 flex-1 text-left truncate">Search...</span>
            <kbd className="hidden xl:inline-flex px-1.5 py-0.5 text-[10px] bg-white dark:bg-gray-700 rounded border border-gray-200 dark:border-gray-600 text-gray-500 dark:text-gray-600 font-mono">⌘K</kbd>
        </button>
    );
}
                ...
                <div className="flex items-center justify-between h-14 lg:h-[72px]">
                    ...
                    <div className="lg:hidden flex items-center gap-3 ml-1">
                        ...
                        <Sheet open={isOpen} onOpenChange={setIsOpen}>
                            <SheetContent side="right" className="w-full sm:w-96 p-0 bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl flex flex-col h-full border-l border-gray-200/60 dark:border-gray-800/60 shadow-2xl">
                                ...
                                <div className="flex-1 overflow-y-auto min-h-0">
                                    <nav className="p-4 space-y-2">
                                        {navigationCategories.map((category) => {
                                            ...
                                            return (
                                                <div key={category.slug} className="border-b border-gray-100 last:border-0 pb-2 last:pb-0">
                                ...
                                <div className="p-4 border-t border-gray-200 bg-gray-50 space-y-3">
                                    ...
                                    <Link href="/login" onClick={() => setIsOpen(false)}>
                                        <Button variant="outline" className="w-full h-10 font-semibold text-gray-600 hover:text-green-700 border-gray-200">
                                            Log In
                                        </Button>
                                    </Link>
