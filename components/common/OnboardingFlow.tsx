...
const steps = [
  {
    ...
    description:
      "Your personal finance companion for smart investing decisions",
    icon: Sparkles,
    content: (
      <div className="space-y-4">
        <p className="text-gray-600">
          We're excited to have you here! InvestingPro helps you make informed
        ...
        <ul className="space-y-3">
          <li className="flex items-center gap-3">
            ...
            <span className="text-gray-700">
              Compare 5000+ mutual funds, stocks, and credit cards
            </span>
          </li>
          <li className="flex items-center gap-3">
            <CheckCircle2 className="w-5 h-5 text-primary-500 flex-shrink-0" />
          ...
          <li className="flex items-center gap-3">
            <CheckCircle2 className="w-5 h-5 text-primary-500 flex-shrink-0" />
            <span className="text-gray-700">
              Expert articles and community reviews
            </span>
          </li>
          <li className="flex items-center gap-3">
            <CheckCircle2 className="w-5 h-5 text-primary-500 flex-shrink-0" />
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-secondary-700">
                    Share your investment knowledge and earn 50 points per
                    published article
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-accent-700">
                    Review products you've used and help others make better
                    decisions
                  </p>
                </div>
              </div>
