...
export default function ComplianceDisclaimer({
    ...
    if (variant === 'inline') {
        return (
            <p className={cn(baseStyles, className)}>
                <strong className="text-slate-800 dark:text-slate-300">Not SEBI registered.</strong> Decision support only. Educational purpose. 
    ...
    if (variant === 'compact') {
        return (
            <div className={cn("bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 rounded-lg p-4", className)}>
                <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 space-y-2">
                        <p className={cn(baseStyles)}>
                            <strong className="text-slate-800 dark:text-slate-300">Important:</strong> InvestingPro.in is <strong>NOT a SEBI registered investment advisor</strong>. 
    ...
    // Full variant
    return (
        <div className={cn("bg-slate-50 dark:bg-slate-900/50 border-2 border-warning-200 dark:border-warning-800 rounded-xl p-6", className)}>
            <div className="flex items-start gap-4">
                ...
                <div className="flex-1 space-y-3">
                    ...
                    <div className="space-y-2 text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
                        ...
                        <p>
                            <strong className="text-slate-800 dark:text-slate-300">Decision Support Only:</strong> Our content, tools, calculators, and product comparisons are provided for informational and educational purposes only. They are designed to help you make informed decisions, not to provide personalized investment advice.
                        </p>
                        <p>
                            <strong className="text-slate-800 dark:text-slate-300">Educational Purpose:</strong> All information on this platform is for research, education, and discovery purposes. Nothing on this website constitutes a recommendation to buy, sell, or hold any security, financial product, or investment.
                        </p>
                        <p>
                            <strong className="text-slate-800 dark:text-slate-300">Your Responsibility:</strong> All financial decisions are made at your own risk. Past performance does not guarantee future results. You should conduct your own research and consult with a qualified, SEBI-registered financial advisor before making any investment decisions.
                        </p>
                    </div>
                    <Link 
                        href="/disclaimer" 
