...
export default function SEOHead({
  ...
  description = "Compare Credit Cards, Mutual Funds & More in India. Make Smart Decisions. Get personalized recommendations based on your spending, lifestyle, and goals. Apply Instantly.",
  image: providedImage,
  url,
  type = "website",
  structuredData = null,
  ...
  useEffect(() => {
    ...
    setMetaTag(
      "keywords",
      "investment, mutual funds, stocks, credit cards, insurance, SIP calculator, India",
    );
