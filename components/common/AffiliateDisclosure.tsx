...
export default function AffiliateDisclosure({ 
    ...
    if (variant === 'button') {
        return (
            <p className={`text-[10px] text-gray-600 text-center flex items-center justify-center gap-0.5 ${className}`}>
    ...
    if (variant === 'tooltip') {
        return (
            <div className={`text-xs text-gray-600 max-w-xs ${className}`}>
                <p className="mb-2">
