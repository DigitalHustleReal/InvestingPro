        ...
        <div className="relative">
          ...
          {variant === "newsletter" && (
            <div className="p-8 text-center">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-6">
                Get weekly investment insights, exclusive deals, and expert tips
          ...
          {variant === "offer" && (
            <div className="p-8 text-center bg-gradient-to-br from-primary-600 to-primary-700 text-white">
              ...
              <p className="text-white/90 mb-6">
                Subscribe and get instant access to our premium credit card
                comparison tool.
              </p>
              <form onSubmit={handleSubscribe} className="space-y-4">
                <Input
          ...
          {variant === "wizard" && (
            <div className="md:grid md:grid-cols-5 h-full">
              {/* Visual Side */}
              <div className="hidden md:flex md:col-span-2 bg-gradient-to-br from-green-600 to-green-700 items-center justify-center p-6 text-white text-center">
                <div>
              ...
              <div className="md:col-span-3 p-8">
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">
                  Wait! Not sure which card to pick?
                </h2>
                <p className="text-gray-600 dark:text-gray-400 mb-6 text-sm leading-relaxed">
                  Get a personalized recommendation based on your spending. It
                ...
                <p
                  className="text-center mt-4 text-xs text-gray-600 hover:text-gray-500 cursor-pointer"
                  onClick={handleClose}
                >
