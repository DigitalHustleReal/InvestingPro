...
const RatesWidget = dynamic(
    () => import('@/components/rates/RatesWidget'),
    { 
...
const CibilGauge = dynamic(
    () => import('@/components/widgets/CibilGauge'),
    { 
...
export default function UniversalSidebar({ 
    ...
    const rateCategory = 
        ...
        category === 'investing' || category === 'mutual_fund' ? 'investing' : 
        'banking';
                ...
                <div ref={newsObserver.ref}>
                    {newsObserver.hasIntersected ? (
                        <ContextualNewsWidget 
                            category={category === 'mutual_fund' ? 'investing' : category as any} 
                        />
                    ) : (
                        <NewsWidgetSkeleton />
                    )}
