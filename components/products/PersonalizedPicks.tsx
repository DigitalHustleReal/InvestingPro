      ...
      {recommendations.map((rec, idx) => (
        <Card 
          ...
          className={cn(
            ...
            idx === 0 ? "border-primary-600 bg-primary-50/30 dark:bg-primary-900/10" : "border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-900"
          )}
        >
          {idx === 0 && (
          ...
          <CardContent className="p-6">
            <div className="flex flex-col h-full">
              <div className="relative w-full h-32 mb-4 bg-white dark:bg-slate-800 rounded-xl overflow-hidden p-4 flex items-center justify-center border border-slate-100 dark:border-slate-700 group-hover:scale-105 transition-transform duration-500">
              ...
              <div className="mb-4">
                <h4 className="font-bold text-slate-900 dark:text-white leading-tight mb-1 truncate">
                  {rec.product.name}
                </h4>
