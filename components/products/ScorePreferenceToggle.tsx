...
export default function ScorePreferenceToggle({
  currentWeights,
  onWeightChange,
}: ScorePreferenceToggleProps) {
  const preferences = [
    {
      id: "balanced",
      label: "Balanced",
      icon: Sparkles,
      weights: { rewards: 0.35, fees: 0.3, travel: 0.35 },
    },
    {
      id: "travel",
      label: "Travel",
      icon: Plane,
      weights: { rewards: 0.2, fees: 0.1, travel: 0.7 }, // Heavy travel focus
    },
    {
      id: "fees",
      label: "Low Fees",
      icon: Wallet,
      weights: { rewards: 0.2, fees: 0.7, travel: 0.1 }, // Heavy fee focus
    },
    {
      id: "shopping",
      label: "Shopping",
      icon: ShoppingCart,
      weights: { rewards: 0.7, fees: 0.2, travel: 0.1 }, // Heavy rewards focus
    },
  ];
      ...
      <div className="flex items-center gap-2 mb-3">
        ...
        <div>
          ...
          <p className="text-xs text-gray-500">
            Adjust how we score these cards for you.
          </p>
        </div>
      </div>
