            ...
            >
                <Sheet open={isOpen} onOpenChange={setIsOpen}>
                    <SheetTrigger asChild>
                        <Button 
                            className="h-14 px-6 rounded-xl bg-gray-900 border border-white/10 text-white shadow-2xl flex items-center gap-3 animate-in slide-in-from-bottom-5"
                        >
                            <SlidersHorizontal className="w-5 h-5" />
                            <span className="font-bold">Filters</span>
                            {activeFiltersCount > 0 && (
                                <span className="flex items-center justify-center w-6 h-6 rounded-full bg-primary-500 text-gray-950 text-[10px] font-black">
                                    {activeFiltersCount}
                                </span>
                            )}
                        </Button>
                    </SheetTrigger>
                    <SheetContent side="bottom" className="h-[85vh] p-0 rounded-t-[2.5rem] bg-white dark:bg-gray-950 border-t border-gray-200 dark:border-gray-800">
                        ...
                        <div className="absolute bottom-0 inset-x-0 p-6 bg-white/80 dark:bg-gray-950/80 backdrop-blur-md border-t border-gray-100 dark:border-gray-800 flex gap-4">
                            <Button 
