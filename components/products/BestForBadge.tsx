...
export default function BestForBadge({
  ...
  return (
    <div className={className}>
      <div
        className={`inline-flex items-center ${sizeClasses[size]} ${badge.bgColor} ${badge.borderColor} dark:bg-gray-900/90 dark:border-white/20 border-2 rounded-full font-bold ${badge.color} dark:text-white shadow-sm hover:shadow-md transition-shadow backdrop-blur-sm`}
      >
