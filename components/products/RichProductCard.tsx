    ...
    >
      ...
      {isScored && matchScore !== undefined && (
        <div className="absolute top-10 right-0 z-10 animate-in slide-in-from-right-4 duration-500">
          <ScoreExplanation
            overall={rawScore || matchScore / 10}
      ...
      <div className="absolute top-3 left-3 z-10">
        ...
        >
          ...
          >
            {isCompareSelected && (
              <Check className="w-3.5 h-3.5 text-primary-600 font-black" />
            )}
          </div>
      ...
      <div
        className={cn(
          ...
          isList
            ? "w-full md:w-80 border-b md:border-b-0 md:border-r border-gray-100"
      ...
      >
        ...
        {product.is_verified && (
          <Badge
            variant="outline"
            className="gap-1 bg-white border-primary-200 text-primary-700 text-[10px] font-medium shadow-sm"
          >
        ...
        <CardHeader className="pb-2">
          <div className="flex justify-between items-start gap-4">
            <div className="flex-1">
              ...
              {product.bestFor &&
                calculateProductTags(product, product.category || "credit_card")
                  .length === 0 && (
        ...
        <CardContent className="flex-1 pb-4">
          ...
          <div className="flex items-center justify-between bg-gray-50/50 rounded-lg p-2 mb-4 border border-gray-100">
            <div className="flex items-center gap-2">
              <div
                className={cn(
                  "text-xs font-bold px-2 py-0.5 rounded-full ring-1 bg-white",
                  getTrustColor(ratingObj.trust_score),
                )}
              >
