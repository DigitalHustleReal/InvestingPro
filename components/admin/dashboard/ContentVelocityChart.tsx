            ...
            <div className="glass-card p-3 border-emerald-500/20 shadow-2xl">
                ...
                <div className="space-y-1">
                    <p className="text-sm font-bold text-emerald-400 flex items-center justify-between gap-4">
                        Views <span className="text-foreground">{payload[0].value.toLocaleString()}</span>
                    </p>
                    <p className="text-sm font-bold text-cyan-400 flex items-center justify-between gap-4">
                        Articles <span className="text-foreground">{payload[1]?.value || 0}</span>
                    </p>
                </div>
            </div>
        );
        ...
        <div className="bento-card p-6 h-full flex flex-col">
            <div className="flex items-center justify-between mb-6 relative z-10">
                <div>
                    ...
                    <p className="text-xs text-muted-foreground">Publishing frequency vs Reader engagement</p>
                </div>
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-1.5">
                        ...
                        <span className="text-[10px] uppercase font-bold text-muted-foreground">Articles</span>
                    </div>
                </div>
            </div>
            ...
            <div className="flex-1 min-h-[300px] h-[300px] mt-6 min-w-0 relative">
                {isMounted && data && data.length > 0 ? (
                    ...
                    <div className="h-full w-full flex items-center justify-center bg-white/5 rounded-xl border border-white/5">
                        <p className="text-xs text-muted-foreground font-bold">Waiting for Momentum Data...</p>
                    </div>
                )}
            </div>
        </div>
