...
export default function AdminLayout({
  ...
  return (
    <>
      <KeyboardShortcuts />
      <div
        className={`min-h-screen flex flex-col antialiased bg-background text-foreground font-sans selection:bg-primary/30 ${isResizing ? "cursor-col-resize select-none" : ""}`}
      >
        ...
        <div className="grid grid-cols-[auto_1fr] flex-1 overflow-hidden relative z-10">
          <aside
            className={cn(
              "flex-shrink-0 shadow-xl transition-all duration-300 ease-in-out",
              ...
              {showInspector && inspectorContent && (
                <aside
                  ...
                  className={cn(
                    ...
                    isMobile
                      ? "fixed inset-y-0 right-0 z-50 bg-card shadow-2xl"
                      : "relative",
                  )}
                >
