            ...
            <Card>
                ...
                <CardContent>
                    {abTests.length > 0 ? (
                                ...
                                >
                                    <div className="flex items-center justify-between">
                                        <div>
                                            ...
                                            <div className="text-sm text-slate-600">{test.prompt_slug}</div>
                                            <div className="text-xs text-slate-500 mt-1">
                                                Status: {test.status}
                                            </div>
                                        </div>
                        ...
                        <p className="text-slate-500 text-center py-4">No A/B tests yet</p>
                    )}
                </CardContent>
            </Card>
                    ...
                    <CardContent>
                        <div className="space-y-4">
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    <div className="text-sm text-slate-600">Usage Count</div>
                            ...
                            <div>
                                <div className="text-sm text-slate-600 mb-2">User Prompt Template</div>
                                <Textarea
                            ...
                            {selectedPrompt.system_prompt && (
                                <div>
                                    <div className="text-sm text-slate-600 mb-2">System Prompt</div>
                                    <Textarea
                    ...
                    <CardContent>
                        <div className="space-y-4">
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    <div className="text-sm text-slate-600">Min Sample Size</div>
                            ...
                            <div>
                                <div className="text-sm text-slate-600 mb-2">Traffic Split</div>
