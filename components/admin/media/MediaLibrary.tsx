    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row gap-4 justify-between items-center bg-surface-darker/50 dark:bg-surface-darker/50 p-4 rounded-xl border border-slate-800">
                <div className="relative w-full sm:w-96">
                    ...
                    <input
                        ...
                        className="w-full pl-10 pr-4 py-2 bg-muted dark:bg-muted border border-wt-border dark:border-wt-border rounded-lg text-sm text-wt-text/90 dark:text-wt-text/90 focus:outline-none focus:border-brand-500"
                    />
                </div>
                <div className="flex items-center gap-2 p-1 bg-muted dark:bg-muted rounded-lg border border-wt-border dark:border-wt-border">
                    <button
                        onClick={() => setViewMode('grid')}
                        className={`p-2 rounded-md transition-colors ${viewMode === 'grid' ? 'bg-brand-500/20 text-brand-400' : 'text-wt-text-muted dark:text-wt-text-muted hover:text-wt-text/90 dark:text-wt-text/90'}`}
                    >
                        <Grid className="w-4 h-4" />
                    </button>
                    <button
                        onClick={() => setViewMode('list')}
                        className={`p-2 rounded-md transition-colors ${viewMode === 'list' ? 'bg-brand-500/20 text-brand-400' : 'text-wt-text-muted dark:text-wt-text-muted hover:text-wt-text/90 dark:text-wt-text/90'}`}
                    >
            ...
            {loading ? (
                ...
                <div className="text-center py-20 text-wt-text-muted dark:text-wt-text-muted">
                                    ...
                                    <>
                                        <div className="flex-1 relative w-full overflow-hidden bg-surface-darkest dark:bg-surface-darkest/50">
                                            {item.type.startsWith('image/') ? (
                                                ...
                                                <div className="w-full h-full flex items-center justify-center text-wt-text-muted/50 dark:text-wt-text-muted/50">
                                            ...
                                            <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-2">
                                                <button
                                                    ...
                                                    className="p-2 bg-white/10 hover:bg-wt-surface-hover rounded-full text-wt-text dark:text-wt-text backdrop-blur-sm transition-colors"
                                                    title="Copy URL"
                                                >
                                                ...
                                                <button
                                                    ...
                                                    className="p-2 bg-wt-danger/20 hover:bg-wt-danger/40 text-wt-danger rounded-full backdrop-blur-sm transition-colors"
                                                    title="Delete"
                                                >
                                        ...
                                        <div className="p-3 border-t border-slate-800">
                                            ...
                                            <div className="flex justify-between items-center mt-1">
                                                <p className="text-[10px] text-wt-text-muted/70 dark:text-wt-text-muted/70">
                                        ...
                                        <div className="w-12 h-12 rounded-lg bg-surface-darkest dark:bg-surface-darkest overflow-hidden flex-shrink-0">
                                            {item.type.startsWith('image/') ? (
                                                ...
                                                <div className="w-full h-full flex items-center justify-center">
                                                    <FileText className="w-6 h-6 text-wt-text-muted/50 dark:text-wt-text-muted/50" />
                                                </div>
                                            )}
                                        </div>
                                        <div className="flex-1 min-w-0">
                                            <p className="text-sm font-medium text-wt-text/90 dark:text-wt-text/90 truncate">{item.name}</p>
