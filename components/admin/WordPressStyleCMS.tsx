            ...
            <div className="flex items-center justify-between border-b border-slate-200 pb-4">
                ...
                <div className="flex gap-3">
                    {onGenerate && (
                        <Button
                            onClick={onGenerate}
                            className="bg-secondary-600 hover:bg-secondary-700 text-foreground dark:text-foreground"
                        >
                                            ...
                                            <div className="flex items-center gap-2 md:gap-3">
                                                {article.featured_image ? (
                                                    ...
                                                    <div className="w-10 h-10 md:w-12 md:h-12 rounded bg-slate-100 flex items-center justify-center flex-shrink-0">
                                                        <FileText className="w-5 h-5 md:w-6 md:h-6 text-muted-foreground dark:text-muted-foreground" />
                                                    </div>
                                                )}
                                                <div className="min-w-0 flex-1">
                                                    <Link
                                                ...
                                                {article.quality_score !== undefined ? (
                                                    <div className="flex items-center gap-1.5">
                                                        ...
                                                        <span className="text-sm font-medium text-slate-900">
                                                            ...
                                                            <span className="text-[10px] text-muted-foreground dark:text-muted-foreground ml-0.5">/100</span>
                                                        </span>
                                                    </div>
                                                ) : (
                                                    <span className="text-xs text-muted-foreground dark:text-muted-foreground italic">Not Audited</span>
                                                )}
                                            </div>
                                        </td>
