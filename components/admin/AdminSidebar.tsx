        ...
        <div className="w-64 bg-slate-950 text-slate-100 h-screen flex flex-col border-r border-white/5 relative z-50">
            ...
            <div className="px-4 mb-6">
                <div className="relative group">
                    <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-slate-500 group-focus-within:text-primary-400 transition-colors" aria-hidden="true" />
                    <input
                        type="text"
            ...
            {/* Navigation Sections */}
            <nav className="flex-1 overflow-y-auto px-4 pb-6 space-y-8 no-scrollbar" aria-label="Main navigation">
                                ...
                                return (
                                    <li key={item.href}>
                                        <Link
                                            href={item.href}
                                            className={cn(
                                                "group flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-300 relative overflow-hidden focus:outline-none focus:ring-2 focus:ring-primary-500/50",
                                                isActive
