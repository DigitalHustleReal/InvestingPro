...
export function ProductCardSkeleton({ className, variant = 'default' }: ProductCardSkeletonProps) {
  if (variant === 'horizontal') {
    return (
      <div className={cn(
        ...
        {/* CTA */}
        <div className="w-24 h-10 bg-gray-200 dark:bg-gray-700 rounded-lg flex-shrink-0" />
      </div>
    );
  }
  ...
  if (variant === 'compact') {
    return (
      <div className={cn(
        ...
        {/* CTA */}
        <div className="h-9 bg-gray-200 dark:bg-gray-700 rounded-lg mt-3" />
      </div>
    );
  }
  ...
  return (
    <div className={cn(
      ...
      {/* Badge */}
      <div className="h-5 bg-gray-200 dark:bg-gray-700 rounded-full w-1/4 mb-3" />
