...
export function InflationAdjustedCalculator() {
  ...
  const pieData = [
    ...
    },
    {
      ...
      value: Math.round(result.erosion),
      color: "#16a34a",
    },
  ];
              ...
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={growthData}>
                  ...
                  <Area
                    ...
                    dataKey="nominal"
                    stroke="#166534"
                    fill="url(#colorInflationNominal)"
                    strokeWidth={2}
                    name="Nominal Value"
                  />
                  <Area
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gradient-to-br from-emerald-50 to-emerald-50 dark:from-emerald-950/30 dark:to-emerald-950/30 rounded-sm p-5 border border-emerald-100 dark:border-emerald-900/50 relative overflow-hidden">
                ...
                <p className="text-lg font-medium text-emerald-900 dark:text-emerald-100 mb-3">
                  {formatCurrency(initialAmount)} today will cost{" "}
                  <span className="font-bold">
                    {formatCurrency(result.futureCost)}
                  </span>{" "}
                  in {years} years. Your money's real value drops to{" "}
                  <span className="font-bold">
                    {formatCurrency(result.purchasingPower)}
                  </span>
                  .
                ...
                <div className="flex flex-wrap gap-2">
                  {parseFloat(erosionPct) > 50 && (
                    ...
                    >
                      <TrendingDown className="w-3 h-3" /> High Erosion — Invest
                      Now
                    </Badge>
                  )}
              ...
              <div className="p-5 bg-card rounded-sm border border-border shadow-sm mt-4">
                ...
                <p className="text-xs text-muted-foreground mb-4">
                  Get a personalized inflation protection strategy and
                  investment plan to beat {inflationRate}% inflation over{" "}
                  {years} years.
                </p>
