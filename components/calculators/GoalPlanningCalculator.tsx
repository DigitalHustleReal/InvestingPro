...
export function GoalPlanningCalculator() {
  ...
  const pieData = [
    {
      name: "Total Invested",
      value: Math.max(0, Math.round(totalInvested)),
      color: "#166534",
    },
    {
      name: "Returns",
      value: Math.max(0, Math.round(totalReturns)),
      color: "#16a34a",
    },
  ];
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground">
              Project future goal with inflation
            </p>
          </div>
        </div>
        <Switch
          ...
          <CardHeader>
            <div className="flex items-start justify-between gap-4 mb-2">
              <div className="flex-1">
                ...
                <CardDescription>
                  Calculate the monthly SIP needed to achieve your financial
                  goals
                </CardDescription>
              </div>
            ...
            <div className="flex flex-wrap gap-2 mt-4 pt-4 border-t border-border">
              ...
              {[
                {
                  label: "Dream Home ₹50L 10yr",
                  goal: 5000000,
                  yrs: 10,
                  ret: 12,
                },
                {
                  label: "Child Education ₹20L 8yr",
                  goal: 2000000,
                  yrs: 8,
                  ret: 12,
                },
          ...
          <CardContent className="pt-4 sm:pt-6 relative z-10">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 sm:gap-3 mb-4">
              ...
              <div className="text-center p-6 md:p-8 sm:p-4 bg-card rounded-sm shadow-sm border border-border">
                ...
                <p className="text-base sm:text-lg font-extrabold text-primary">
                  {formatCurrency(result.futureGoal)}
                </p>
              </div>
              <div className="text-center p-6 md:p-8 sm:p-4 bg-card rounded-sm shadow-sm border border-border">
                <p className="text-[9px] sm:text-[10px] font-bold text-muted-foreground uppercase tracking-widest mb-1.5 sm:mb-2">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gradient-to-br from-emerald-50 to-emerald-50 dark:from-emerald-950/30 dark:to-emerald-950/30 rounded-sm p-5 border border-emerald-100 dark:border-emerald-900/50 relative overflow-hidden">
                ...
                <p className="text-lg font-medium text-emerald-900 dark:text-emerald-100 mb-3">
                  ...
                  <span className="font-bold">
                    {formatCurrency(result.requiredSIP)}/month
                  </span>{" "}
                  to reach your{" "}
                  <span className="font-bold">
                    {formatCurrency(goalAmount)}
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  >
                    ...
                    {adjustForInflation ? "Inflation Adjusted" : "Nominal Goal"}
                  </Badge>
                </div>
              </div>
              ...
              <div className="p-5 bg-card rounded-sm border border-border shadow-sm mt-4">
                ...
                <p className="text-xs text-muted-foreground mb-4">
                  Get a personalized investment plan with top fund
                  recommendations to achieve your {formatCurrency(goalAmount)}{" "}
                  goal in {years} years.
                </p>
