...
export function NPSCalculator() {
  ...
  const generateYearlyData = () => {
    ...
    for (let year = 0; year <= yearsToRetirement; year++) {
      ...
      const realValue = adjustForInflation
        ? corpus / Math.pow(1 + inflationRate / 100, year)
        : corpus;
  ...
  const npsChartData = [
    ...
    {
      name: "Returns",
      value: adjustForInflation ? result.realReturns : result.returns,
      color: "#16a34a",
    },
  ];
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                NPS typically returns 8-14% based on asset allocation
              </p>
            </div>
            ...
            <div className="p-3 bg-primary/10 border border-primary/20 rounded-sm">
              ...
              <p className="text-xs text-primary">
                ✓ 80CCD(1B): ₹50K extra • Employer: ₹7.5L • 60% tax-free
                withdrawal
              </p>
            </div>
          </CardContent>
        ...
        >
          ...
          <CardContent className="pt-4 sm:pt-6 relative z-10">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 sm:gap-3 mb-4">
              ...
              <div className="text-center p-6 md:p-8 sm:p-4 bg-card rounded-sm shadow-sm border border-border">
                ...
                <p className="text-base sm:text-lg font-extrabold text-primary">
                  {formatCurrency(
                    adjustForInflation ? result.realReturns : result.returns,
                  )}
                </p>
              </div>
              <div className="text-center p-6 md:p-8 sm:p-4 bg-card rounded-sm shadow-sm border border-border">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
              <div className="text-center p-3 sm:p-4 bg-card rounded-sm shadow-sm border border-border">
                ...
                <p className="text-sm sm:text-base font-extrabold text-primary">
                  {formatCurrency(result.withdrawableAmount)}
                </p>
              </div>
              <div className="text-center p-3 sm:p-4 bg-card rounded-sm shadow-sm border border-border">
                <p className="text-[9px] sm:text-[10px] font-bold text-muted-foreground uppercase tracking-widest mb-1">
                    ...
                    <table className="w-full min-w-full sm:min-w-[500px]">
                      <thead className="bg-muted border-b border-border">
                        <tr>
                          ...
                          <th className="px-3 py-2 text-right text-xs font-bold text-muted-foreground uppercase tracking-wider">
                            {adjustForInflation ? "Real Value" : "Nominal"}
                          </th>
                        </tr>
                      </thead>
              ...
              <div className="p-5 bg-card rounded-sm border border-border shadow-sm mt-4">
                <div className="flex items-center justify-between mb-3">
                  <h3 className="font-bold text-foreground flex items-center gap-2">
                    ...
                    Get NPS vs EPF vs PPF Report (Free)
                  </h3>
                ...
                <p className="text-xs text-muted-foreground mb-4">
                  Compare NPS with EPF and PPF to find the best retirement
                  strategy for your {formatCurrency(monthlyContribution)}/month
                  contribution.
                </p>
