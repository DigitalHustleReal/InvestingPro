...
export function SIPCalculatorWithInflation() {
  ...
  const sipChartData = [
    ...
    {
      name: "Returns",
      value: adjustForInflation ? sipResult.realReturns : sipResult.returns,
      color: "#16a34a",
    },
  ];
  ...
  const generateYearlyData = () => {
    ...
    for (let year = 0; year <= years; year++) {
      ...
      const realValue = adjustForInflation
        ? currentFutureValue / Math.pow(1 + inflationRate / 100, year)
        : currentFutureValue;
    ...
    <div className="space-y-6 pb-20 md:pb-6">
      ...
      <div className="grid lg:grid-cols-2 gap-6">
          ...
          <CardHeader>
            <div className="flex items-start justify-between gap-4 mb-2">
              <div className="flex-1">
                ...
                <CardDescription>
                  Calculate returns on systematic investment plan with inflation
                  adjustment
                </CardDescription>
              </div>
        ...
        <Card
          ...
          className="order-first lg:order-none border-border shadow-sm rounded-sm bg-gradient-to-br from-primary/5 to-secondary/5 relative overflow-hidden scroll-mt-4"
        >
            ...
            <div className="space-y-4">
                    ...
                    {(adjustForInflation
                      ...
                      <>
                        ...
                        <Badge
                          ...
                          className="bg-white/50 border-emerald-200 text-emerald-800 flex items-center gap-1"
                        >
                          <GraduationCap className="w-3 h-3" /> Child's
                          Education
                        </Badge>
                      </>
                    ) : (adjustForInflation
                        ? sipResult.realValue
                        : sipResult.futureValue) > 500000 ? (
                      <>
                        <Badge
                          variant="outline"
                          className="bg-white/50 border-emerald-200 text-emerald-800 flex items-center gap-1"
              ...
              <div className="p-5 bg-card rounded-sm border border-border shadow-sm mt-4">
                ...
                <p className="text-xs text-muted-foreground mb-4">
                  Receive a personalized investment plan with top fund
                  recommendations for your goal of{" "}
                  {formatCurrency(
                    adjustForInflation
                      ? sipResult.realValue
                      : sipResult.futureValue,
