...
export function SIPCalculatorWithInflation() {
    ...
    const sipChartData = [
        { name: 'Invested', value: sipResult.invested, color: '#166534' },
        { name: 'Returns', value: adjustForInflation ? sipResult.realReturns : sipResult.returns, color: '#16a34a' },
    ];
                    ...
                    {inputsExpanded && (
                        <CardContent className="space-y-4 pt-0">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="space-y-2">
                                    <div className="flex justify-between items-center">
                                        <Label className="text-sm text-foreground font-semibold">Expected Return</Label>
                                        <div className="flex items-center gap-1.5 bg-muted rounded-lg px-3 py-1.5">
                                ...
                                <div className="flex items-center justify-between p-3 bg-muted/50 rounded-sm border border-border">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <div>
                                            <Label className="text-sm text-foreground font-semibold">Annual Step-Up</Label>
                                            <p className="text-xs text-muted-foreground">Increase investment yearly</p>
                                        </div>
                                    </div>
                                    <Switch
                                ...
                                {enableStepUp && (
                                    <div className="space-y-2">
                                        <div className="flex justify-between items-center">
                                            <Label className="text-sm text-foreground font-semibold">Step-Up %</Label>
                                            <div className="flex items-center gap-1.5 bg-muted rounded-lg px-3 py-1.5">
                                                <Percent className="w-3.5 h-3.5 text-muted-foreground" />
                                                <span className="text-sm font-bold text-foreground">{stepUpRate}%</span>
                                            </div>
                                        </div>
                                        <Slider
                                            value={[stepUpRate]}
                ...
                <Card className="hidden lg:block border-border shadow-sm rounded-sm">
                    ...
                    <CardContent className="space-y-4">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-2">
                                <div className="flex justify-between items-center">
                                    <Label className="text-sm text-foreground font-semibold">Monthly Investment</Label>
                                    <div className="flex items-center gap-1.5 bg-muted rounded-lg px-3 py-1.5">
                                        <IndianRupee className="w-3.5 h-3.5 text-muted-foreground" />
                                        <Input
                                            type="number"
                        ...
                        {enableStepUp && (
                            <div className="space-y-2">
                                <div className="flex justify-between items-center">
                                    <Label className="text-sm text-foreground font-semibold">Step-Up Percentage</Label>
                                    <div className="flex items-center gap-1.5 bg-muted rounded-lg px-3 py-1.5">
                                        <Percent className="w-3.5 h-3.5 text-muted-foreground" />
                                        <span className="text-sm font-bold text-foreground">{stepUpRate}%</span>
                                    </div>
                            ...
                            <ResponsiveContainer width="100%" height="100%">
                                <AreaChart data={growthData}>
                                    <defs>
                                        ...
                                        <linearGradient id="colorSIPReal" x1="0" y1="0" x2="0" y2="1">
                                    ...
                                    />
                                    <Area type="monotone" dataKey="value" stroke="#166534" fill="url(#colorSIPNominal)" strokeWidth={2} name="Nominal" />
                                    {adjustForInflation && (
                                        <Area type="monotone" dataKey="realValue" stroke="#d97706" fill="url(#colorSIPReal)" strokeWidth={2} name="Real (Inflation Adjusted)" />
                                    )}
                                </AreaChart>
                            </ResponsiveContainer>
                        </div>
