                        ...
                        <CardContent className="space-y-4 pt-0">
                            ...
                            <div className="grid grid-cols-3 gap-2 p-3 bg-slate-50 dark:bg-slate-800 rounded-lg mb-4">
                                <div className="text-center">
                                    ...
                                    <p className="text-sm font-bold text-slate-900 dark:text-slate-100">{formatCurrency(monthlyInvestment)}</p>
                                </div>
                                <div className="text-center">
                                    <p className="text-xs text-slate-500 mb-1">Years</p>
                                    <p className="text-sm font-bold text-slate-900 dark:text-slate-100">{years}</p>
                                </div>
                                <div className="text-center">
                                    <p className="text-xs text-slate-500 mb-1">Return</p>
                                    <p className="text-sm font-bold text-slate-900 dark:text-slate-100">{expectedReturn}%</p>
                                </div>
                            </div>
