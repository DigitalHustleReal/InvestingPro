  ...
  const calculateRD = () => {
    ...
    for (let i = 0; i < totalMonths; i++) {
      ...
      const installmentMaturity =
        monthlyDeposit * Math.pow(1 + interestRate / 400, 4 * t);
          ...
          <CardHeader>
            <div className="flex items-start justify-between gap-4 mb-2">
              <div className="flex-1">
                ...
                <CardDescription>
                  Calculate maturity amount for Recurring Deposits with
            ...
            <div className="space-y-4">
              ...
              <div className="p-5 bg-card rounded-sm border border-border shadow-sm mt-4">
                ...
                <p className="text-xs text-muted-foreground mb-4">
                  Get the best RD rates from top banks and a personalized
                  savings plan to maximize your {formatCurrency(monthlyDeposit)}
                  /month deposit.
                </p>
