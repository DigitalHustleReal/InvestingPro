...
export default function InsuranceCoverageCalculator() {
  ...
  const pieData = [
    {
      ...
      value: result.coverageBreakdown.futureIncome,
      color: "#166534",
    },
    {
      name: "Loan Cover",
      value: result.coverageBreakdown.loans,
      color: "#16a34a",
    },
    {
      name: "Dependent Support",
      value: result.coverageBreakdown.dependents,
      color: "#d97706",
    },
  ];
  ...
  const barData = [
    ...
    {
      name: "Income Replacement",
      amount: result.coverageBreakdown.futureIncome,
    },
          ...
          <CardHeader>
            <div className="flex items-start justify-between gap-4 mb-2">
              <div className="flex-1">
                ...
                <CardDescription>
                  Calculate how much life insurance you need to protect your
                  family
                </CardDescription>
              </div>
              ...
              {[
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    setDependents(preset.deps);
                    setExistingLoans(preset.loans);
          ...
          <CardContent className="pt-4 sm:pt-6 relative z-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 sm:gap-3 mb-4">
              <div className="text-center p-3 sm:p-5 bg-card rounded-sm shadow-sm border border-border">
                <p className="text-[9px] sm:text-[10px] font-bold text-muted-foreground uppercase tracking-widest mb-1.5">
                  Income Replacement
                </p>
                <p className="text-base sm:text-lg font-extrabold text-primary">
                  {formatCurrency(result.coverageBreakdown.futureIncome)}
                </p>
              </div>
              <div className="text-center p-3 sm:p-5 bg-card rounded-sm shadow-sm border border-border">
                <p className="text-[9px] sm:text-[10px] font-bold text-muted-foreground uppercase tracking-widest mb-1.5">
                ...
                <p className="text-base sm:text-lg font-extrabold text-foreground">
                  {formatCurrency(result.coverageBreakdown.loans)}
                </p>
              </div>
              <div className="text-center p-3 sm:p-5 bg-card rounded-sm shadow-sm border border-border">
                <p className="text-[9px] sm:text-[10px] font-bold text-muted-foreground uppercase tracking-widest mb-1.5">
                ...
                <p className="text-base sm:text-lg font-extrabold text-foreground">
                  {formatCurrency(result.coverageBreakdown.dependents)}
                </p>
              </div>
            </div>
            ...
            <div className="p-4 bg-card rounded-sm border border-border mb-4">
              ...
              <div className="flex items-center justify-between">
                <p className="text-lg font-bold text-foreground">
                  {formatCurrency(result.estimatedAnnualPremium)}
                </p>
                <Badge
                  variant="outline"
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="p-4 bg-muted rounded-sm border border-border">
                  ...
                  <p className="text-lg font-bold text-primary">
                    {Math.max(retirementAge - currentAge, 0)} yrs
                  </p>
                </div>
              </div>
              ...
              <div className="overflow-hidden rounded-sm border border-border">
                <table className="w-full">
                  ...
                  <tbody className="divide-y divide-border">
                    ...
                    <tr className="hover:bg-muted/50 transition-colors">
                      <td className="px-3 py-2.5 text-sm font-semibold text-foreground">
                        Dependent Support ({dependents} × ₹5L)
                      </td>
                      <td className="px-3 py-2.5 text-sm text-right font-semibold text-primary">
                        {formatCurrency(result.coverageBreakdown.dependents)}
                      </td>
              ...
              <div className="bg-gradient-to-br from-emerald-50 to-emerald-50 dark:from-emerald-950/30 dark:to-emerald-950/30 rounded-sm p-5 border border-emerald-100 dark:border-emerald-900/50 relative overflow-hidden">
                ...
                <p className="text-lg font-medium text-emerald-900 dark:text-emerald-100 mb-3">
                  ...
                  life cover. At{" "}
                  <span className="font-bold">
                    {formatCurrency(result.estimatedAnnualPremium)}/year
                  </span>
                  , this costs just{" "}
                  <span className="font-bold">₹{dailyCost}/day</span> for
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  >
                    <Shield className="w-3 h-3" /> {dependents} dependents
                    protected
                  </Badge>
                  <Badge
                    variant="outline"
              ...
              <div className="p-5 bg-card rounded-sm border border-border shadow-sm mt-4">
                ...
                <p className="text-xs text-muted-foreground mb-4">
                  Compare term insurance plans — get quotes in 2 minutes for{" "}
                  {formatCurrency(result.recommendedCoverage)} coverage.
                </p>
