...
export function EMICalculatorEnhanced() {
  ...
  const calculateEMI = () => {
    ...
    const emi =
      (emiLoan * monthlyRate * Math.pow(1 + monthlyRate, months)) /
  ...
  const interestRatio = (
    (emiResult.totalInterest / emiResult.totalPayment) *
    100
  ).toFixed(1);
  ...
  const inputSliders = (
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        <Slider
          value={[emiLoan]}
          onValueChange={(v) => setEmiLoan(v[0])}
          min={100000}
          max={20000000}
          step={100000}
          className="py-2"
            ...
            <div className="group relative">
              ...
              <div className="absolute left-0 bottom-full mb-2 w-72 p-3 bg-gray-900 text-white text-xs rounded-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-50 shadow-xl">
                ...
                <div className="text-[10px] font-mono leading-relaxed">
                  ...
                  <br />P = Principal, r = Monthly Rate, n = Months
                  <div className="mt-2 pt-2 border-t border-gray-700 text-ink/20">
          ...
          <CardHeader>
            <div className="flex items-start justify-between gap-4 mb-2">
              <div className="flex-1">
                ...
                <CardDescription>
                  Calculate your monthly loan EMI with detailed breakdown
                </CardDescription>
              </div>
            ...
            <div className="space-y-4">
                      ...
                      <tbody className="divide-y divide-border">
                        {(showAllYears
                          ...
                          >
                            ...
                            <td className="px-3 py-2.5 text-sm text-right font-semibold text-muted-foreground">
              ...
              <div className="bg-gradient-to-br from-emerald-50 to-emerald-50 dark:from-emerald-950/30 dark:to-emerald-950/30 rounded-sm p-5 border border-emerald-100 dark:border-emerald-900/50 relative overflow-hidden">
                ...
                <p className="text-lg font-medium text-emerald-900 dark:text-emerald-100 mb-3">
                  Your{" "}
                  <span className="font-bold">{formatCurrency(emiLoan)}</span>{" "}
                  loan costs{" "}
                  ...
                  in interest. Your EMI is{" "}
                  <span className="font-bold">
                    {formatCurrency(emiResult.emi)}/month
                  </span>
                  .
                </p>
                <div className="flex flex-wrap gap-2">
                  ...
                  >
                    <TrendingDown className="w-3 h-3" /> {interestRatio}% goes
                    to interest
                  </Badge>
                  <Badge
                    variant="outline"
              ...
              <div className="p-5 bg-card rounded-sm border border-border shadow-sm mt-4">
                ...
                <p className="text-xs text-muted-foreground mb-4">
                  Compare top loan offers with lowest interest rates. Save on
                  your {formatCurrency(emiResult.totalInterest)} interest
                  burden.
                </p>
