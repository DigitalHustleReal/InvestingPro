...
export function EMICalculatorEnhanced() {
    ...
    const emiChartData = [
        { name: 'Principal', value: emiLoan, color: '#0088cc' },
        { name: 'Interest', value: emiResult.totalInterest, color: '#17a697' },
    ];
            ...
            <div className="grid lg:grid-cols-2 gap-6">
                    ...
                    <CardHeader>
                        <div className="flex items-start justify-between gap-4 mb-2">
                            ...
                            <div className="flex flex-col gap-1.5 items-end">
                                ...
                                <Badge variant="secondary" className="bg-primary/10 text-primary border-primary/20 hover:bg-primary/20 text-[10px]">
                ...
                <Card className="border-border shadow-sm rounded-xl bg-gradient-to-br from-primary/5 to-secondary/5 relative overflow-hidden">
                    ...
                    <CardContent className="pt-4 sm:pt-6 relative z-10">
                        <div className="text-center p-6 md:p-8 sm:p-6 bg-card rounded-xl shadow-sm border border-border mb-4">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 sm:gap-3 mb-4">
                            <div className="text-center p-3 sm:p-5 bg-card rounded-xl shadow-sm border border-border">
                                ...
                                <p className="text-base sm:text-lg font-extrabold text-secondary">{formatCurrency(emiLoan)}</p>
                            </div>
                            <div className="text-center p-3 sm:p-5 bg-card rounded-xl shadow-sm border border-border">
                        ...
                        <div className="h-80">
                            <ResponsiveContainer width="100%" height="100%">
                                <BarChart data={emiResult.schedule}>
                                    ...
                                    />
                                    <Legend />
                                    <Bar dataKey="principal" stackId="a" fill="#0088cc" name="Principal" />
                                    <Bar dataKey="interest" stackId="a" fill="#17a697" name="Interest" />
                                </BarChart>
                            </ResponsiveContainer>
                        </div>
                    </CardContent>
                                            ...
                                            <tbody className="divide-y divide-border">
                                                ...
                                                {yearlyData.length > 10 && (
                                                    <tr className="bg-muted/30">
                                                        <td colSpan={4} className="px-3 py-2 text-xs text-center text-muted-foreground font-medium">
