  ...
  return (
    <Card className={cn("p-6 md:p-8", className)}>
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h3 className="text-xl font-display font-bold text-ink dark:text-white">SIP Calculator</h3>
          <p className="text-sm text-ink-60 dark:text-ink-60">Plan your wealth creation journey</p>
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          {/* Monthly Investment */}
          <div>
            <label className="flex items-center gap-2 text-sm font-display font-semibold text-ink dark:text-white mb-2">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  value={monthlyInvestment}
                  onChange={(e) => setMonthlyInvestment(Number(e.target.value))}
                  className="flex-1 px-4 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-white rounded-lg font-mono text-lg font-semibold focus:ring-2 focus:ring-primary-600 focus:border-transparent"
                />
                <span className="text-ink-60 dark:text-ink-60 font-medium">/month</span>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="flex-1 px-4 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-white rounded-lg font-mono text-lg font-semibold focus:ring-2 focus:ring-primary-600 focus:border-transparent"
                />
                <span className="text-ink-60 dark:text-ink-60 font-medium">years</span>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="flex-1 px-4 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-white rounded-lg font-mono text-lg font-semibold focus:ring-2 focus:ring-primary-600 focus:border-transparent"
                />
                <span className="text-ink-60 dark:text-ink-60 font-medium">% p.a.</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-gradient-to-br from-primary-600 to-success-600 text-white rounded-sm p-6">
          ...
          <div className="space-y-3">
            {/* Total Invested */}
            <div className="flex items-center justify-between p-4 bg-canvas dark:bg-gray-800/50 rounded-lg border border-ink/10 dark:border-gray-700">
              <div>
                <p className="text-xs text-ink-60 dark:text-ink-60 mb-1">Amount Invested</p>
                <p className="text-xl font-bold font-mono text-ink dark:text-white">
          ...
          {/* Composition Bar */}
          <div className="pt-4">
            <p className="text-xs font-semibold text-ink dark:text-ink/20 mb-2">Investment Composition</p>
            ...
            <div className="flex justify-between mt-2 text-xs text-ink-60 dark:text-ink-60">
