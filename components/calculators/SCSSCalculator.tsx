        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center gap-1.5 bg-muted rounded-lg px-3 py-1.5">
            ...
            <Input
              ...
              value={investment}
              onChange={(e) =>
                setInvestment(Math.min(Number(e.target.value), 3000000))
              }
      ...
      <div className="p-4 bg-muted/50 rounded-sm border border-border flex items-start gap-3">
        ...
        <div>
          ...
          <p className="text-xs text-muted-foreground leading-relaxed">
            Interest paid every quarter (April, July, Oct, Jan). Max deposit
            ₹30L. TDS applicable if interest exceeds ₹50,000/yr.
          </p>
        </div>
      </div>
    </div>
            ...
            <CardContent className="space-y-4 pt-0">
              <div className="grid grid-cols-3 gap-2 p-3 bg-muted rounded-lg mb-4">
                ...
                <div className="text-center">
                  ...
                  <p className="text-xs font-bold text-foreground">
                    {formatCurrency(Math.round(quarterlyInterest))}
                  </p>
                </div>
              </div>
              {inputSliders}
          ...
          <CardHeader>
            <div className="flex items-start justify-between gap-4 mb-2">
              <div className="flex-1">
                ...
                <CardDescription>
                  Senior Citizen Savings Scheme — Guaranteed quarterly income
                </CardDescription>
              </div>
          ...
          <CardContent className="pt-4 sm:pt-6 relative z-10">
            ...
            <div className="flex justify-center mb-3">
              <span className="inline-flex items-center gap-1.5 text-xs bg-muted px-3 py-1.5 rounded-full border border-border text-muted-foreground">
                ...
                {formatCurrency(Math.round(quarterlyInterest / 3))}/month
                effective · {interestRate}% p.a.
              </span>
            </div>
            {/* Pie chart */}
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="p-4 bg-primary-50 rounded-sm border border-primary-100">
                  ...
                  <p className="text-lg font-bold text-foreground">
                    {formatCurrency(Math.round(annualInterest / 12))}
                  </p>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-emerald-50 to-emerald-50 dark:from-emerald-950/30 dark:to-emerald-950/30 rounded-sm p-5 border border-emerald-100 dark:border-emerald-900/50 relative overflow-hidden">
                ...
                <p className="text-lg font-medium text-emerald-900 dark:text-emerald-100 mb-3">
                  You earn {formatCurrency(Math.round(quarterlyInterest))}{" "}
                  quarterly income (
                  {formatCurrency(Math.round(annualInterest / 12))}/month
                  effective) from your SCSS deposit of{" "}
                  {formatCurrency(investment)}.
                </p>
              ...
              <div className="p-5 bg-card rounded-sm border border-border shadow-sm mt-4">
                ...
                <p className="text-xs text-muted-foreground mb-4">
                  Get a complete SCSS income projection with quarterly payout
                  schedule, TDS implications, and retirement planning tips.
                </p>
