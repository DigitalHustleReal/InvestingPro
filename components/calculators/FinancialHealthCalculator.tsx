...
export function FinancialHealthCalculator() {
  ...
  const calculateHealth = () => {
    ...
    if (savingsRate < 20)
      insights.push({
        type: "warning",
        text: "Try to increase your savings rate to at least 20%.",
      });
    ...
    if (emergencyMonths >= 6) score += 20;
      ...
      insights.push({
        type: "critical",
        text: "Your emergency fund is critically low.",
      });

    if (emergencyMonths < 6)
      insights.push({
        type: "info",
        text: `Build emergency fund to cover 6 months expenses (₹${(monthlyExpenses * 6).toLocaleString()}).`,
      });
    ...
    if (dti === 0) score += 20;
      ...
      insights.push({
        type: "danger",
        text: "Your debt payments are consuming too much of your income.",
      });
    }
    ...
    if (hasHealthInsurance) score += 10;
      ...
      insights.push({
        type: "warning",
        text: "Get health insurance to protect your savings.",
      });
    ...
    if (hasTermInsurance) score += 10;
      ...
      insights.push({
        type: "info",
        text: "Consider term insurance if you have dependents.",
      });
    ...
    return {
      ...
      metrics: {
        ...
        insuranceScore:
          (hasHealthInsurance ? 10 : 0) + (hasTermInsurance ? 10 : 0),
  ...
  const scoreBreakdownData = [
    {
      ...
      score: result.metrics.savingsScore,
      ideal: 20,
    },
    {
      component: "Emergency Fund",
      score: result.metrics.emergencyScore,
      ideal: 20,
    },
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-1.5 bg-muted rounded-lg px-3 py-1.5">
                    ...
                    <Input
                      ...
                      className="border-0 bg-transparent p-0 text-right text-sm font-bold focus-visible:ring-0"
                    />
                  </div>
                  <Slider
                    value={[monthlyIncome]}
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-1.5 bg-muted rounded-lg px-3 py-1.5">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setMonthlyDebtPayments(Number(e.target.value))
                      }
                      className="border-0 bg-transparent p-0 text-right text-sm font-bold focus-visible:ring-0"
                    />
                  </div>
        ...
        <Card className="hidden lg:block border-border shadow-sm rounded-sm">
          <CardHeader>
            <div className="flex items-start justify-between gap-4 mb-2">
              <div className="flex-1">
                ...
                <CardDescription>
                  Enter your details to get a comprehensive financial health
                  score out of 100
                </CardDescription>
              </div>
          ...
          <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-1.5 bg-muted rounded-lg px-3 py-1.5">
                  ...
                  <Input
                    ...
                    value={monthlyIncome}
                    onChange={(e) => setMonthlyIncome(Number(e.target.value))}
                    className="border-0 bg-transparent p-0 text-right text-sm font-bold focus-visible:ring-0 w-full"
                  />
                </div>
                <Slider
                  value={[monthlyIncome]}
            ...
            <div className="space-y-4 pt-2">
              ...
              <div className="space-y-2">
                <Label className="text-sm font-medium text-foreground">
                  Total Liquid Savings (Cash/Bank)
                </Label>
                <div className="flex items-center gap-1.5 bg-muted rounded-lg px-3 py-1.5">
                  <IndianRupee className="w-3.5 h-3.5 text-muted-foreground" />
                  <Input
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-1.5 bg-muted rounded-lg px-3 py-1.5">
                  ...
                  <Input
                    type="number"
                    value={investmentCorp}
                    onChange={(e) => setInvestmentCorp(Number(e.target.value))}
                    className="border-0 bg-transparent p-0 text-right text-sm font-bold focus-visible:ring-0 w-full"
                  />
                </div>
              </div>
            ...
            <div className="space-y-4 pt-2">
              ...
              <div className="flex items-center justify-between p-3 bg-muted/50 rounded-sm border border-border">
                ...
                <Switch
                  ...
                  onCheckedChange={setHasTermInsurance}
                />
              </div>
            </div>
          </CardContent>
        ...
        >
          ...
          <CardContent className="pt-4 sm:pt-6 relative z-10">
            ...
            <div className="flex flex-col items-center justify-center py-6 bg-card rounded-sm border border-border mb-4">
              ...
              <div className="mt-3">
                <Badge
                  className="text-white px-4 py-1 text-sm font-bold"
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="text-center p-3 bg-card rounded-sm shadow-sm border border-border">
                ...
                <p className="text-base font-extrabold text-foreground">
                  {result.metrics.emergencyMonths} Mo
                </p>
              </div>
              <div className="text-center p-3 bg-card rounded-sm shadow-sm border border-border">
                <p className="text-[9px] font-bold text-muted-foreground uppercase tracking-widest mb-1">
              ...
              <div className="text-center p-3 bg-card rounded-sm shadow-sm border border-border">
                ...
                <p className="text-base font-extrabold text-foreground">
                  {result.metrics.netWorthRatio}x
                </p>
              </div>
            </div>
          </CardContent>
            ...
            <div className="space-y-4">
                      ...
                      <tbody className="divide-y divide-border">
                        {scoreBreakdownData.map((row, idx) => (
                          ...
                          >
                            ...
                            <td
                              className="px-3 py-2.5 text-sm text-right font-bold"
                              style={{
                                color:
                                  row.score >= 16
                                    ? "#166534"
              ...
              {result.insights.length > 0 && (
                <div className="space-y-2">
                  <h4 className="text-xs font-bold text-foreground uppercase tracking-widest flex items-center gap-2">
                    <TrendingUp className="w-3.5 h-3.5 text-primary" /> Action
                    Plan
                  </h4>
                      ...
                      className={`flex gap-3 p-3 rounded-lg border text-sm ${
                        insight.type === "danger"
                          ...
                          : insight.type === "warning"
                            ? "bg-indian-gold/10 border-amber-100 text-amber-800 dark:bg-amber-950/30 dark:border-amber-900/50 dark:text-amber-200"
                            : insight.type === "critical"
                              ? "bg-destructive/15 border-destructive/30 text-destructive font-bold"
              ...
              <div className="bg-gradient-to-br from-emerald-50 to-emerald-50 dark:from-emerald-950/30 dark:to-emerald-950/30 rounded-sm p-5 border border-emerald-100 dark:border-emerald-900/50 relative overflow-hidden">
                ...
                <p className="text-lg font-medium text-emerald-900 dark:text-emerald-100 mb-3">
                  ...
                  <span className="font-bold text-2xl underline decoration-emerald-400 decoration-2 underline-offset-2">
                    {result.score}/100
                  </span>{" "}
                  (Grade: {result.grade}).
                  {result.score >= 80
                    ? " Excellent financial health! Keep maintaining these habits."
                    : result.score >= 60
                      ? " Good financial health — a few tweaks can make it excellent."
                      : result.score >= 40
                        ? " Fair financial health — focus on savings rate and emergency fund."
              ...
              <div className="p-5 bg-card rounded-sm border border-border shadow-sm mt-4">
                <div className="flex items-center justify-between mb-3">
                  <h3 className="font-bold text-foreground flex items-center gap-2">
                    ...
                    Get Personalized Health Plan (Free)
                  </h3>
                ...
                <p className="text-xs text-muted-foreground mb-4">
                  Receive a personalized financial health improvement plan with
                  actionable steps to reach score 80+.
                </p>
