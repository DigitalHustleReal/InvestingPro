                ...
                <Card className="border-border shadow-sm rounded-xl">
                    <CardHeader>
                        <div className="flex items-start justify-between gap-4 mb-2">
                            ...
                            <div className="flex flex-col gap-1.5 items-end">
                                <Badge variant="secondary" className="bg-success/10 text-success-700 dark:text-success-400 border-success/20">
                    ...
                    <CardContent className="space-y-6">
                        ...
                        <div className="space-y-3">
                            ...
                            <p className="text-[10px] text-muted-foreground">Current Rate: 7.5%</p>
                        </div>
                     ...
                     <CardContent className="pt-8 relative z-10 flex flex-col justify-between h-full">
                        <div className="text-center mb-8">
                             ...
                             <div className="inline-flex items-center gap-2 bg-card/50 px-3 py-1 rounded-full border border-border">
                                <span className="text-xs font-medium text-muted-foreground">Invested: {formatCurrency(investment)}</span>
                                <span className="text-muted-foreground">|</span>
                                <span className="text-xs font-bold text-primary">2x Returns</span>
                             </div>
                        </div>

                        <div className="grid grid-cols-2 gap-4">
                            <div className="p-4 bg-card/60 backdrop-blur-sm rounded-xl border border-border">
                            ...
                            <AreaChart data={result.data}>
                                <defs>
                                    <linearGradient id="colorKVP" x1="0" y1="0" x2="0" y2="1">
                                        <stop offset="5%" stopColor="#17a697" stopOpacity={0.2}/>
                                ...
                                />
                                <Area type="step" dataKey="amount" stroke="#17a697" fill="url(#colorKVP)" strokeWidth={2} name="Value" />
                            </AreaChart>
                        </ResponsiveContainer>
                    </div>
                 </CardContent>
