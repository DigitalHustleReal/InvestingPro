...
export function KVPCalculator() {
    ...
    const chartData = [
        ...
        { name: 'Interest Earned', value: Math.round(maturityAmount - investment), color: '#16a34a' },
    ];
        ...
        <div className="space-y-4">
            ...
            <div className="space-y-3">
                <div className="flex justify-between items-center">
                    <Label className="text-sm font-semibold text-foreground">One-time Investment</Label>
                ...
                <div className="flex justify-between text-[10px] text-muted-foreground">
                    <span>Min: ₹1,000</span><span>₹10 L</span>
                </div>
            </div>
            ...
            <div className="p-4 bg-muted/50 rounded-xl border border-border flex items-start gap-3">
                ...
                <div>
                    ...
                    <p className="text-xs text-muted-foreground leading-relaxed">
                        At {interestRate}%, your KVP doubles in <span className="font-bold text-foreground">{doublingYears} years &amp; {doublingMonths} months</span> ({totalMonths} months total).
                    </p>
                </div>
            </div>
        </div>
                    ...
                    {inputsExpanded && (
                        <CardContent className="space-y-4 pt-0">
                            <div className="grid grid-cols-3 gap-2 p-3 bg-muted rounded-lg mb-4">
                                ...
                                <div className="text-center">
                                    <p className="text-[10px] text-muted-foreground">Doubles In</p>
                                    <p className="text-xs font-bold text-foreground">{doublingYears}Y {doublingMonths}M</p>
                                </div>
                            </div>
                            {inputSliders}
                        </CardContent>
                    ...
                    <CardHeader>
                        <div className="flex items-start justify-between gap-4 mb-2">
                            <div className="flex-1">
                                ...
                                <CardDescription>Kisan Vikas Patra — Government guaranteed doubling scheme</CardDescription>
                            </div>
                        ...
                        <div className="h-80 lg:h-96">
                            <ResponsiveContainer width="100%" height="100%">
                                <AreaChart data={growthData}>
                                    <defs>
                                        <linearGradient id="colorKVPValue" x1="0" y1="0" x2="0" y2="1">
                                    ...
                                    <Area type="monotone" dataKey="value" stroke="#166534" fill="url(#colorKVPValue)" strokeWidth={2} name="Value" />
                                </AreaChart>
                            </ResponsiveContainer>
                        </div>
                    </CardContent>
                        ...
                        <div className="space-y-4">
                                        ...
                                        <table className="w-full min-w-full sm:min-w-[500px]">
                                            ...
                                            <tbody className="divide-y divide-border">
                                                ...
                                                <tr className="bg-primary/10 border-t-2 border-primary/20">
                                                    ...
                                                    <td className="px-3 py-3 text-sm text-right font-bold text-primary">{formatCurrency(Math.round(maturityAmount - investment))}</td>
                                                    <td className="px-3 py-3 text-sm text-right font-bold text-primary">{formatCurrency(maturityAmount)}</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                            ...
                            <div className="bg-gradient-to-br from-emerald-50 to-emerald-50 dark:from-emerald-950/30 dark:to-emerald-950/30 rounded-xl p-5 border border-emerald-100 dark:border-emerald-900/50 relative overflow-hidden">
                                ...
                                <p className="text-lg font-medium text-emerald-900 dark:text-emerald-100 mb-3">
                                    Your {formatCurrency(investment)} KVP will double to {formatCurrency(maturityAmount)} in ~{totalMonths} months ({doublingYears} years {doublingMonths} months) — a government-guaranteed 2x return!
                                </p>
                            ...
                            <div className="p-5 bg-card rounded-xl border border-border shadow-sm mt-4">
                                ...
                                <p className="text-xs text-muted-foreground mb-4">Receive a complete KVP analysis with year-wise growth projection, doubling timeline, and comparison with other government schemes.</p>
