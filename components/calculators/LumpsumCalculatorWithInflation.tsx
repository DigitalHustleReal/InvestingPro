                        ...
                        <div className="h-80 lg:h-96">
                            <ResponsiveContainer width="100%" height="100%">
                                <AreaChart data={growthData}>
                                    ...
                                    {adjustForInflation && (
                                        <Area type="monotone" dataKey="realValue" stroke="#0ea5e9" fill="url(#colorLumpsumReal)" strokeWidth={2} name="Real (Inflation Adjusted)" /> {/* secondary-500 */}
                                    )}
                                </AreaChart>
                            </ResponsiveContainer>
                        </div>
                                            ...
                                            <tbody className="divide-y divide-slate-100">
                                                ...
                                                {yearlyData.length > 0 && (
                                                    <tr className="bg-primary-50 border-t-2 border-primary-200">
                                                        ...
                                                        <td className="px-3 py-3 text-sm text-right font-bold text-primary-600">{formatCurrency(adjustForInflation ? lumpsumResult.realValue : lumpsumResult.futureValue)}</td>
                                                    </tr>
                                                )}
                                            </tbody>
                                        </table>
