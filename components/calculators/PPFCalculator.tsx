...
export function PPFCalculator() {
  ...
  const calculatePPF = () => {
    ...
    for (let year = 1; year <= years; year++) {
      ...
      maturityAmount =
        (maturityAmount + annualContribution) * (1 + interestRate / 100);
    }
        ...
        <Card className="hidden lg:block border-border shadow-sm rounded-sm">
          <CardHeader>
            <div className="flex items-start justify-between gap-4 mb-2">
              <div className="flex-1">
                ...
                <CardDescription>
                  Calculate Public Provident Fund maturity with EEE tax benefits
                </CardDescription>
              </div>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              />
              <p className="text-xs text-muted-foreground">
                Current PPF rate: 7.1% (updated quarterly by government)
              </p>
            </div>
            ...
            <div className="p-3 bg-primary/10 border border-primary/20 rounded-sm">
              ...
              <p className="text-xs text-primary">
                ✓ 80C deduction (up to ₹1.5L) • Interest & maturity completely
                tax-free
              </p>
            </div>
          </CardContent>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gradient-to-br from-emerald-50 to-emerald-50 dark:from-emerald-950/30 dark:to-emerald-950/30 rounded-sm p-5 border border-emerald-100 dark:border-emerald-900/50 relative overflow-hidden">
                ...
                <p className="text-lg font-medium text-emerald-900 dark:text-emerald-100 mb-3">
                  ...
                  is completely tax-free — EEE status (Exempt-Exempt-Exempt)!
                </p>
              ...
              <div className="p-5 bg-card rounded-sm border border-border shadow-sm mt-4">
                <div className="flex items-center justify-between mb-3">
                  <h3 className="font-bold text-foreground flex items-center gap-2">
                    ...
                    Get PPF vs ELSS Comparison Report (Free)
                  </h3>
                ...
                <p className="text-xs text-muted-foreground mb-4">
                  Get a detailed comparison of PPF vs ELSS with tax-adjusted
                  returns for your investment of{" "}
