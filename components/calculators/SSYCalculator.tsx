                        ...
                        <div className="space-y-2">
                            <div className="flex justify-between items-center">
                                ...
                                <div className="flex items-center gap-1.5 bg-slate-100 rounded-lg px-3 py-1.5">
                                    ...
                                    <span className="text-sm font-bold text-slate-900">{girlAge} Y</span>
                                </div>
                            </div>
                            <Slider
                                value={[girlAge]}
                    ...
                    <CardContent className="pt-4 sm:pt-6">
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 sm:gap-3 mb-4">
                            <div className="text-center p-6 md:p-8 sm:p-5 bg-white dark:bg-slate-800 rounded-xl sm:rounded-2xl shadow-sm border border-primary-100">
                                ...
                                <p className="text-base sm:text-lg font-extrabold text-slate-900 transform transition-all hover:scale-105">{formatCurrency(result.totalContributed)}</p>
                            </div>
                            <div className="text-center p-6 md:p-8 sm:p-5 bg-white dark:bg-slate-800 rounded-xl sm:rounded-2xl shadow-sm border border-primary-100">
