...
export function SSYCalculator() {
  ...
  const calculateSSY = () => {
    ...
    if (adjustForInflation) {
      realValue =
        maturityAmount / Math.pow(1 + inflationRate / 100, maturityDuration);
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3 mt-2">
        <div className="p-3 bg-primary/5 border border-primary/20 rounded-sm">
          <p className="text-[10px] font-bold text-primary-700 uppercase tracking-widest mb-1">
            Tax Benefits
          </p>
            ...
            <div className="flex justify-center gap-6 -mt-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-medium text-muted-foreground">
                  Invested: {formatCurrency(result.totalContributed)}
                </span>
              </div>
              <div className="flex items-center gap-2">
                <div
                ...
                />
                <span className="text-xs font-medium text-muted-foreground">
                  Interest: {formatCurrency(result.returns)}
                </span>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gradient-to-br from-emerald-50 to-emerald-50 dark:from-emerald-950/30 dark:to-emerald-950/30 rounded-sm p-5 border border-emerald-100 dark:border-emerald-900/50 relative overflow-hidden">
                ...
                <p className="text-lg font-medium text-emerald-900 dark:text-emerald-100 mb-3">
                  Starting SSY for your daughter at age {girlAge}: she receives{" "}
                  ...
                  at 21 — 80C tax benefit + tax-free maturity!
                </p>
              ...
              <div className="p-5 bg-card rounded-sm border border-border shadow-sm mt-4">
                ...
                <p className="text-xs text-muted-foreground mb-4">
                  Get a complete SSY guide, account opening steps, and
                  tax-saving tips to maximize your daughter's future fund of{" "}
                  {formatCurrency(result.maturityAmount)}.
                </p>
