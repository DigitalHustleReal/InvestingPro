...
export default function PointsWidget({ points = 0, level = 'Beginner' }: PointsWidgetProps) {
    ...
    return (
        <Card className="rounded-[2.5rem] border-0 shadow-2xl overflow-hidden bg-gray-900 text-white relative group">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-8">
                    <div className="flex items-center gap-6">
                        ...
                        <div>
                            ...
                            <h3 className="text-3xl font-bold tracking-tight">{points.toLocaleString()} <span className="text-gray-500 text-xl font-medium">Points</span></h3>
                        </div>
                    </div>
                    ...
                    <div className="flex-1 max-w-md">
                        <div className="flex justify-between items-end mb-3">
                            ...
                            <span className="text-xs font-bold text-gray-600">{pointsToNext} XP to Next Tier</span>
                        </div>
                    ...
                    <div className="hidden lg:flex flex-col items-end">
                        ...
                        <p className="text-[10px] text-gray-500 font-bold uppercase tracking-widest">Growth this week</p>
                    </div>
                </div>
            </CardContent>
        </Card>
