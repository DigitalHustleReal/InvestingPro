            ...
            <CardContent className="p-8 relative z-10">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-8">
                    <div className="flex items-center gap-6">
                        <div className="w-16 h-16 rounded-3xl bg-emerald-500 flex items-center justify-center shadow-xl shadow-emerald-500/20 group-hover:rotate-6 transition-transform">
                            <Trophy className="w-8 h-8 text-slate-900" />
                        </div>
                        <div>
                            <p className="text-[10px] font-black text-emerald-400 uppercase tracking-[0.2em] mb-1">XP Achievement System</p>
                            <h3 className="text-3xl font-black tracking-tight">{points.toLocaleString()} <span className="text-slate-500 text-xl font-medium">Points</span></h3>
                        </div>
                    </div>
                    ...
                    <div className="flex-1 max-w-md">
                        <div className="flex justify-between items-end mb-3">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-sm font-black uppercase tracking-widest">{level} Status</span>
                            </div>
