    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger asChild>
                <Button variant="ghost" size="sm" className="text-gray-500 text-xs flex items-center gap-1 hover:text-gray-900 dark:hover:text-gray-300">
            ...
            <DialogContent className="max-w-2xl bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-800">
                ...
                <div className="grid gap-6 py-6">
                    <div className="flex gap-4">
                        ...
                        <div>
                            <h3 className="font-bold text-gray-900 dark:text-white mb-1">1. Trust Score (40%)</h3>
                    ...
                    <div className="flex gap-4">
                        ...
                        <div>
                            <h3 className="font-bold text-gray-900 dark:text-white mb-1">2. Feature Coverage (30%)</h3>
                            <p className="text-sm text-gray-600 dark:text-gray-400">
                    ...
                    <div className="flex gap-4">
                        ...
                        <div>
                            <h3 className="font-bold text-gray-900 dark:text-white mb-1">3. Value Analysis (30%)</h3>
                            <p className="text-sm text-gray-600 dark:text-gray-400">
                ...
                <div className="bg-gray-50 dark:bg-gray-950 p-4 rounded-xl border border-gray-100 dark:border-gray-800 text-xs text-gray-500">
