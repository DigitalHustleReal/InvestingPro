...
// =============================================================================
// MAIN PROXY (Next.js 16 - replaces deprecated middleware)
// =============================================================================
...
export async function proxy(request: NextRequest) {
    try {
        ...
        // Cleanup request context (sync - no setTimeout in proxy)
        clearRequestContext();

        return response;
    } catch (error) {
        // Prevent MIDDLEWARE_INVOCATION_FAILED - ensure we always return a response
