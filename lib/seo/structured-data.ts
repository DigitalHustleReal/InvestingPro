...
export function generateOrganizationStructuredData(data?: {
    ...
    const structured: OrganizationStructuredData = {
        ...
        description: data?.description || 'Compare 5000+ mutual funds, stocks, credit cards & insurance in India. Free calculators, expert reviews & personalized recommendations.',
    };
 ...
 */
export function generateBreadcrumbStructuredData(items: Array<{ name: string; url: string }>): BreadcrumbStructuredData {
    return {
        '@context': 'https://schema.org',
        '@type': 'BreadcrumbList',
