 ...
 * 
 * Weekly job that scrapes and updates product data for Credit Cards and Mutual Funds
 * 
 * SCHEDULE: Weekly (every Wednesday at 3 AM)
 * FOCUS: Credit Cards + Mutual Funds only (primary monetization categories)
