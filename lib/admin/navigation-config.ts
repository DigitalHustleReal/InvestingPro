...
export const NAV_SECTIONS: Record<string, NavSection> = {
  ...
  CONTENT: {
    ...
    items: [
      ...
      { label: "Import Hub", href: "/admin/import", icon: Upload },
    ],
  },
  PLANNING: {
    title: "PLANNING",
  ...
  CREATOR: {
    ...
    items: [
      { label: "Creator Hub", href: "/admin/creator", icon: Video },
      {
...
export const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    sections: ["SYSTEM", "OPERATIONS", "PIPELINE", "CREATOR", "DEVELOPER"],
    paths: [
      "/admin/users",
      "/admin/autonomy",
  ...
  },
  {
    ...
    sections: ["SETTINGS"],
    paths: ["/admin/settings", "/admin/settings/vault", "/admin/guide"],
  },
];
...
export function validateNavigation(): {
  ...
  const unmappedRoutes = navRoutes.filter(
