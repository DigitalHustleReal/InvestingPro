...
export const NAVIGATION_CATEGORIES: Category[] = [
    {
        ...
        subcategories: [
            ...
            { name: 'Lounge Access Cards', slug: 'lounge-access', description: 'Free airport lounge access at 1,000+ lounges', keywords: ['lounge', 'airport lounge', 'priority pass', 'dreamfolks'] },
            { name: 'Lifetime Free Cards', slug: 'lifetime-free', description: 'Zero annual fee credit cards — no conditions', keywords: ['lifetime free', 'no annual fee', 'zero fee', 'free card'] },
            { name: 'RuPay UPI Cards', slug: 'upi-rupay', description: 'Credit cards linkable to PhonePe and Google Pay', keywords: ['rupay', 'upi', 'upi credit card'] },
            { name: 'Dining Cards', slug: 'dining', description: 'Maximum rewards on restaurants and food delivery', keywords: ['dining', 'restaurant', 'swiggy', 'zomato'] },
            { name: 'OTT Subscription Cards', slug: 'ott-subscriptions', description: 'Free Netflix, Prime & Hotstar with your card', keywords: ['ott', 'netflix', 'amazon prime', 'hotstar', 'streaming'] },
            { name: 'Rent Payment Cards', slug: 'rent-payment', description: 'Earn rewards on monthly rent payments', keywords: ['rent', 'rental', 'housing', 'nobroker'] },
            { name: 'Utility Bill Cards', slug: 'electricity-bill', description: 'Cashback on electricity and utility bills', keywords: ['electricity', 'utility', 'bill payment', 'utilities'] },
