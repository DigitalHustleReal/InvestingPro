                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                  ...
                  <div className="lg:col-span-3 space-y-2">
                    {[
                      ...
                      { id: 'applications', label: 'My Applications', icon: ArrowUpRight },
                      { id: 'recommendations', label: 'Personalized Picks', icon: TrendingUp },
                    ].map((tab) => (
                      <button
                        key={tab.id}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                          <Card className="border-none bg-gradient-to-br from-primary-700 to-primary-500 text-white shadow-xl shadow-primary-500/20">
                            <CardContent className="p-6">
                              <p className="text-xs font-bold uppercase opacity-80 mb-1">Credit Score</p>
                              <div className="flex items-end gap-2">
                                <h3 className="text-3xl font-black">{creditScore}</h3>
                                <span className="text-xs font-bold mb-1 opacity-90">Excellent</span>
                              </div>
                              <div className="mt-4 h-1.5 w-full bg-white/20 rounded-full overflow-hidden">
                                <div className="h-full bg-white rounded-full" style={{ width: `${(creditScore/900)*100}%` }} />
                              </div>
                            </CardContent>
                          </Card>
                    ...
                    trigger={
                      <button className="flex items-center gap-3 bg-success-600 hover:bg-success-700 text-white px-6 py-4 rounded-2xl shadow-2xl shadow-success-500/20 transition-all hover:-translate-y-1">
                        ...
                        <div className="text-left">
                          <p className="text-[10px] font-bold opacity-80 leading-none">WhatsApp Support</p>
