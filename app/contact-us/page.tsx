                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 max-w-6xl mx-auto">
                    ...
                    <div className="lg:col-span-1 space-y-8">
                        <div>
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <h4 className="font-semibold text-gray-900 dark:text-white">Quick Support</h4>
                        ...
                        <div className="p-6 bg-gray-100 dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700">
                            <h4 className="font-bold text-gray-900 dark:text-white mb-2">Not Financial Advice</h4>
