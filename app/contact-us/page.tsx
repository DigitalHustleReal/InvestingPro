...
export const metadata: Metadata = {
  title: "Contact Us",
  description:
    "Get in touch with the InvestingPro team for support, feedback, or business inquiries.",
};
...
export default function ContactPage() {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      ...
      <div className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 pt-24 pb-12">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">
            Get in Touch
          </h1>
          <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto text-lg">
            Have a question about a financial product? Found a bug? Or just want
          ...
          <div className="lg:col-span-1 space-y-8">
            ...
            <div className="p-6 bg-gray-100 dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700">
              ...
              <p className="text-xs text-gray-600 dark:text-gray-400 leading-relaxed">
                Please note that we cannot provide personalized investment
                advice or handle grievances related to specific bank accounts or
                products directly. Please contact the respective financial
                institution for account-specific issues.
              </p>
            </div>
          </div>
