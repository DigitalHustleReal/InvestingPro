...
const BusinessTool = ({ icon: Icon, title, desc, href }: { icon: any, title: string, desc: string, href: string }) => (
    <Link href={href} className="group p-6 rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 hover:border-primary-500/50 hover:shadow-xl transition-all duration-300">
        ...
        <p className="text-xs text-gray-500 dark:text-gray-600 leading-relaxed mb-4">{desc}</p>
        ...
        <div className="min-h-screen bg-gray-50 dark:bg-gray-950 font-sans selection:bg-primary-100 selection:text-primary-900">
            ...
            <section className="py-24 bg-white dark:bg-gray-950">
                <div className="container mx-auto px-4">
                    <div className="mb-16 text-center md:text-left">
                        <h2 className="text-4xl font-black text-gray-900 dark:text-white mb-4 tracking-tight">Tailored Capital Solutions</h2>
                        <p className="text-lg text-gray-500 dark:text-gray-600">One size doesn't fit all. Choose the funding that matches your machinery, inventory, or payroll needs.</p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {[
                            ...
                            <div key={idx} className="group bg-gray-50 dark:bg-gray-900 p-8 rounded-[32px] border border-gray-200 dark:border-gray-800 hover:shadow-2xl hover:shadow-primary-500/10 hover:border-primary-500/30 transition-all duration-500 relative overflow-hidden">
                                ...
                                <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-2 relative z-10">{loan.type}</h3>
                        ...
                        <div className="space-y-4">
                            {[
                                ...
                                <div key={i} className="p-6 rounded-3xl bg-white flex items-center justify-between group cursor-pointer hover:translate-x-2 transition-transform shadow-lg shadow-black/5">
                                    <div>
                                        <div className="font-bold text-gray-900 text-lg">{scheme.name}</div>
            ...
            <section className="py-24 bg-gray-50 dark:bg-gray-900/50">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-16 px-4">
                        <h2 className="text-4xl font-black text-gray-900 dark:text-white mb-4">MSME Digital Toolkit</h2>
                        <p className="text-lg text-gray-500 dark:text-gray-600">Essential software and services to automate your business operations.</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {[
                            ...
                            <div key={idx} className="p-8 rounded-3xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 text-center hover:border-primary-500 dark:hover:border-primary-500 hover:shadow-xl hover:shadow-primary-500/5 transition-all duration-300 group">
                                <div className="text-5xl mb-6 group-hover:scale-110 transition-transform duration-300 inline-block">{tool.logo}</div>
                                <h4 className="text-xl font-bold text-gray-900 dark:text-white mb-1">{tool.name}</h4>
                                <p className="text-sm text-gray-500 dark:text-gray-600 mb-6 font-medium">{tool.type}</p>
            ...
            <section className="py-24 border-t border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950">
                <div className="container mx-auto px-4 flex flex-col items-center text-center">
                    ...
                    <h2 className="text-3xl font-black text-gray-900 dark:text-white mb-6">Trusted by 10,000+ Indian Small Businesses</h2>
                    ...
                    <div className="flex flex-wrap justify-center gap-12 opacity-40 hover:opacity-100 transition-all duration-500 grayscale">
                        ...
                        <div className="font-bold text-3xl text-gray-600 dark:text-gray-400">SBI</div>
                        <div className="font-bold text-3xl text-gray-600 dark:text-gray-400">SIDBI</div>
                        <div className="font-bold text-3xl text-gray-600 dark:text-gray-400">NSIC</div>
                        <div className="font-bold text-3xl text-gray-600 dark:text-gray-400">NABARD</div>
                    </div>
                </div>
            </section>
        </div>
