        ...
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950 font-sans">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {[
                            ...
                            <div key={idx} className="group bg-white dark:bg-slate-900 p-8 rounded-[32px] border border-slate-200 dark:border-slate-800 hover:shadow-2xl transition-all duration-300">
                                ...
                                <Button className="w-full h-12 bg-slate-900 dark:bg-white text-white dark:text-slate-900 font-bold rounded-2xl">
                                    Check Eligibility
                                </Button>
                            </div>
                        ))}
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        ...
                        <div className="space-y-4">
                            {[
                                ...
                                <div key={i} className="p-6 rounded-3xl bg-white flex items-center justify-between group cursor-pointer hover:translate-x-2 transition-transform">
                                    <div>
            ...
            <section className="py-24 border-t border-slate-200 dark:border-slate-800">
                <div className="container mx-auto px-4 flex flex-col items-center text-center">
                    <Handshake className="w-16 h-16 text-slate-300 mb-8" />
                    ...
                    <div className="flex flex-wrap justify-center gap-12 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
                        ...
                        <div className="font-bold text-2xl text-slate-400">SBI</div>
                        <div className="font-bold text-2xl text-slate-400">SIDBI</div>
                        <div className="font-bold text-2xl text-slate-400">NSIC</div>
                        <div className="font-bold text-2xl text-slate-400">NABARD</div>
                    </div>
                </div>
            </section>
        </div>
