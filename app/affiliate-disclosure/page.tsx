...
export const metadata: Metadata = {
  ...
  description:
    "How InvestingPro earns commissions through affiliate partnerships and our commitment to editorial independence. Cuelinks + EarnKaro + direct issuer relationships disclosed.",
  alternates: { canonical: "https://investingpro.in/affiliate-disclosure" },
  robots: "index, follow",
};
...
export default function AffiliateDisclosurePage() {
  return (
    <PolicyPageShell
      ...
      lead="Transparency about how we earn revenue. We earn commissions when you apply through our links — but those commissions never move scores or rankings. Here's exactly how it works."
      lastUpdated="2026-04-26"
      breadcrumbLabel="Affiliate Disclosure"
    >
      <div className="space-y-8">
        {/* Summary */}
        <div className="border-l-2 border-indian-gold pl-5 my-6">
          <p className="font-mono text-[10px] uppercase tracking-wider text-indian-gold mb-2">
            Quick summary
          </p>
          <p className="text-sm text-blue-800 dark:text-blue-300">
            InvestingPro earns commissions when you apply for financial products
            through our affiliate links. This helps us keep the platform free.
            Our recommendations remain unbiased and based on thorough research.
          </p>
        </div>
        ...
        <section>
          ...
          <div className="space-y-3 text-gray-700 dark:text-gray-300">
            <p>
              Affiliate marketing is a performance-based marketing model where
              we earn a commission when you:
            </p>
            <ul className="list-disc pl-6 space-y-2">
              <li>Click on an "Apply Now" or affiliate link on our platform</li>
              <li>
                Complete an application for a financial product (credit card,
                loan, insurance, etc.)
              </li>
            ...
            <p>
              These commissions help us maintain and improve InvestingPro at no
              cost to you.
            </p>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="space-y-3 text-gray-700 dark:text-gray-300">
            ...
            <p>
              When you apply for a credit card through our affiliate links and
              get approved, we earn a commission from the card issuer.
            ...
            <p>
              We earn commissions when you apply for and are approved for loans
              through our partner banks and NBFCs. The commission is typically a
            ...
            <p>
              ...
              commission when you open an account or make investments through
              our referral links.
            </p>
            ...
            <p>
              Insurance companies pay us commissions when you purchase policies
              (life, health, motor, etc.) through our affiliate links.
            </p>
        ...
        <section>
          <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-6">
            ...
            <p className="text-green-800 dark:text-green-300">
              <strong>Important:</strong> Affiliate commissions do NOT increase
              the cost to you. You pay the same price, interest rate, or fees
              whether you use our affiliate link or go directly to the
              provider's website.
            </p>
        ...
        <section>
          ...
          <div className="space-y-3 text-gray-700 dark:text-gray-300">
            <p>
              <strong>We maintain strict editorial independence.</strong> Our
              affiliate relationships do NOT influence:
            </p>
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Product Rankings:</strong> Products are ranked based on
                objective criteria (features, fees, benefits)
              </li>
              <li>
                <strong>Recommendations:</strong> We recommend products based on
                merit, not commission rates
              </li>
              <li>
                <strong>Reviews:</strong> Our reviews are honest and unbiased
              </li>
              <li>
            ...
            <p className="mt-4">
              ...
              believe provide genuine value to our users. If a product doesn't
              meet our quality standards, we won't promote it, regardless of
              commission rates.
            </p>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="space-y-3 text-gray-700 dark:text-gray-300">
            <p>
              We partner with financial institutions and service providers based
              on:
            </p>
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Reputation:</strong> Established, trustworthy companies
                with good customer reviews
              </li>
              <li>
                <strong>Product Quality:</strong> Competitive features, fees,
                and benefits
              </li>
              <li>
                <strong>Customer Service:</strong> Responsive support and fair
                practices
              </li>
              <li>
              ...
              <li>
                <strong>User Experience:</strong> Easy application process and
                transparent terms
              </li>
            </ul>
            <p className="mt-4">
              We regularly review our affiliate partnerships and remove partners
        ...
        <section>
          ...
          <div className="space-y-3 text-gray-700 dark:text-gray-300">
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Affiliate Badges:</strong> "Affiliate Link" badges next
                to partner links
              </li>
              <li>
                <strong>Page Disclaimers:</strong> Disclosure notices on product
                comparison pages
              </li>
              <li>
              ...
              <li>
                <strong>Footer Links:</strong> Link to this disclosure in our
                website footer
              </li>
            </ul>
            <p className="mt-4">
        ...
        <section>
          ...
          <div className="space-y-3 text-gray-700 dark:text-gray-300">
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Educational Articles:</strong> Guides, tutorials, and
                financial literacy content
              </li>
              <li>
                <strong>Calculators:</strong> Free financial calculators (SIP,
                EMI, Tax, etc.)
              </li>
              <li>
                <strong>Research:</strong> Market analysis and financial news
              </li>
              <li>
            ...
            <p className="mt-4">
              This content is provided free of charge to help you make informed
              financial decisions.
            </p>
          </div>
        </section>
        ...
        <section className="bg-primary-50 dark:bg-primary-900/20 border border-primary-200 dark:border-primary-800 rounded-lg p-6">
          ...
          <p className="text-primary-800 dark:text-primary-300 mt-4">
            <strong>Our Mission:</strong> To help you make informed financial
            decisions, not to maximize commissions.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            we earn revenue, please contact us:
          </p>
