...
export default function DataTableDemo() {
  ...
  const columns: ColumnDef<SampleFund>[] = [
    ...
    },
    {
      ...
      accessor: (row) => (
        <span
          className={`font-semibold ${row.returns_1y > 15 ? "text-success-600" : "text-gray-700 dark:text-gray-300"}`}
        >
    ...
    },
    {
      ...
      accessor: (row) => (
        <span
          className={`font-semibold ${row.returns_3y > 18 ? "text-success-600" : "text-gray-700 dark:text-gray-300"}`}
        >
    ...
    },
    {
      ...
      accessor: (row) => (
        <span
          className={`font-semibold ${row.returns_5y > 17 ? "text-success-600" : "text-gray-700 dark:text-gray-300"}`}
        >
      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400">
            Universal table component with sorting, pagination, and mobile
            responsiveness
          </p>
        </div>
