        ...
        <div className="min-h-screen bg-white dark:bg-slate-950">
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
                ...
                <div className="text-center mb-16">
                    ...
                    <p className="text-xl text-stone-600 dark:text-slate-400 max-w-2xl mx-auto">
                ...
                <div className="prose prose-lg dark:prose-invert max-w-none">
                    ...
                    <ol className="space-y-4">
                        <li>
                            <strong>You click an "Apply Now" link</strong> on one of our product cards
                        </li>
                        <li>
                            <strong>You're redirected to the provider's website</strong> (bank, lender, etc.)
                        </li>
                        <li>
                            <strong>If you complete an application,</strong> the provider may pay us a commission
                        </li>
                        <li>
                            <strong>You pay nothing extra.</strong> The commission comes from the provider's marketing budget
                        </li>
                    </ol>
                    ...
                    <ul className="space-y-2">
                        <li>Offer our comparison tools <strong>completely free</strong> to consumers</li>
                        <li>Invest in thorough,<strong> independent research</strong> and analysis</li>
                        <li>Maintain a team of <strong>expert analysts</strong> and fact-checkers</li>
                        <li>Keep our platform updated with the <strong>latest product data</strong></li>
                    ...
                    <ul className="space-y-2">
                        <li><strong>Data Analysis:</strong> We collect and compare data from hundreds of sources</li>
                        <li><strong>Expert Review:</strong> Financial analysts with 5-10+ years experience evaluate each product</li>
                        <li><strong>Fact-Checking:</strong> Every claim is verified by a separate fact-checker</li>
                        <li><strong>Regular Updates:</strong> We review and update recommendations monthly</li>
