...
export const metadata: Metadata = {
  title: "Cookie Policy",
  description:
    "Learn about how InvestingPro uses cookies to improve your experience and protect your privacy.",
};
        ...
        <div className="bg-white dark:bg-gray-900 rounded-3xl shadow-xl p-8 md:p-12">
          ...
          <div className="prose dark:prose-invert max-w-none">
            ...
            <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 mb-6 space-y-2">
              ...
              <li>
                <strong>Axiom:</strong> Performance monitoring and error
                tracking
              </li>
              <li>
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-4">
              These cookies help us show you relevant content and track
              conversions:
            </p>
            <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 mb-6 space-y-2">
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-6">
              ...
              pages. We do not control these cookies. Please refer to the third
