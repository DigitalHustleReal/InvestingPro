...
import {
  MutualFundDecisionEngine,
  GoalInput,
  FundRecommendation,
} from "@/lib/decision-engines/mutual-fund-engine";
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-white/90 mb-6">
              Tell us your financial goal and we'll recommend the best mutual
              funds with exact SIP amounts to achieve it.
            </p>
            ...
            <div className="flex items-center gap-2 text-sm">
              ...
              <div
                className={cn(
                  "flex items-center gap-2 px-3 py-1.5 rounded-full",
                  step >= 3 ? "bg-white text-primary-600" : "bg-white/20",
                )}
              >
                <span
                  className={cn(
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex gap-2">
                    {[500000, 1000000, 2500000, 5000000, 10000000].map(
                      (amt) => (
                        <button
                          key={amt}
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-sm text-gray-500">
                    If left empty, we'll calculate the required monthly SIP for
                    your goal.
                  </p>
                </div>
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                  ...
                  <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 text-center">
                    ...
                    <p className="text-4xl font-black">
                      {formatCurrency(
                        recommendations[0]?.recommendedSIPAmount || 0,
                      )}
                    </p>
                  </div>
                </div>
                        ...
                        <div className="grid grid-cols-3 gap-4 mt-4 pt-4 border-t border-gray-100 dark:border-gray-800">
                          <div>
                            ...
                            <p className="text-lg font-bold text-green-600">
                              {rec.fund.returns_3y?.toFixed(1) || "N/A"}%
                            </p>
                          </div>
                          <div>
                          ...
                          <div>
                            ...
                            <p className="text-lg font-bold text-gray-700 dark:text-gray-300">
                              {rec.fund.expense_ratio?.toFixed(2) || "N/A"}%
                            </p>
                          </div>
                        </div>
