        ...
        <div className="min-h-screen bg-slate-50">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-16 relative z-20">
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                    {[
                        { label: "Bank Max Yield", value: "7.85%", sub: "For Senior Citizens", icon: Percent, color: "bg-blue-600" },
                        { label: "NBFC Max Yield", value: "8.65%", sub: "Aggressive Returns", icon: Zap, color: "bg-amber-600" },
                        { label: "Insured Amount", value: "₹5 Lakh", sub: "DICGC per Bank", icon: Shield, color: "bg-emerald-600" },
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
                ...
                <div className="bg-white rounded-[2.5rem] p-8 shadow-xl shadow-slate-200/50 mb-12 border border-slate-100 flex flex-col md:flex-row items-center justify-between gap-8">
                    ...
                    <div className="flex-1 flex flex-col items-center">
                        ...
                        <p className="text-slate-900 font-black text-xl">8.15% <span className="text-slate-400 text-sm font-bold">at Shriram Finance</span></p>
                    </div>
                                ...
                                <div className="grid lg:grid-cols-4 gap-12 items-center">
                                    ...
                                    <div className="lg:col-span-1 border-r border-slate-50 pr-8">
                                        <div className="flex items-center gap-5">
                                            <div className={`w-16 h-16 rounded-[2rem] bg-gradient-to-br ${fd.color} flex items-center justify-center text-white text-3xl font-black shadow-xl shrink-0`}>
                                                {fd.logo}
                                            </div>
                                            <div>
                                                <h3 className="text-2xl font-black text-slate-900 tracking-tight">{fd.bank}</h3>
                                                <div className="flex items-center gap-2 mt-1.5">
                                                    <Badge className="bg-slate-100 text-slate-500 border-0 text-[9px] font-bold uppercase tracking-widest px-2 py-1">
                                                        {fd.type}
                                                    </Badge>
                                                    {fd.featured && (
                                                        <Badge className="bg-emerald-500/10 text-emerald-600 border-0 text-[9px] font-bold uppercase tracking-widest px-2 py-1">
                                    ...
                                    <div className="lg:col-span-2">
                                        <div className="grid grid-cols-4 gap-6">
                                            {tenures.map(tenure => (
                                                ...
                                                >
                                                    <p className={`text-[9px] font-black uppercase tracking-tighter mb-1 ${tenure === selectedTenure ? 'text-white/70' : 'text-slate-400'}`}>{tenure}</p>
                                                    <p className="text-xl font-black tracking-tight">{fd.rates[tenure]}%</p>
                                                </div>
                                            ))}
                                        </div>
                                    </div>
                                    ...
                                    <div className="lg:col-span-1">
                                        <div className="flex flex-col gap-3">
                                            ...
                                            <Button className="w-full rounded-2xl bg-slate-900 hover:bg-amber-500 text-white font-black py-7 h-auto transition-all text-base shadow-xl active:scale-95 group/btn">
                                                Secure This Rate
                ...
                <div className="mt-24 grid md:grid-cols-2 gap-8">
                    <Card className="rounded-[3rem] border-0 shadow-2xl bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white p-12 relative overflow-hidden">
                        ...
                        <CardHeader className="p-0 mb-8">
                            ...
                            <CardTitle className="text-3xl font-black tracking-tight leading-tight">Mastering Fixed Income</CardTitle>
                        </CardHeader>
                        <CardContent className="p-0 space-y-8">
                            ...
                            <div className="pt-8 border-t border-white/5 grid grid-cols-2 gap-6">
                                <div>
                                    <p className="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] mb-2">DICGC Scheme</p>
                                ...
                                <div>
                                    <p className="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] mb-2">Section 80C</p>
                    ...
                    <Card className="rounded-[3rem] border-0 shadow-2xl bg-white p-12 overflow-hidden flex flex-col justify-between">
                        <div>
                            <CardHeader className="p-0 mb-10">
                                <div className="w-16 h-16 bg-blue-50 rounded-[2rem] flex items-center justify-center mb-6">
                                    <Calculator className="w-8 h-8 text-blue-600" />
                                </div>
                                <CardTitle className="text-3xl font-black text-slate-900 tracking-tight">Strategy: The FD Ladder</CardTitle>
                            </CardHeader>
                                ...
                                <div className="space-y-4 mb-8">
                                    {[
                                        ...
                                        <div key={i} className="flex gap-4 items-center">
                                            <span className="text-xl font-black text-slate-200">{s.step}</span>
