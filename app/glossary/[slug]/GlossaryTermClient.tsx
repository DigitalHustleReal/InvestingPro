...
export interface EnrichedGlossaryTerm {
    id: string;
    term: string;
    slug: string;
    category: string;
...
export default function GlossaryTermClient({ termData }: { termData: EnrichedGlossaryTerm }) {
    const [activeSection, setActiveSection] = useState<string>('');

    const tableOfContents: TableOfContentsItem[] = [
        { id: 'definition', title: `What Is ${termData.term}?` },
        { id: 'understanding', title: `Understanding ${termData.term}` },
