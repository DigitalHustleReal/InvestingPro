...
export const metadata: Metadata = {
  ...
  description:
    "Important disclaimers and risk disclosures for InvestingPro users. Not a SEBI-registered investment advisor — content is for information only.",
  alternates: { canonical: "https://investingpro.in/disclaimer" },
};
...
export default function DisclaimerPage() {
  return (
    <PolicyPageShell
      ...
      lead="InvestingPro is an information and comparison platform — not a SEBI-registered investment advisor. All financial decisions are made at your own risk. Read this in full before relying on anything you read here."
      lastUpdated="2026-04-02"
      breadcrumbLabel="Disclaimer"
    >
      <div>
        {/* Critical Notice */}
        <div className="border-l-2 border-warning-red bg-warning-red/5 p-5 my-6">
          <h2 className="font-display text-[20px] font-bold text-ink mb-3 flex items-center gap-2">
          ...
          <p className="text-danger-800">
            All financial decisions are made at YOUR OWN RISK. Please consult a
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 mb-4">
            ...
            policies. Interest rates, fees, and terms shown on InvestingPro are
            indicative and may vary based on:
          </p>
          <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
          ...
          <p className="text-gray-700 mb-4">
            ...
            Failure to repay may result in penalty charges, credit score damage,
            and legal action.
          </p>
          <p className="text-gray-700 mb-4">
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 mb-4">
            Insurance information is for comparison purposes only. Policy terms,
            coverage, exclusions, and premiums may vary by insurer.
          </p>
          <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
            ...
            <li>
              Premium rates depend on age, health status, and coverage selected
            </li>
          </ul>
          <p className="text-gray-700 mb-4">
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 mb-4">
            <strong>Editorial Independence:</strong> Affiliate relationships do
            NOT influence our ratings, rankings, or editorial content. Our
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 mb-4">
            When you click "Apply Now" or external links, you are redirected to
            third-party websites (banks, NBFCs, AMCs, insurance companies):
          </p>
          <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
            <li>We do not control third-party websites or their practices</li>
            <li>
              Your interactions are governed by THEIR terms and privacy policies
            </li>
            <li>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 mb-4">
            Tax calculators and information are for reference only. Tax laws in
            India are complex and subject to change:
          </p>
          <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
          ...
          <p className="text-gray-700 mb-4">
            <strong>
              Consult a certified tax professional or CA (Chartered Accountant)
            </strong>{" "}
