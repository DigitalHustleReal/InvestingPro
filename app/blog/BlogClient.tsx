    ...
    return (
        <PageErrorBoundary pageName="Blog Page">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 relative z-10">
                    <div className="max-w-3xl">
                        ...
                        <div className="relative group max-w-2xl">
                            <Search className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-600 group-focus-within:text-primary-400 transition-colors" strokeWidth={2} />
                            <Input
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                ...
                {featuredArticle && (
                    <div className="mb-16">
                        <h2 className="text-sm font-bold text-gray-600 uppercase tracking-[0.2em] mb-6">Latest Highlight</h2>
                                        ...
                                        <div className="pt-6 border-t border-gray-100 flex items-center justify-between">
                                            <div className="flex items-center gap-2">
                                                <div className="w-6 h-6 rounded-full bg-gray-100 flex items-center justify-center">
                                                    <User className="w-3 h-3 text-gray-600" aria-hidden="true" />
                                                </div>
