...
export default function BlogPage() {
  ...
  const featuredArticle =
    currentPage === 1 && !debouncedSearch ? articles[0] : null;
    ...
    <PageErrorBoundary pageName="Blog Page">
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="bg-gray-900 border-b border-gray-800 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 relative z-10">
            <div className="max-w-3xl">
              <Badge className="mb-4 bg-primary-500/10 text-primary-400 border-primary-500/20 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-widest">
                Knowledge Hub
              </Badge>
              <h1 className="text-4xl sm:text-5xl font-extrabold text-white mb-6 leading-tight">
                Unlock Your{" "}
                <span className="text-primary-400">Financial Potential</span>
              </h1>
              <p className="text-xl text-gray-600 mb-10 leading-relaxed font-medium">
                Deep dives, market analysis, and simplified financial guides to
                empower your investment journey.
              </p>
              <div className="relative group max-w-2xl">
                <Search
                  className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-600 group-focus-within:text-primary-400 transition-colors"
                  strokeWidth={2}
                />
                <Input
                  ...
                  className="pl-12 h-16 bg-white/5 border-gray-700 text-white placeholder:text-gray-500 rounded-2xl focus:bg-white/10 transition-all outline-none text-lg"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                ...
                <Card className="overflow-hidden hover:shadow-2xl hover:-translate-y-1 transition-all duration-500 border-gray-200 group">
                  <div className="grid md:grid-cols-2">
                    <div className="h-64 md:h-auto overflow-hidden relative">
                      ...
                      {featuredArticle.featured_image && (
                        <SmartImage
                          ...
                          alt={
                            featuredArticle.title || "Featured article image"
                          }
                    ...
                    <CardContent className="p-8 md:p-6 md:p-8 flex flex-col justify-center bg-white">
                      <Badge className="w-fit mb-4 bg-primary-100 text-primary-700 border-0 text-[10px] uppercase font-bold tracking-wider">
                        {featuredArticle.category?.replace(/-/g, " ")}
                      </Badge>
                      <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-4 group-hover:text-primary-600 transition-colors leading-tight">
                        {featuredArticle.title}
                      </h2>
                      <p className="text-gray-500 text-lg mb-8 line-clamp-2 leading-relaxed font-medium">
                        {featuredArticle.excerpt}
                      </p>
                      <div className="flex items-center gap-6 text-xs text-gray-600 font-bold uppercase tracking-tight mb-8">
                        <span className="flex items-center gap-2">
                          ...
                          />
                          {new Date(
                            featuredArticle.published_date || Date.now(),
                    ...
                    <Card className="h-full flex flex-col hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border-gray-200 group bg-white shadow-sm overflow-hidden">
                      <div className="h-56 relative overflow-hidden bg-gray-100">
                        ...
                        <div className="absolute top-4 left-4">
                          <Badge className="bg-white/90 backdrop-blur-sm text-gray-900 border-0 text-[10px] font-bold shadow-sm">
                      ...
                      <CardContent className="p-6 flex-1 flex flex-col">
                        ...
                        <div className="pt-6 border-t border-gray-100 flex items-center justify-between">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-xs font-bold text-gray-900 uppercase tracking-tighter">
                              {article.author_name}
                            </span>
                          </div>
          ...
          {/* Pagination */}
          {totalPages > 1 && (
            <div className="mt-16 bg-white p-2 rounded-2xl shadow-sm border border-gray-100">
              <Pagination
