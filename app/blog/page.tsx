...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Blog — InvestingPro",
    url: "https://investingpro.in/blog",
  },
};
      ...
      <section className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 lg:px-8 pt-6 pb-8">
          ...
          <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 mb-6">
            ...
            <Link
              href="/feed.xml"
              className="flex items-center gap-1.5 text-[12px] text-gray-500 hover:text-green-600 transition-colors flex-shrink-0"
            >
            ...
            {[
              ...
              <Link
                ...
                href={
                  i === 0
                    ? "/blog"
                    : `/blog?category=${p.toLowerCase().replace(" ", "-")}`
                }
