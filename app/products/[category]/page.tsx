...
> = {
  credit_card: {
    ...
    description:
      "Compare and find the best credit cards with rewards, cashback, and lounge access.",
    icon: "💳",
  },
  mutual_fund: {
    title: "Top Mutual Funds",
    description:
      "Discover high-performing mutual funds for your investment portfolio.",
    icon: "📈",
  },
  loan: {
    title: "Best Loan Offers",
    description:
      "Compare personal loans, home loans, and business loans with competitive rates.",
    icon: "💰",
  },
  insurance: {
    title: "Insurance Plans",
    description:
      "Find the right life, health, and term insurance for you and your family.",
    icon: "🛡️",
  },
  broker: {
