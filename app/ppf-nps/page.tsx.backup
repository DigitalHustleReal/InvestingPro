                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="max-w-3xl space-y-6">
                        <div className="inline-flex items-center gap-2 bg-purple-500/10 backdrop-blur-md rounded-full px-4 py-2 border border-purple-500/20">
                            ...
                            <span className="text-purple-400 font-black text-[10px] uppercase tracking-[0.2em]">Sovereign Guaranteed Assets</span>
                        </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-16 relative z-20">
                <Tabs defaultValue="ppf" className="space-y-12">
                    <TabsList className="bg-white p-2 rounded-[2rem] shadow-2xl border border-slate-100 flex h-auto max-w-fit mx-auto lg:mx-0">
                        <TabsTrigger value="ppf" className="rounded-3xl px-10 py-5 font-black uppercase tracking-widest text-[11px] data-[state=active]:bg-slate-900 data-[state=active]:text-white transition-all">
                            <PiggyBank className="w-4 h-4 mr-2" />
                            Public Provident Fund (PPF)
                        </TabsTrigger>
                        <TabsTrigger value="nps" className="rounded-3xl px-10 py-5 font-black uppercase tracking-widest text-[11px] data-[state=active]:bg-slate-900 data-[state=active]:text-white transition-all">
                    ...
                    <TabsContent value="ppf" className="animate-in fade-in slide-in-from-bottom-3 duration-500">
                        <div className="grid lg:grid-cols-3 gap-8">
                            <div className="lg:col-span-2 space-y-8">
                                <Card className="rounded-[3rem] border-0 shadow-2xl bg-white overflow-hidden p-10">
                                    <div className="flex items-center gap-4 mb-8">
                                        ...
                                        <div>
                                            <h2 className="text-3xl font-black text-slate-900 tracking-tight">The PPF Fortress</h2>
                                    ...
                                    <div className="grid md:grid-cols-3 gap-6 mb-10">
                                        {[
                                            ...
                                            { label: "Lock-in Period", value: "15 Yrs", sub: "Extendable by 5", icon: Clock, color: "text-blue-600", bg: "bg-blue-50" },
                                    ...
                                    <div className="space-y-6">
                                        <h3 className="text-xl font-black text-slate-900 tracking-tight">Strategic Advantages</h3>
                                        <div className="grid md:grid-cols-2 gap-4">
                                            {[
                                                ...
                                                <div key={index} className="flex items-start gap-3 p-4 bg-slate-50/50 rounded-2xl border border-slate-50">
                                                    <div className="w-6 h-6 rounded-full bg-emerald-500 text-white flex items-center justify-center shrink-0 text-[10px]"><Check className="w-3 h-3" /></div>
                                ...
                                <Card className="rounded-[3rem] border-0 shadow-2xl bg-white p-10">
                                    <h3 className="text-xl font-black text-slate-900 tracking-tight mb-8">Deployment Protocol</h3>
                                    <div className="space-y-4">
                                        {[
                                            ...
                                            <div key={index} className="flex gap-6 p-6 hover:bg-slate-50 rounded-3xl transition-colors border border-transparent hover:border-slate-100">
                                                <div className="text-4xl font-black text-slate-100 group-hover:text-purple-100 transition-colors uppercase tracking-widest">
                                                    {item.step}
                                                </div>
                                                <div>
                                                    <h4 className="font-black text-slate-900 tracking-tight mb-1">{item.title}</h4>
                            ...
                            <div className="space-y-8">
                                <Card className="rounded-[3rem] border-0 shadow-2xl bg-slate-900 text-white p-10 sticky top-28 overflow-hidden">
                                    ...
                                    <div className="relative z-10">
                                        <div className="flex items-center gap-3 mb-8">
                                            ...
                                            <h3 className="text-xl font-black tracking-tight">Compounding Logic</h3>
                                        </div>

                                        <div className="space-y-6">
                                            <div className="p-6 bg-white/5 border border-white/5 rounded-3xl">
                                                <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest mb-2">Maximized Allocation Projection</p>
                                                <p className="text-4xl font-black text-white tracking-tight mb-1">₹40.68 L</p>
                                                <p className="text-[11px] font-bold text-slate-500 italic">Investing ₹1.5L/yr for 15 years @ 7.1%</p>
                                            </div>

                                            <div className="grid grid-cols-2 gap-4">
                                                <div className="p-4 bg-white/5 rounded-2xl border border-white/5">
                                                    <p className="text-[9px] font-black text-slate-500 uppercase tracking-widest mb-1">Capital Invested</p>
                                                    <p className="text-lg font-black text-blue-400">₹22.5 L</p>
                                                </div>
                                                <div className="p-4 bg-white/5 rounded-2xl border border-white/5">
                                                    <p className="text-[9px] font-black text-slate-500 uppercase tracking-widest mb-1">Wealth Created</p>
                                                    <p className="text-lg font-black text-emerald-400">₹18.18 L</p>
                                                </div>
                                            </div>

                                            <Button className="w-full h-14 rounded-2xl bg-white text-slate-900 hover:bg-purple-500 hover:text-white font-black uppercase tracking-widest text-[11px] transition-all">
                                                Open PPF Terminal
                            ...
                            <div className="lg:col-span-2 space-y-8">
                                <Card className="rounded-[3rem] border-0 shadow-2xl bg-white overflow-hidden p-10">
                                    <div className="flex items-center gap-4 mb-8">
                                        ...
                                        <div>
                                            <h2 className="text-3xl font-black text-slate-900 tracking-tight">Modern Pension Utility</h2>
                                    ...
                                    <div className="grid md:grid-cols-3 gap-6 mb-10">
                                        {[
                                            ...
                                            { label: "Exit Maturity", value: "60 Yrs", sub: "Retirement Goal", icon: Target, color: "text-blue-600", bg: "bg-blue-50" },
                                    ...
                                    <div className="mb-10">
                                        <h3 className="text-xl font-black text-slate-900 tracking-tight mb-6">Tax Optimization Matrix</h3>
                                        <div className="grid md:grid-cols-2 gap-6">
                                            <div className="p-6 bg-slate-900 text-white rounded-[2.5rem] relative overflow-hidden group">
                                                ...
                                                <h4 className="text-[10px] font-black uppercase text-slate-500 tracking-widest mb-3">Core Deduction (80CCD)</h4>
                                                <p className="text-2xl font-black tracking-tight mb-2">₹1,50,000</p>
                                            ...
                                            <div className="p-6 bg-indigo-600 text-white rounded-[2.5rem] relative overflow-hidden group">
                                                ...
                                                <h4 className="text-[10px] font-black uppercase text-indigo-200 tracking-widest mb-3">Exclusive Add-on (80CCD-1B)</h4>
                                                <p className="text-2xl font-black tracking-tight mb-2">₹50,000</p>
                                    ...
                                    <h3 className="text-xl font-black text-slate-900 tracking-tight mb-6">Dynamic Asset Categories</h3>
                                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                        {[
                                            { name: "Equity (E)", desc: "Market Linked", color: "bg-rose-50 text-rose-600", border: 'border-rose-100' },
                                            { name: "Corp Bond (C)", desc: "Fixed Yield", color: "bg-blue-50 text-blue-600", border: 'border-blue-100' },
                                            ...
                                            <div key={index} className={`p-4 rounded-3xl ${asset.color} border ${asset.border} text-center`}>
                                                <p className="text-xs font-black uppercase tracking-widest mb-1">{asset.name}</p>
                                ...
                                <Card className="rounded-[3rem] border-0 shadow-2xl bg-white p-10">
                                    <h3 className="text-xl font-black text-slate-900 tracking-tight mb-8">Performance Leaderboard (Tier-I)</h3>
                                    <div className="grid md:grid-cols-2 gap-4">
                                        {[
                                            ...
                                            <div key={index} className="p-6 border border-slate-100 rounded-[2rem] hover:bg-slate-50 transition-colors group">
                                                <div className="flex justify-between items-start mb-4">
                                                    <h4 className="font-black text-slate-900 tracking-tight leading-tight max-w-[120px]">{fund.name}</h4>
                                                    <Badge className="bg-emerald-50 text-emerald-600 border-0 rounded-lg text-[9px] font-black uppercase">{fund.returns}</Badge>
                                                </div>
                                                <div className="flex justify-between items-center pt-4 border-t border-slate-100">
                                                    <span className="text-[10px] font-black text-slate-400 tracking-widest uppercase">Verified AUM</span>
                                                    <span className="text-xs font-black text-slate-900">{fund.aum}</span>
                                                </div>
                                            </div>
                                        ))}
                                    </div>
                                ...
                                <Card className="rounded-[3rem] border-0 shadow-2xl bg-slate-900 text-white p-10 sticky top-28 overflow-hidden">
                                    ...
                                    <div className="relative z-10">
                                        <div className="flex items-center gap-3 mb-8">
                                            ...
                                            <h3 className="text-xl font-black tracking-tight">Pension Estimator</h3>
                                        </div>

                                        <div className="space-y-6">
                                            <div className="p-6 bg-white/5 border border-white/5 rounded-3xl">
                                                <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest mb-2">Projected Maturity (Age 60)</p>
                                                <p className="text-4xl font-black text-white tracking-tight mb-1">₹1.76 Cr</p>
                                                <p className="text-[11px] font-bold text-slate-500 italic">₹10k/mo from age 30 @ 10% returns</p>
                                            </div>

                                            <div className="grid grid-cols-2 gap-4">
                                                <div className="p-4 bg-white/5 rounded-2xl border border-white/5">
                                                    <p className="text-[9px] font-black text-slate-500 uppercase tracking-widest mb-1">Monthly Pension</p>
                                                    <p className="text-lg font-black text-indigo-400">₹52.8k</p>
                                                </div>
                                                <div className="p-4 bg-white/5 rounded-2xl border border-white/5">
                                                    <p className="text-[9px] font-black text-slate-500 uppercase tracking-widest mb-1">Tax-Free Lump</p>
                                                    <p className="text-lg font-black text-emerald-400">₹70.4 L</p>
                                                </div>
                                            </div>

                                            <Button className="w-full h-14 rounded-2xl bg-white text-slate-900 hover:bg-indigo-500 hover:text-white font-black uppercase tracking-widest text-[11px] transition-all">
                ...
                <Card className="mt-20 rounded-[3rem] border-0 shadow-2xl bg-white overflow-hidden p-10">
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h3 className="text-2xl font-black text-slate-900 tracking-tight">Sovereign Benchmark Review</h3>
                        ...
                        <table className="w-full text-left">
                            <thead>
                                <tr className="border-b border-slate-100">
                                    <th className="pb-6 text-[11px] font-black text-slate-400 uppercase tracking-widest">Asset Parameters</th>
                                    <th className="pb-6 text-[11px] font-black text-purple-600 uppercase tracking-widest text-center">PPF Protocol</th>
                                    <th className="pb-6 text-[11px] font-black text-indigo-600 uppercase tracking-widest text-center">NPS Infrastructure</th>
                                </tr>
                            </thead>
                            <tbody className="divide-y divide-slate-50">
                                {[
                                    ...
                                    <tr key={index} className="group hover:bg-slate-50/50 transition-colors">
                                        <td className="py-6 text-sm font-black text-slate-900">{row.feature}</td>
