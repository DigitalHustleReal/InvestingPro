...
export const metadata: Metadata = {
  ...
  description:
    "Privacy policy for InvestingPro — how we collect, use, store, and protect your data. India PDPA / DPDP-aligned with full disclosure of cookies, third-party services, and your rights.",
  alternates: { canonical: "https://investingpro.in/privacy" },
};
...
export default function PrivacyPage() {
  return (
    <PolicyPageShell
      ...
      highlight="policy"
      lead="How we collect, use, store, and protect your data — written in plain English, India PDPA / DPDP-aligned, with full disclosure of every third-party service we use."
      ...
      <div>
        <section className="mb-8">
          ...
          <p className="text-gray-700 mb-4">
            Welcome to InvestingPro ("we," "our," or "us"). We are committed to
            protecting your personal information and your right to privacy. This
            Privacy Policy explains how we collect, use, disclose, and safeguard
            your information when you visit our website investingpro.in and use
            our services.
          </p>
          <p className="text-gray-700 mb-4">
            By using InvestingPro, you consent to the data practices described
            in this policy.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 mb-4">
            ...
            understand user behavior. You can control cookie preferences through
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
            <li>
              <strong>Provide Services:</strong> To deliver financial comparison
              tools, calculators, and product recommendations
            </li>
            <li>
            ...
            <li>
              <strong>Security:</strong> To protect against fraud, unauthorized
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 mb-4">
            ...
            business, or servicing you. These providers include:
          </p>
          <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
          ...
          <p className="text-gray-700 mb-4">
            When you click on "Apply Now" buttons or external links, we may
            share limited information with our financial product partners. We
            earn commission on successful referrals. For details, see our{" "}
            <a
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
            <li>
              <strong>Access:</strong> Request access to your personal data we
              hold
            </li>
            <li>
          ...
          <p className="text-gray-700 mb-4">
            ...
            <a
              href="mailto:privacy@investingpro.in"
              className="text-primary-600 hover:text-primary-700 underline"
            >
              privacy@investingpro.in
            </a>
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 mb-4">
            InvestingPro is not intended for users under the age of 18. We do
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
            ...
            <li>
              <strong>Analytics Cookies:</strong> To understand user behavior
              and improve our services
            </li>
            <li>
              <strong>Marketing Cookies:</strong> To deliver targeted
              advertising
            </li>
            <li>
          ...
          <p className="text-gray-700 mb-4">
            You can manage cookie preferences via our Cookie Consent banner or
            your browser settings.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 mb-4">
            ...
            longer retention period is required by law. After the retention
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 mb-4">
            ...
            India where our service providers are located (e.g., United States
            for cloud hosting). We ensure adequate safeguards are in place
            through:
          </p>
          <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 mb-4">
            Your continued use of InvestingPro after changes indicates
        ...
        <section className="mb-8">
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            ...
            <p className="text-gray-700 mb-2">
              Address: InvestingPro, Bangalore, Karnataka, India
            </p>
            <p className="text-gray-700 mb-2">
        ...
        <section className="mb-8 bg-accent-50 p-6 rounded-lg border border-accent-200">
          ...
          <p className="text-accent-800 mb-4">
            As per the Digital Personal Data Protection Act, 2023, you have the
            right to file a grievance regarding data privacy. Our Grievance
            Officer will respond to your complaint within the statutory timeline
            of 30 days.
          </p>
          <div className="bg-white rounded-lg p-4 border border-accent-200 space-y-1">
            <p className="text-accent-900 font-semibold">
              Grievance Officer: Shivam Patel
            </p>
            <p className="text-accent-800">
              <strong>Email:</strong>{" "}
              <a
                href="mailto:grievance@investingpro.in"
                className="text-primary-600 hover:text-primary-700 underline"
              >
            ...
            <p className="text-accent-800">
              <strong>Address:</strong> InvestingPro, Bangalore, Karnataka,
              India — 560001
            </p>
            <p className="text-accent-800">
