      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="prose prose-slate max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-2">We may collect the following personal information that you voluntarily provide to us:</p>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">6. Your Rights (Under Indian Law)</h2>
            <p className="text-gray-700 mb-4">
          ...
          <section className="mb-8 bg-amber-50 p-6 rounded-lg border border-amber-200">
            <h2 className="text-2xl font-bold text-amber-900 mb-4">13. Grievance Redressal</h2>
