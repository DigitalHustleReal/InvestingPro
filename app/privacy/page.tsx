...
export const metadata: Metadata = {
  ...
  description:
    "Privacy policy for InvestingPro - How we collect, use, and protect your data",
};
        ...
        <div className="prose prose-slate max-w-none">
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              Welcome to InvestingPro ("we," "our," or "us"). We are committed
              to protecting your personal information and your right to privacy.
              This Privacy Policy explains how we collect, use, disclose, and
              safeguard your information when you visit our website
              investingpro.in and use our services.
            </p>
            <p className="text-gray-700 mb-4">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
              <li>
                <strong>Provide Services:</strong> To deliver financial
                comparison tools, calculators, and product recommendations
              </li>
              <li>
              ...
              <li>
                <strong>Communication:</strong> To send newsletters, updates,
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              ...
              or government authority, or to protect our rights, property, or
              safety.
            </p>
          </section>
          ...
          <section className="mb-8 bg-accent-50 p-6 rounded-lg border border-accent-200">
            ...
            <p className="text-accent-800 mb-4">
              ...
              the right to file a grievance regarding data privacy. Our
              Grievance Officer will respond to your complaint within the
              statutory timeline of 30 days.
            </p>
