...
export default function FDCalculatorPage() {
    const structuredData = {
        ...
        "name": "FD Calculator",
        "description": "Free Fixed Deposit (FD) calculator to calculate FD maturity amount and interest earned. Compare quarterly, monthly, and annual compounding. Includes inflation-adjusted returns.",
        "provider": {
            "@type": "Organization",
            "name": "InvestingPro",
