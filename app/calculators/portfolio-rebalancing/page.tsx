...
export const metadata: Metadata = {
  title: "Portfolio Rebalancing Calculator - Asset Allocation Tool",
  description:
    "Optimize your investment portfolio with our free rebalancing calculator. Determine exactly how much Equity, Debt, or Gold to buy or sell to maintain your target asset allocation.",
  keywords:
    "portfolio rebalancing, asset allocation calculator, investment portfolio tool, equity debt split, rebalance portfolio india",
};
    ...
    <div className="bg-gray-50 dark:bg-gray-950 min-h-screen py-12">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 prose prose-slate dark:prose-invert max-w-4xl mx-auto">
          ...
          <p>
            Portfolio rebalancing is the process of realigning the weightings of
            a portfolio of assets. It involves periodically buying or selling
            assets in a portfolio to maintain an original or desired level of
            asset allocation or risk.
          </p>
          <h3>When should you rebalance?</h3>
          <ul>
            <li>
              <strong>Time-based:</strong> Every 6 months or 1 year.
            </li>
            <li>
              <strong>Threshold-based:</strong> When an asset class deviates by
