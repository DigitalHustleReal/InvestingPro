...
export const metadata: Metadata = {
  title: "Inflation Adjusted Returns Calculator India 2026 | Real Returns",
  description:
    "Calculate inflation-adjusted (real) returns on investments. Understand what your money is actually worth after inflation. Free calculator for Indian investors.",
  keywords:
    "inflation adjusted returns calculator, real returns calculator India, inflation calculator investment, real rate of return calculator",
  alternates: {
    canonical: "https://investingpro.in/calculators/inflation-adjusted-returns",
  },
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="mt-6 mb-10">
          ...
          <p className="text-lg text-ink-60 dark:text-ink-60 max-w-2xl leading-relaxed">
            ...
            This calculator shows you what your investments are{" "}
            <em>actually</em> worth in today's money.
          </p>
        </div>
          ...
          {[
            ...
            >
              <CardContent className="p-6">
                <h3 className="font-display font-bold text-ink dark:text-white mb-2 flex items-center gap-2">
