    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950 transition-colors duration-300">
            ...
            {/* Share & Disclaimer */}
                ...
                <SocialShareButtons
                    title="NPS Calculator India - National Pension System Returns | InvestingPro"
                    url="https://investingpro.in/calculators/nps"
                    description="Free nps calculator india - national pension system returns - use this free tool from InvestingPro"
                />
