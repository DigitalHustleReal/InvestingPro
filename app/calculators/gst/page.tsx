...
export default function GSTCalculatorPage() {
    ...
    const calculatorSchema: any = generateSchema({
        ...
        description: 'Free GST calculator to calculate GST for goods and services in India. Calculate CGST, SGST, IGST with GST exclusive and inclusive options.',
        url: '/calculators/gst',
        breadcrumbs,
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 space-y-8">
                ...
                <Card className="border-0 shadow-lg rounded-2xl">
                    ...
                    <CardContent>
                        <div className="grid md:grid-cols-2 gap-6">
                            {[
                                { rate: '0%', items: 'Essential items like food grains, fresh vegetables, milk, etc.' },
                                { rate: '5%', items: 'Essential goods like packaged food, medicines, transport services' },
                                { rate: '12%', items: 'Processed foods, computers, mobile phones, restaurant services' },
                                ...
                                <div key={idx} className="border border-gray-200 rounded-lg p-4">
                                    <div className="flex items-center gap-3 mb-2">
                                        ...
                                        <span className="text-sm font-display font-semibold text-ink">GST Rate</span>
                                    </div>
                        ...
                        <div className="space-y-8">
                            {[
                                ...
                                <div key={idx} className="border-b border-gray-200 pb-6 last:border-0">
                                    <h3 className="font-display font-bold text-ink mb-2 text-lg">{faq.q}</h3>
                ...
                <Card className="border-0 shadow-lg rounded-2xl bg-gradient-to-br from-primary-50 to-success-50">
                    <CardHeader>
                        <CardTitle className="text-2xl font-display font-bold text-ink">Related Business Calculators</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            {[
                                { name: "Tax Calculator", href: "/calculators/tax", desc: "Calculate income tax" },
                                { name: "EMI Calculator", href: "/calculators/emi", desc: "Calculate loan EMIs" },
                                { name: "Business Loans", href: "/loans?type=business", desc: "Compare business loans" }
                            ].map((item, idx) => (
                                <Link
                                    key={idx}
                                    href={item.href}
                                ...
                                >
                                    <div className="flex items-center gap-2 mb-2">
                                        ...
                                        <span className="font-display font-semibold text-ink group-hover:text-primary-600">{item.name}</span>
                                    </div>
