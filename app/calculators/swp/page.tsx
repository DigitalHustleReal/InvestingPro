...
export default function SWPCalculatorPage() {
  ...
  const calculatorSchema = generateSchema({
    ...
    description:
      "Free SWP (Systematic Withdrawal Plan) calculator to plan monthly withdrawals from your investment corpus.",
    url: "/calculators/swp",
    breadcrumbs,
    category: "investing",
  });
  ...
  const howToSchema = {
    ...
    description:
      "Step-by-step guide to calculate monthly withdrawals using our free SWP Calculator",
    step: [
      {
        "@type": "HowToStep",
  ...
  const financialServiceSchema = {
    ...
    name: "SWP Calculator",
    description:
      "Free SWP (Systematic Withdrawal Plan) calculator to plan monthly withdrawals from your investment corpus. Calculate how long your corpus will last and plan retirement income.",
    provider: {
      "@type": "Organization",
      name: "InvestingPro",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-8">
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-ink-60 max-w-3xl mx-auto leading-relaxed">
            Calculate monthly withdrawals from your investment corpus with our
            free SWP calculator. Plan retirement income, see corpus
            sustainability, and check how long your investments will last.
          </p>
        </div>
      </div>
        ...
        <div className="space-y-12">
          ...
          <Card className="border-0 shadow-lg rounded-2xl bg-white dark:bg-gray-900">
            ...
            <CardContent className="prose prose-slate dark:prose-invert max-w-none">
              ...
              <p className="text-lg leading-relaxed">
                ...
                <strong>steady monthly pension</strong> from their retirement
                corpus. It provides a regular income stream while the remaining
                money stays invested in the mutual fund scheme, continuing to
                earn returns. This dual benefit of regular income + potential
                capital appreciation makes SWP superior to traditional options
                like Fixed Deposits (FD) or Dividend plans.
              </p>
            </CardContent>
          </Card>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <Card className="border-0 shadow-md rounded-2xl bg-gradient-to-br from-primary-50 to-white dark:from-gray-800 dark:to-gray-900">
              ...
              <CardContent>
                <p className="text-ink-60 dark:text-gray-300">
                  Just as SIP helps in averaging purchase cost, SWP helps in
                  averaging withdrawal units. When markets are high, fewer units
                  are redeemed. When markets are low, more units are redeemed.
                </p>
              </CardContent>
            </Card>
            <Card className="border-0 shadow-md rounded-2xl bg-gradient-to-br from-primary-50 to-white dark:from-gray-800 dark:to-gray-900">
              ...
              <CardContent>
                <p className="text-ink-60 dark:text-gray-300">
                  SWP is more tax-efficient than FDs. In SWP, you only pay tax
                  on the capital gains portion of the withdrawal, not the entire
                  amount. Long-term capital gains up to ₹1.25 Lakh are tax-free.
                </p>
              </CardContent>
            </Card>
            <Card className="border-0 shadow-md rounded-2xl bg-gradient-to-br from-purple-50 to-white dark:from-gray-800 dark:to-gray-900">
              ...
              <CardContent>
                <p className="text-ink-60 dark:text-gray-300">
                  You have full control. You can choose the amount, date, and
                  frequency of withdrawals. You can also stop, pause, or
                  increase the SWP amount anytime without penalties.
                </p>
              </CardContent>
            </Card>
            <Card className="border-0 shadow-md rounded-2xl bg-gradient-to-br from-accent-50 to-white dark:from-gray-800 dark:to-gray-900">
              ...
              <CardContent>
                <p className="text-ink-60 dark:text-gray-300">
                  It guarantees a fixed cash flow to meet monthly expenses,
                  acting like a self-funded pension plan for retirees or anyone
          ...
          <Card className="border-0 shadow-lg rounded-2xl overflow-hidden">
            <div className="bg-gray-900 p-6 text-white">
              <h3 className="text-2xl font-bold mb-2">
                How SWP Works: A Practical Example
              </h3>
              <p className="text-gray-300">
                Let's say you have a corpus of ₹50 Lakhs earning 10% annual
                returns.
              </p>
            </div>
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-ink-60">
                      You invest ₹50 Lakhs in a Mutual Fund (e.g., Balanced
                      Advantage Fund).
                    </p>
                  </div>
                </div>
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-ink-60">
                      You instruct the fund house to withdraw{" "}
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-ink-60">
                      Every month, units worth ₹40,000 are sold and credited to
                      your bank account.
                    </p>
                  </div>
                </div>
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-ink-60">
                      Since your withdrawal (₹4.8L/year) is less than returns
                      (10% of 50L = ₹5L/year), your original corpus actually{" "}
                      <span className="font-bold text-emerald-600">GROWS</span>{" "}
                      over time despite withdrawals.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <Card className="border border-gray-200 shadow-sm rounded-2xl bg-white">
            ...
            <CardContent>
                ...
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="border-b border-gray-200">
                      <th className="p-4 font-display font-bold text-ink">
                        Fund Type
                      </th>
                      <th className="p-4 font-display font-bold text-ink">
                        Holding Period
              ...
              <p className="text-sm text-ink-60 mt-4 italic">
                *Note: Changes as per Budget 2024. Long Term Capital Gains
                (LTCG) on equity funds are tax-free up to ₹1.25 Lakhs per
                financial year. Withdrawals are taxed on a First-In-First-Out
                (FIFO) basis.
              </p>
            </CardContent>
          </Card>
        ...
        <Card className="border-0 shadow-lg rounded-2xl">
          <CardHeader>
            ...
            <p className="text-ink-60 mt-2">
              Find answers to the most common questions about SWP calculator and
            ...
            <div className="space-y-8">
              {[
                ...
                >
                  ...
                  <p className="text-gray-700 leading-relaxed text-lg ml-8">
                    {faq.a}
                  </p>
                </div>
              ))}
