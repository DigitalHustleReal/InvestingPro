...
export const metadata: Metadata = {
  title:
    "SIP Calculator India 2026 - Calculate SIP Returns with Inflation Adjustment | InvestingPro",
  description:
    "Free SIP calculator to calculate returns on Systematic Investment Plans (SIP). Calculate SIP maturity value, returns, and inflation-adjusted real returns. Plan your financial goals with accurate SIP projections. No registration required.",
  keywords:
    "SIP calculator, SIP calculator India, SIP returns calculator, systematic investment plan calculator, mutual fund sip calculator, inflation adjusted sip calculator",
  openGraph: {
    title:
      "SIP Calculator India 2026 - Calculate SIP Returns with Inflation Adjustment | InvestingPro",
    description:
      "Free SIP calculator to calculate returns on Systematic Investment Plans (SIP). Calculate SIP maturity value, returns, and inflation-adjusted real returns.",
  ...
  twitter: {
    ...
    title:
      "SIP Calculator India 2026 - Calculate SIP Returns with Inflation Adjustment",
    description:
      "Free SIP calculator to calculate returns on Systematic Investment Plans (SIP). Calculate SIP maturity value, returns, and inflation-adjusted real returns.",
...
export default function SIPCalculatorPage() {
  ...
  const calculatorSchema = generateSchema({
    ...
    description:
      "Free SIP calculator to calculate returns on Systematic Investment Plans (SIP) with inflation adjustment.",
    url: "/calculators/sip",
    breadcrumbs,
    category: "investing",
  });
  ...
  const structuredData = {
    ...
    name: "SIP Calculator",
    description:
      "Free SIP calculator to calculate returns on Systematic Investment Plans (SIP) with inflation adjustment. Calculate SIP maturity value, returns, and plan your financial goals.",
    provider: {
      "@type": "Organization",
      name: "InvestingPro",
  ...
  const howToSchema = {
    ...
    description:
      "Step-by-step guide to calculate SIP returns using our free SIP calculator",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-8">
        <div className="text-center mb-6">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 text-sm text-gray-500 mb-4">
            ...
            <span className="flex items-center gap-2">
              <span className="font-semibold text-primary-600">Free</span> — no
              signup required
            </span>
            <span className="hidden sm:inline">•</span>
            <span className="flex items-center gap-2">
