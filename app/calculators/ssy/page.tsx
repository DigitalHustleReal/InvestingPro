    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-gray-950 transition-colors duration-300">
                        ...
                        <div className="space-y-6">
                            {faqs.map((faq, idx) => (
                                <div key={idx} className="border-b border-gray-200 dark:border-gray-800 pb-6 last:border-0">
                                    ...
                                    <p className="text-gray-600 dark:text-gray-400 leading-relaxed ml-8 whitespace-pre-line">
                                        {faq.answer}
                                    </p>
                                </div>
                            ))}
            ...
            {/* Share & Disclaimer */}
                ...
                <SocialShareButtons
                    title="Sukanya Samriddhi Yojana Calculator | InvestingPro"
                    url="https://investingpro.in/calculators/ssy"
                    description="Free sukanya samriddhi yojana calculator - use this free tool from InvestingPro"
                />
