...
export async function generateMetadata({
  ...
  return {
    title: `${stock.name} (${stock.symbol}) Stock Analysis - Price, Target & Buy`,
...
export default async function StockDetailPage({
  ...
  const trendBg = stock.isPositive
                      ...
                      className={`px-3 py-1 rounded-full text-sm font-bold ${
                        stock.analystRating === "Buy"
                          ...
                          : stock.analystRating === "Hold"
                            ? "bg-accent-500 text-black dark:text-white"
                ...
                <CardContent className="p-4">
                  <div className="flex gap-3">
                    ...
                    <div className="text-xs text-amber-800 dark:text-amber-200">
                      ...
                      <p>
                        Stock investments are subject to market risks. Past
                        performance is not indicative of future results. Please
      ...
      <div className="bg-gray-900 text-white py-12">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-4">
            Invest in {stock.symbol} Today
          </h2>
          <p className="text-gray-300 mb-8">
            Open a demat account and build your long-term portfolio!
          </p>
