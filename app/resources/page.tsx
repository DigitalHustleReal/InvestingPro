            ...
            <div className="max-w-6xl mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {RESOURCES.filter(r => r.id !== 'expense-tracker').map(resource => (
                        <Card key={resource.id} className="group hover:shadow-xl transition-all duration-300 border-gray-200 overflow-hidden flex flex-col">
                            <div className="p-6">
                            ...
                            <div className="mt-auto p-6 bg-gray-50 border-t border-gray-100 flex items-center justify-between">
                ...
                {/* Trust Banner */}
                <div className="mt-20 flex flex-col md:flex-row items-center justify-center gap-12 py-10 border-y border-gray-200 opacity-60 grayscale">
