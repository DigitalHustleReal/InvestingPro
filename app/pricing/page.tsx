    ...
    <main className="min-h-screen bg-gray-50 dark:bg-gray-950">
      ...
      <section className="pt-20 pb-16 px-4 text-center">
        ...
        <p className="text-lg text-gray-600 dark:text-gray-400 max-w-xl mx-auto">
          Free forever for casual use. Upgrade to Pro for unlimited comparisons,
          portfolio tools, and an ad-free experience.
        </p>
      </section>
            ...
            <CardContent className="p-8 flex flex-col h-full">
              <div className="mb-8">
                ...
                <div className="flex items-end gap-2 mb-3">
                  ...
                  <span className="text-gray-500 dark:text-gray-400 mb-1.5">
                    /month
                  </span>
                </div>
              ...
              <Link href="/signup">
                <Button
                  variant="outline"
                  className="w-full h-12 font-semibold border-gray-300 dark:border-gray-700"
                >
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-gray-100 dark:bg-gray-800">
                ...
                <th className="text-center px-6 py-4 font-semibold text-gray-700 dark:text-gray-300">
                  Free
                </th>
                <th className="text-center px-6 py-4 font-semibold text-primary-600 dark:text-primary-400">
                  Pro
                </th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-100 dark:divide-gray-800 bg-white dark:bg-gray-900">
              {[
                ...
                >
                  ...
                  <td className="px-6 py-4 text-center text-gray-500 dark:text-gray-500">
                    {free}
                  </td>
