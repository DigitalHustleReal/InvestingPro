        ...
        return (
            <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex items-center justify-center">
                <div className="text-center max-w-md mx-auto px-4">
                    ...
                    <p className="text-slate-600 dark:text-slate-400 mb-6">{error || 'The product you are looking for does not exist.'}</p>
                    <Link href="/">
                        <DecisionCTA
                            text="Go to Homepage"
                            href="/"
        ...
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
            ...
            <div className="bg-slate-50 dark:bg-slate-950 pt-24 pb-12">
                <div className="container mx-auto px-4">
                    <Link href={`/${productType}s/${product.slug || productId}`} className="inline-flex items-center gap-2 text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white mb-6">
                    ...
                    <div className="max-w-3xl mx-auto">
                        <div className="bg-white dark:bg-slate-900 rounded-2xl border-2 border-slate-200 dark:border-slate-800 p-8 md:p-12 shadow-xl">
                            {/* Header */}
                            ...
                            <div className="text-center">
                                {affiliateLink ? (
                                    ...
                                    <p className="text-slate-500 dark:text-slate-400">Application link not available. Please contact support.</p>
                                )}
                            </div>
