    ...
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="bg-gray-50 rounded-2xl p-8 mb-12 border border-gray-200">
          ...
          <ul className="space-y-3">
            <li className="flex items-start gap-3">
              ...
              <div>
                <strong className="text-gray-900">Fee structures</strong>
                <span className="text-gray-600"> - Zero brokerage vs. percentage-based vs. flat fees</span>
              </div>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-primary-600 mt-0.5 flex-shrink-0" />
              <div>
                <strong className="text-gray-900">Platform reliability</strong>
                <span className="text-gray-600"> - Uptime, execution speed, customer support</span>
              </div>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-primary-600 mt-0.5 flex-shrink-0" />
              <div>
                <strong className="text-gray-900">Tool sophistication</strong>
                <span className="text-gray-600"> - Research tools, charting, portfolio analytics</span>
              </div>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-primary-600 mt-0.5 flex-shrink-0" />
              <div>
                <strong className="text-gray-900">Account types</strong>
                <span className="text-gray-600"> - Demat, trading, margin, commodity accounts</span>
              </div>
            </li>
          </ul>
        </div>
        ...
        <div className="mb-12">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-white rounded-xl p-6 border border-gray-200">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">Infrastructure Trust</h3>
        ...
        <div className="text-center bg-gray-50 rounded-2xl p-12 border border-gray-200">
          <h2 className="text-2xl font-semibold text-gray-900 mb-4">Next Step: Broker Selection</h2>
