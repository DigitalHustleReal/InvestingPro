...
export default function SignupPage() {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-950 dark:to-slate-900 flex items-center justify-center p-4">
        <div className="w-full max-w-md bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-8 text-center">
          ...
          <Link
            href="/login"
            className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-primary-500 to-teal-600 text-white font-semibold rounded-xl"
          >
            Go to Login
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-950 dark:to-slate-900 flex">
      {/* Left Side - Benefits */}
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary-600 to-teal-700 p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="space-y-6">
            <Benefit icon={<Gift className="w-5 h-5" />} text="100% Free to use" />
            <Benefit icon={<Star className="w-5 h-5" />} text="Access all calculators & tools" />
            <Benefit icon={<Shield className="w-5 h-5" />} text="Save comparisons & portfolios" />
            <Benefit icon={<Sparkles className="w-5 h-5" />} text="Get personalized insights" />
          </div>
        </div>

        <div className="relative z-10 text-white/60 text-sm">
          Join 50,000+ Indians making smarter money decisions
        </div>
      </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden text-center mb-8">
            <div className="inline-flex items-center gap-2">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-primary-500 to-teal-600 flex items-center justify-center">
