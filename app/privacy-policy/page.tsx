...
export const metadata: Metadata = {
  ...
  description:
    "How InvestingPro collects, uses, protects, and manages your personal information in compliance with Indian data protection laws and GDPR.",
  robots: "index, follow",
};
          ...
          <div className="prose dark:prose-invert max-w-none space-y-6">
            <section>
              <p className="text-gray-700 dark:text-gray-300">
                InvestingPro ("we", "us", or "our") is committed to protecting
                your privacy. This Privacy Policy explains how we collect, use,
                disclose, and safeguard your personal information when you use
                our platform and services.
              </p>
              <p className="text-gray-700 dark:text-gray-300">
                By using InvestingPro, you consent to the data practices
            ...
            <section>
              ...
              <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-2">
                ...
                <li>
                  <strong>Profile Information:</strong> Age, location, financial
                  goals (optional)
                </li>
                <li>
                ...
                <li>
                  <strong>Preferences:</strong> Saved products, comparisons,
                  watchlists
                </li>
              </ul>
              ...
              <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-2">
                ...
                <li>
                  <strong>Referral Information:</strong> Source that referred
                  you to our Platform
                </li>
              </ul>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-2">
                ...
                <li>
                  <strong>Personalization:</strong> To customize content and
                ...
                <li>
                  <strong>Research:</strong> To conduct research and development
            ...
            <section>
              ...
              <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-2">
                ...
                <li>
                  ...
                  for our legitimate business interests (analytics, security)
                </li>
                <li>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-2">
                ...
                <li>
                  <strong>Axiom:</strong> Application monitoring and error
                  tracking
                </li>
                <li>
              ...
              <p className="text-gray-700 dark:text-gray-300">
                When you click on affiliate links or apply for products, we may
                share limited information (click data, referral source) with our
                affiliate partners to track conversions and earn commissions.
              </p>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-2">
                <li>
                  ...
                  (HTTPS/TLS) and at rest (database encryption)
                </li>
                <li>
                ...
                <li>
                  <strong>Regular Audits:</strong> Periodic security audits and
                  penetration testing
                </li>
                <li>
            ...
            <section>
              ...
              <p className="text-gray-700 dark:text-gray-300 mt-4">
                ...
                privacy@investingpro.in. We will respond to your request within
                30 days.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-2">
                ...
                <li>
                  <strong>Usage Data:</strong> Retained for 24 months for
                  analytics purposes
                </li>
                <li>
                  <strong>Communication Data:</strong> Retained for 12 months
                </li>
                <li>
                  <strong>Legal Records:</strong> Retained as required by
                  applicable laws (typically 7 years)
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700 dark:text-gray-300">
                ...
                countries outside of India, including the United States and
                European Union. These countries may have different data
            ...
            <section>
              ...
              <div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-6 mt-4">
                <p className="text-gray-700 dark:text-gray-300">
                  ...
                  <br />
                  <strong>Data Protection Officer:</strong> dpo@investingpro.in
                  <br />
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-6 mt-8">
              <p className="text-sm text-blue-900 dark:text-blue-200">
                ...
                rights. If you have any questions or concerns, please don't
