...
export default function IPOPage() {
  ...
  const lastUpdated = apiResponse?.lastUpdated
    ? new Date(apiResponse.lastUpdated)
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      case "open":
        return "bg-primary-50 text-primary-600 dark:bg-primary-500/10 dark:text-primary-400 border-primary-100 dark:border-primary-500/20";
      case "upcoming":
        return "bg-primary-50 text-primary-600 dark:bg-primary-500/10 dark:text-primary-400 border-primary-100 dark:border-primary-500/20";
      case "closed":
        return "bg-gray-100 text-gray-600 dark:bg-gray-500/10 dark:text-gray-600 border-gray-200 dark:border-gray-500/20";
      default:
        return "bg-gray-100 text-gray-600 dark:bg-gray-500/10 dark:text-gray-600";
    }
  };
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400 mb-10 max-w-3xl mx-auto leading-relaxed">
              Track Grey Market Premium (GMP), subscription status, and get
              data-driven listing predictions for all upcoming and current IPOs
              in India.
            </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-3xl mx-auto">
              {[
                ...
                {
                  label: "Avg GMP",
                  value: `+₹${Math.round(ipos.reduce((acc, ipo) => acc + (ipo.gmp || 0), 0) / (ipos.length || 1))}`,
                  icon: TrendingUp,
                  color: "teal",
                },
                {
                  ...
                  value: ipos
                    .filter((ipo) => {
                      const listingDate = ipo.listingDate
                        ? new Date(ipo.listingDate)
                        : null;
                      return (
                        listingDate &&
                        listingDate.getMonth() === new Date().getMonth()
                      );
                    })
                    .length.toString(),
                  icon: Calendar,
        ...
        <div className="mb-8 flex justify-center">
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            <TabsList className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 p-1">
              <TabsTrigger
                value="all"
                className="data-[state=active]:bg-gray-900 dark:data-[state=active]:bg-white data-[state=active]:text-white dark:data-[state=active]:text-gray-900"
              >
                All IPOs
              </TabsTrigger>
              <TabsTrigger
          ...
          {filteredIPOs.length === 0 ? (
            <Card className="bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-800 rounded-3xl">
              <CardContent className="p-16 text-center">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  No {activeTab !== "all" ? activeTab : ""} IPOs available at
                  the moment.
                </p>
              </CardContent>
            </Card>
            ...
            filteredIPOs.map((ipo) => {
              ...
              return (
                <Card
                  key={ipo.id}
                  className="bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-800 hover:border-primary-500 dark:hover:border-primary-500 transition-all hover:shadow-xl rounded-3xl overflow-hidden group"
                >
                    ...
                    <div className="flex flex-col lg:flex-row">
                      ...
                      <div className="flex-1 p-8">
                        <div className="grid md:grid-cols-2 gap-8">
                          ...
                          <div>
                            ...
                            <div
                              className={`flex items-center gap-2 text-4xl font-bold mb-2 ${getGMPColor(ipo.gmp)}`}
                            >
                              {ipo.gmp && ipo.gmp > 0 ? (
                            ...
                            <div
                              className={`text-sm font-semibold ${getGMPColor(ipo.gmp)}`}
                            >
                              {gmpPercent > 0 ? "+" : ""}
                              {gmpPercent}% over issue price
                            </div>
                            <div className="mt-4 p-3 bg-gray-100 dark:bg-gray-800 rounded-xl">
                              ...
                              <div className="text-xl font-bold text-gray-900 dark:text-white">
                                {formatCurrency(ipo.estimatedListingPrice)}
                              </div>
                            </div>
                          </div>
                              ...
                              {[
                                {
                                  ...
                                  value: ipo.subscriptionQIB || 0,
                                },
                                {
                                  label: "NII (High Net Worth)",
                                  value: ipo.subscriptionNII || 0,
                                },
                                {
                                  label: "Retail (Individual)",
                                  value: ipo.subscriptionRetail || 0,
                                },
                              ].map((cat, idx) => (
                                <div key={idx}>
                                  ...
                                  <div className="w-full h-2 bg-gray-200 dark:bg-gray-800 rounded-full overflow-hidden">
                                    <div
                                      ...
                                      style={{
                                        width: `${Math.min((cat.value / 200) * 100, 100)}%`,
                                      }}
                                    ></div>
                                  </div>
                                </div>
                        ...
                        <div className="mt-8 pt-8 border-t border-gray-100 dark:border-gray-800">
                          <div className="flex items-center justify-between text-sm">
                            <div>
                              <div className="text-gray-500 dark:text-gray-600 mb-1">
                                Opens
                              </div>
                      ...
                      <div className="lg:w-48 p-8 border-t lg:border-t-0 lg:border-l border-gray-100 dark:border-gray-800 flex flex-col justify-center gap-3">
                        ...
                        <Link href="/go/groww" target="_blank">
                          <Button
                            variant="outline"
                            className="w-full border-primary-200 dark:border-primary-700 text-primary-600 dark:text-primary-400 hover:bg-primary-50 dark:hover:bg-primary-900/20 rounded-xl"
                          >
                            Apply via Groww
                          </Button>
                        </Link>
                        <Link
                          href="/demat-accounts"
                          className="text-xs text-center text-gray-500 hover:text-primary-600 mt-1"
                        >
                          More brokers â†’
                        </Link>
                      </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <Card className="bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-800 rounded-3xl">
            <CardContent className="p-8">
              ...
              <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">
                GMP is the price at which IPO shares trade in the unofficial
                "grey market" before listing. A positive GMP suggests strong
                demand, but it's not a guarantee of listing day gains.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-800 rounded-3xl">
            <CardContent className="p-8">
              ...
              <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">
                QIB (banks/funds), NII (wealthy investors), and Retail
                subscription numbers help gauge demand across investor segments.
                Higher subscription often indicates confidence.
              </p>
            </CardContent>
          </Card>
        </div>
