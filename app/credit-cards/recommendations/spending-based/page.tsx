...
import { ShoppingBag, Fuel, Plane, CreditCard as CardIcon, TrendingUp, CheckCircle2, ArrowRight } from 'lucide-react';
...
export default function SpendingBasedRecommendationsPage() {
    ...
    const recommendations: CardRecommendation[] = spendingInput.monthlySpending > 0 && engine
    ...
    const getTopSpendingCategory = () => {
        const categories = [
            ...
            { name: 'onlineShopping', amount: spendingInput.onlineShopping, icon: CardIcon }
        ];
                        ...
                        <Card className="h-fit">
                            ...
                            <CardContent className="space-y-6">
                                <div className="grid gap-4">
                                    <div>
                                        <Label htmlFor="groceries">Groceries & Supermarkets (₹/month)</Label>
                                        <Input
                                            id="groceries"
                                            type="number"
                                            placeholder="0"
                                    ...
                                    <div>
                                        <Label htmlFor="dining">Dining & Restaurants (₹/month)</Label>
                                        <Input
                                            id="dining"
                                            type="number"
                                            placeholder="0"
                                    ...
                                    <div>
                                        <Label htmlFor="utilities">Utilities & Bills (₹/month)</Label>
                                        <Input
                                            id="utilities"
                                            type="number"
                                            placeholder="0"
                        ...
                        <CardContent className="p-6">
                            ...
                            <div className="grid md:grid-cols-4 gap-4">
                                {[
                                    ...
                                    { label: "Best for Fuel", href: "/credit-cards/recommendations/fuel/8000", icon: Fuel },
                                    { label: "Best for Travel", href: "/credit-cards/recommendations/travel/25000", icon: Plane },
                                    { label: "Best for Online Shopping", href: "/credit-cards/recommendations/online-shopping/20000", icon: CardIcon }
                                ].map((link) => (
