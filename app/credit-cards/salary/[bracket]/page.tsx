...
const BRACKET_CONFIGS: Record<string, BracketConfig> = {
  "15000-25000": {
    ...
    faqs: [
      {
        question:
          "What is the best credit card for a salary of ₹15,000 per month?",
        answer:
          "For a ₹15,000 monthly salary, the best options are Lifetime Free (LTF) cards like Amazon Pay ICICI, IDFC First Millennia, or secured cards against Fixed Deposits. These have no annual fees and offer basic cashback benefits.",
      },
      {
        question: "Can I get a credit card with a ₹20,000 salary?",
        answer:
          "Yes, many banks approve credit cards for a ₹20,000 salary. HDFC MoneyBack+, Axis Neo, and SBI SimplyCLICK are popular choices. You may also consider secured credit cards for guaranteed approval.",
      },
      {
        question:
          "What is the minimum CIBIL score needed for entry-level credit cards?",
        answer:
          "Most entry-level cards require a CIBIL score of 700+. If you have no credit history, secured cards against FD don't require a CIBIL score. Some fintech cards also accept scores as low as 650.",
      },
      {
        question: "Should I pay the annual fee or get a Lifetime Free card?",
        answer:
          "At this salary range, always prefer Lifetime Free cards. Annual fees of even ₹500 can negate the small cashback earnings. Switch to premium cards only when your salary and spending increase.",
      },
      {
        question:
          "How can I increase my credit card limit on a ₹15,000-₹25,000 salary?",
        answer:
          "Use the card regularly (but stay under 30% utilization), pay full bills on time for 6 months, then request a limit increase. Many banks auto-increase limits after consistent usage. You can also add an FD as collateral for a higher limit.",
      },
    ],
    filterFn: (card: any) => {
  ...
  "25000-40000": {
    ...
    faqs: [
      {
        question:
          "What are the best credit cards for a ₹30,000 monthly salary?",
        answer:
          "Popular options include SBI SimplyCLICK (great for online shopping), HDFC MoneyBack+ (versatile rewards), Axis Ace (2% cashback on bill payments), and Amazon Pay ICICI (5% Amazon cashback). These offer the best value for this income range.",
      },
      {
        question: "Can I get a travel credit card with ₹35,000 salary?",
        answer:
          "Basic travel cards are available at this salary level, though premium travel cards usually require ₹50,000+. Consider cards like HDFC Regalia First or Axis Miles & More that offer introductory travel benefits at moderate fees.",
      },
      {
        question: "How much credit limit will I get on a ₹30,000 salary?",
        answer:
          "Banks typically offer 2-3x your monthly salary as credit limit. So with ₹30,000 salary, expect ₹60,000-₹90,000 initial limit. This can increase to ₹1.5-2 Lakhs with good usage history over 6-12 months.",
      },
      {
        question:
          "Is it better to have one card or multiple cards at this salary?",
        answer:
          "Start with one primary card and add a second complementary card after 6 months. For example, use SBI SimplyCLICK for online shopping and Axis Ace for utility bills. More than 2-3 cards at this salary level is unnecessary and hard to manage.",
      },
      {
        question: "What hidden charges should I watch out for?",
        answer:
          "Watch for late payment fees (₹500-₹1,000), over-limit charges (2.5% of excess), forex markup (3.5%), cash advance fees (2.5%), and GST on all charges (18%). Always pay the full bill by the due date to avoid the 36-42% annual interest rate on revolving credit.",
      },
    ],
    filterFn: (card: any) => {
      const fee = Number(card.annual_fee) || 0;
  ...
  "40000-60000": {
    ...
    faqs: [
      {
        question: "What credit cards can I get with a ₹50,000 salary?",
        answer:
          "With ₹50,000 salary, you can access mid-premium cards like HDFC Regalia, SBI Prime, Axis Privilege, and YES Preferred. These offer domestic lounge access, 2-4x reward points on preferred categories, and milestone benefits.",
      },
      {
        question: "Is HDFC Regalia worth it for a ₹50,000 salary?",
        answer:
          "Yes, HDFC Regalia is excellent at this salary level. It offers 4 reward points per ₹150 spent, 12 complimentary lounge visits/year, milestone benefits up to 25,000 bonus points, and ₹2,500 annual fee that is easily recouped through benefits.",
      },
      {
        question: "How many airport lounge visits do mid-premium cards offer?",
        answer:
          "Typically 4-12 domestic lounge visits per year. For example, HDFC Regalia offers 12 visits, SBI Prime offers 8, and Axis Privilege offers 8 visits. International lounge access usually starts with premium/super-premium cards at higher salary levels.",
      },
      {
        question:
          "Should I get a co-branded card or a bank card at this salary?",
        answer:
          "It depends on your spending pattern. If you spend heavily on one platform (Amazon, Flipkart, Swiggy), co-branded cards offer 3-5% cashback there. Bank cards like HDFC Regalia offer broader benefits across all categories. Ideally, have one of each.",
      },
      {
        question: "Can I get a forex-friendly card at this salary level?",
        answer:
          "Yes, cards like HDFC Regalia (2% forex markup), Axis Atlas (no forex markup on international spends), and SBI Elite (1.99% forex) are available. If you travel internationally or shop on foreign websites, low forex markup can save you thousands.",
      },
    ],
    filterFn: (card: any) => {
      const fee = Number(card.annual_fee) || 0;
  ...
  "60000-100000": {
    ...
    subheading:
      "Premium cards with international lounge access and elite rewards",
    icon: IndianRupee,
    ...
    faqs: [
      {
        question: "What are the best premium credit cards for ₹75,000 salary?",
        answer:
          "Top choices include HDFC Regalia Gold (excellent reward rate), Axis Magnus (best for travel), SBI Elite (great lounge program), and Amex Membership Rewards (superior international acceptance). These all offer premium benefits suited for this income level.",
      },
      {
        question: "Is the HDFC Infinia available at ₹80,000 salary?",
        answer:
          "HDFC Infinia typically requires ₹1.5L+ monthly income or an existing relationship with significant NRV. At ₹80,000 salary, HDFC Regalia Gold is the recommended alternative, which offers similar benefits at a lower threshold.",
      },
      {
        question: "How do I maximize Priority Pass lounge visits?",
        answer:
          "Premium cards typically offer 6-12 Priority Pass visits/year. Use them strategically on domestic flights (₹800-₹1,200 per visit saved) and international layovers. Some cards like Axis Magnus offer unlimited lounge visits with a minimum monthly spend.",
      },
      {
        question: "Are premium card annual fees worth paying?",
        answer:
          "Almost always yes at this income level. A ₹5,000 annual fee card that gives ₹20,000+ in lounge visits, milestone rewards, and cashback delivers 4x ROI. Calculate your expected benefits before applying, and choose cards with spend-based fee waivers for added security.",
      },
      {
        question: "Can I get a metal credit card at this salary?",
        answer:
          "Yes, several metal cards are available including Axis Magnus (metal), HDFC Regalia Gold, and OneCard (metal by default). Metal cards at this level usually charge ₹3,000-₹10,000 annual fee and offer premium aesthetics alongside strong reward programs.",
      },
    ],
    filterFn: (card: any) => {
      const fee = Number(card.annual_fee) || 0;
  ...
  "above-100000": {
    ...
    faqs: [
      {
        question:
          "What is the best credit card for salary above ₹1 Lakh in India?",
        answer:
          "The HDFC Infinia is widely considered the best overall, offering 3.3% reward rate, unlimited lounge access, and premium travel benefits. Axis Magnus is best for travel-focused users, while Amex Platinum offers the most luxurious lifestyle benefits.",
      },
      {
        question: "How do I get an invitation-only credit card?",
        answer:
          "Invitation-only cards like HDFC Diners Club Black require a relationship with the bank. Maintain a high NRV (₹10L+ in savings/FD), spend ₹3-5L+ annually on existing premium cards, and request an upgrade. Some banks also offer these based on salary credited to their account.",
      },
      {
        question: "Is it worth paying ₹10,000+ annual fee for a credit card?",
        answer:
          "At ₹1L+ monthly income with corresponding spending, absolutely. A card like HDFC Infinia with ₹10,000 fee easily delivers ₹50,000+ in annual value through 3.3% reward rate, unlimited lounges (₹800-₹1,200 per visit), milestone bonuses, and complimentary memberships.",
      },
      {
        question: "What credit limit can I expect at ₹1 Lakh+ salary?",
        answer:
          "Banks typically offer ₹3-10 Lakhs initial credit limit at this salary. With good usage and relationship building, limits can go up to ₹15-25 Lakhs. Some super-premium cards offer customized limits based on your overall banking relationship.",
      },
      {
        question:
          "Should I go for cashback or reward points at this income level?",
        answer:
          "Reward points are usually better at high spending levels because premium cards offer 2-5x multipliers on specific categories. With ₹5L+ annual spend, reward points on HDFC Infinia or Axis Magnus can yield ₹15,000-₹25,000 in value vs ₹5,000-₹8,000 from flat cashback cards.",
      },
    ],
    filterFn: (card: any) => {
      const type = (card.type || "").toLowerCase();
      return (
        type === "premium" || type === "super premium" || type === "luxury"
      );
    },
  },
  ...
  students: {
    ...
    faqs: [
      {
        question: "Can a student get a credit card in India without income?",
        answer:
          "Yes, students can get secured credit cards against a Fixed Deposit without showing any income proof. Options include IDFC First WOW, Kotak 811 secured card, and SBI Unnati. You just need a valid ID, address proof, and a small FD (₹5,000-₹15,000).",
      },
      {
        question: "What is the best credit card for college students?",
        answer:
          "The IDFC First WOW (secured) and SBI Unnati cards are the best for college students. Both have zero annual fees, require no income proof, and offer basic cashback. The IDFC First WOW card also offers attractive rewards on online spending.",
      },
      {
        question: "How much FD do I need for a secured credit card?",
        answer:
          "Most banks require a minimum FD of ₹5,000 to ₹25,000. Your credit limit will be 75-90% of the FD amount. For example, a ₹15,000 FD gets you approximately ₹12,000-₹13,500 credit limit.",
      },
      {
        question: "Will a student credit card help build my CIBIL score?",
        answer:
          "Absolutely! Using a credit card responsibly (paying full bills on time, keeping low utilization) is one of the fastest ways to build a CIBIL score. After 6-12 months of usage, you'll have a credit score of 700+, which helps when applying for loans or cards after graduation.",
      },
      {
        question: "Should I get an add-on card or my own student card?",
        answer:
          "Get your own card if possible. An add-on card on your parent's account doesn't independently build your credit history. Having your own card — even a small secured card — starts building your personal CIBIL score from day one.",
      },
    ],
    filterFn: (card: any) => {
      const fee = Number(card.annual_fee) || 0;
  ...
  "self-employed": {
    ...
    subheading:
      "Flexible income proof requirements for entrepreneurs and freelancers",
    icon: Briefcase,
    ...
    faqs: [
      {
        question: "Can self-employed people get credit cards in India?",
        answer:
          "Yes, most major banks offer credit cards to self-employed individuals. You need to provide ITR (last 2 years), bank statements (6-12 months), and business registration documents. Many banks also offer secured cards that don't require income proof.",
      },
      {
        question: "What documents do freelancers need for a credit card?",
        answer:
          "Freelancers typically need: PAN card, Aadhaar, last 2 years' ITR, 6 months' bank statements showing freelance income, and any business registration (GST, if applicable). Some banks also accept client contracts or invoice records as supplementary proof.",
      },
      {
        question: "What is the best business credit card for self-employed?",
        answer:
          "HDFC Business Regalia (great rewards + lounge access), Amex Business Gold (best international acceptance), and SBI Business Advantage (low fees + fuel benefits) are top choices. Choice depends on your spending pattern and whether you travel frequently.",
      },
      {
        question: "Is it harder to get a credit card if you are self-employed?",
        answer:
          "It can be slightly more complex documentation-wise, but approval rates are similar if you have good ITR and banking history. Key factors: declared income in ITR, CIBIL score (750+), regular bank account activity, and at least 2 years of business vintage.",
      },
      {
        question: "Can I get a premium credit card as a freelancer?",
        answer:
          "Yes, if your declared annual income (per ITR) is ₹6L+, you can qualify for mid-premium cards. At ₹12L+, premium cards like HDFC Regalia become accessible. The key is having proper documentation — banks don't discriminate by employment type, only by provable income.",
      },
    ],
  ...
  women: {
    ...
    subheading:
      "Cards with shopping rewards, lifestyle benefits, and exclusive perks",
    icon: Heart,
    salaryRange: "Women",
    introContent: `
    ...
    faqs: [
      {
        question: "What are the best credit cards for women in India?",
        answer:
          "Top options include HDFC Solitaire (designed for women with enhanced dining/shopping rewards), Axis My Zone (lifestyle benefits), SBI Her Card (women-specific perks), and Amazon Pay ICICI (great for online shopping). Choice depends on your spending pattern and income level.",
      },
      {
        question: "Do women get special rates or benefits on credit cards?",
        answer:
          "Yes, several banks offer women-specific benefits including lower annual fees, enhanced rewards on fashion/beauty/dining categories, complimentary spa/salon vouchers, and special EMI offers. Some banks also offer lower interest rates for women applicants with good credit scores.",
      },
      {
        question: "Can a homemaker apply for a credit card?",
        answer:
          "Yes, homemakers can apply for secured credit cards against Fixed Deposits without income proof. Some banks also consider household income or spouse's income for card eligibility. Add-on cards are another option, though they don't build independent credit history.",
      },
      {
        question: "What is the best Lifetime Free credit card for women?",
        answer:
          "Amazon Pay ICICI (5% Amazon cashback), IDFC First Classic (no annual fee + good rewards), and Flipkart Axis Bank (cashback on Flipkart) are excellent LTF options. These offer great value for online shopping without any annual fee burden.",
      },
      {
        question: "Is it important for women to have their own credit card?",
        answer:
          "Absolutely. Having your own credit card builds your independent CIBIL score, which is crucial for financial independence — whether for loans, renting property, or future credit applications. Start with a simple card and upgrade as your income grows.",
      },
    ],
    filterFn: (card: any) => {
      const type = (card.type || "").toLowerCase();
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 3,
        name: config.title,
        item: `https://investingpro.in/credit-cards/salary/${bracket}`,
      },
    ],
  };
