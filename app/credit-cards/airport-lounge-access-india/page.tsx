...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: `Compare 50+ credit cards with airport lounge access. Updated ${currentYear} rules, activation steps, limits, and the RuPay debit card changes explained.`,
  ...
  twitter: {
    ...
    description: `Complete guide: 50+ cards compared, activation steps, limits, guest charges. ${currentYear} RuPay changes explained.`,
  },
  alternates: {
    canonical:
      "https://investingpro.in/credit-cards/airport-lounge-access-india",
  },
};
...
async function getLoungeCards(): Promise<LoungeCard[]> {
  try {
    ...
    const { data, error } = await supabase
      .from("credit_cards")
      .select(
        "id, name, bank, annual_fee, image_url, apply_link, rating, type, pros, features, metadata",
      )
    ...
    if (error) {
      logger.error(
        "[LoungeGuidePage] Supabase error",
    ...
    logger.error(
      "[LoungeGuidePage] Failed to fetch lounge cards",
...
function buildStructuredData(cardCount: number) {
  ...
  const article = {
    ...
    description: `Complete guide to airport lounge access using credit cards in India. Compare cards, activation steps, limits, and ${currentYear} rule changes.`,
    url: pageUrl,
  ...
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      },
      {
        "@type": "ListItem",
        position: 3,
        name: "Airport Lounge Access India",
        item: pageUrl,
      },
    ],
  };
...
const FAQ_DATA = [
  {
    question:
      "Which credit card gives the most airport lounge access in India?",
    answer:
      "HDFC Infinia and HDFC Diners Club Black offer unlimited domestic and international lounge access via Priority Pass. American Express Platinum also provides unlimited Priority Pass visits. For mid-range options, HDFC Regalia offers 12 lounge visits per year (6 domestic + 6 international).",
  },
  {
    question: "How do I access an airport lounge with my credit card?",
    answer:
      "Walk to the lounge at the airport, present your credit card and boarding pass at the reception. For Priority Pass lounges, show your Priority Pass membership (digital or physical). For Dreamfolks lounges, the staff will swipe your credit card for verification. No advance booking is required at most lounges.",
  },
  {
    question: "Is airport lounge access free with credit cards?",
    answer:
      "Yes, most premium and super-premium credit cards include complimentary lounge access. However, the number of free visits varies by card — from 2 per quarter (entry-level) to unlimited (super-premium). Guest access typically costs Rs 2,000-2,500 per person beyond the complimentary limit.",
  },
  {
    question: "Can I bring a guest to the airport lounge with my credit card?",
    answer:
      "Most credit cards allow one complimentary guest per visit, but this uses one of your allocated lounge visits. Additional guests are charged Rs 2,000-2,500 per person. Super-premium cards like HDFC Infinia and Amex Platinum may include guest access at no extra charge.",
  },
  {
    question:
      "Do RuPay debit cards still get free airport lounge access in 2026?",
    answer:
      "No. As of April 2026, NPCI has discontinued complimentary airport lounge access for RuPay Platinum debit cards. RuPay Select and above debit cards may still have limited lounge access, but the benefit has been significantly reduced. Credit cards remain the most reliable way to access airport lounges.",
  },
  {
    question: "What is the difference between Priority Pass and Dreamfolks?",
    answer:
      "Priority Pass is a global network with 1,500+ lounges across 600+ cities worldwide, ideal for international travellers. Dreamfolks is India-focused with 60+ domestic lounges, used by most Indian bank credit cards for domestic lounge access. Premium cards often include both.",
  },
  {
    question: "Does airport lounge access work for domestic flights?",
    answer:
      "Yes. Both Dreamfolks and Priority Pass lounges are available at major domestic airports in India including Delhi, Mumbai, Bangalore, Hyderabad, Chennai, Kolkata, and Pune. You need a valid boarding pass for any same-day flight to access the lounge.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Delhi T3 (IGI Airport) has the most lounge options with 8+ lounges including Plaza Premium, ITC Green Lounge, and Encalm. Mumbai T2 has 6+ lounges. Bangalore Kempegowda T2 has modern lounges from Encalm and TFS. Hyderabad, Chennai, and Kolkata each have 3-5 lounges accepting credit cards.",
  },
  {
  ...
  {
    question:
      "Can I use my credit card lounge access on international flights departing from India?",
    answer:
      "Yes. If your credit card includes Priority Pass or Dreamfolks international access, you can use lounges at the international departure terminals in Indian airports. The same card can also be used at Priority Pass lounges abroad at your destination or transit airports.",
  },
  {
    question: "What should I carry to access an airport lounge?",
    answer:
      "You need: (1) Your physical credit card that has lounge access benefits, (2) A valid boarding pass for a same-day flight, (3) A government-issued photo ID. Some lounges also accept the Priority Pass or Dreamfolks digital membership via the app.",
  },
];
        ...
        <div className="bg-gradient-to-b from-green-50 via-gray-50 to-gray-50 dark:from-green-950/30 dark:via-gray-950 dark:to-gray-950 pt-24 pb-12">
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-4xl mx-auto text-center">
              <Badge
                variant="outline"
                className="mb-4 text-green-700 dark:text-green-400 border-green-300 dark:border-green-700"
              >
              ...
              <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto mb-6">
                Compare{" "}
                {loungeCards.length > 0 ? `${loungeCards.length}+` : "50+"}{" "}
                credit cards with lounge access. Learn activation steps, visit
                limits, guest charges, and the April 2026 RuPay debit card
                changes.
              </p>
              ...
              <div className="flex flex-wrap justify-center gap-3 mb-8">
                ...
                <div className="flex items-center gap-1.5 text-sm text-gray-600 dark:text-gray-400">
                  ...
                  {loungeCards.length > 0 ? loungeCards.length : "50+"} Cards
                  Compared
                </div>
              </div>
            </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-16">
            ...
            <CardContent>
              <nav>
                <ol className="space-y-2 text-sm">
                  {[
                    {
                      id: "what-is-lounge-access",
                      label: "What Is Airport Lounge Access?",
                    },
                    {
                      id: "credit-cards-with-lounge-access",
                      label:
                        "Credit Cards with Lounge Access (Comparison Table)",
                    },
                    {
                      id: "how-to-activate",
                      label: "How to Activate Lounge Access (Bank-wise Steps)",
                    },
                    {
                      id: "limits-and-charges",
                      label: "Lounge Access Limits, Guest Charges & Caveats",
                    },
                    {
                      id: "rupay-changes-2026",
                      label: "April 2026 RuPay Debit Card Lounge Changes",
                    },
          ...
          <section id="what-is-lounge-access" className="scroll-mt-24">
            ...
            <div className="prose prose-slate dark:prose-invert max-w-none mb-8">
              <p className="text-base text-gray-700 dark:text-gray-300 leading-relaxed">
                Airport lounge access is one of the most valued perks of premium
                credit cards in India. Instead of waiting at crowded boarding
                gates, lounge access gives you a quiet, comfortable space with
                complimentary food, beverages, Wi-Fi, charging stations, and
                sometimes shower facilities and spa treatments.
              </p>
              <p className="text-base text-gray-700 dark:text-gray-300 leading-relaxed mt-4">
                Credit card-based lounge access in India works through three
                main networks. The network your card uses determines which
                lounges you can access, where, and how many times.
              </p>
            </div>
            ...
            <div className="mt-8 text-base text-gray-700 dark:text-gray-300 leading-relaxed space-y-4">
              <p>
                ...
                is the gold standard for international travellers. With 1,500+
                lounges in 600+ cities, it is included with super-premium cards
                like HDFC Infinia, HDFC Diners Club Black, Axis Magnus, and
                American Express Platinum. The membership is provided by your
                bank at no extra cost when you hold an eligible card.
              </p>
              <p>
                <strong className="text-gray-900 dark:text-white">
                  Dreamfolks
                </strong>{" "}
                dominates the domestic lounge access space in India. Most
                mid-tier and premium cards from HDFC, SBI, Axis, ICICI, and
                other banks use Dreamfolks to facilitate complimentary domestic
                lounge visits. It works through a simple credit card swipe at
                the lounge counter — no separate membership card needed.
              </p>
              <p>
                <strong className="text-gray-900 dark:text-white">
                  Direct bank lounges
                </strong>{" "}
                are exclusive lounges operated by or partnered with specific
                banks at major Indian airports. These are less common but can
                offer a premium experience for loyal customers of that bank.
              </p>
            </div>
          </section>
          ...
          >
            ...
            <p className="text-base text-gray-600 dark:text-gray-400 mb-6">
              Below is a comprehensive comparison of credit cards that offer
              airport lounge access. Data is fetched live from our database and
              updated regularly.
            </p>
              ...
              <Card className="border-dashed border-2">
                <CardContent className="py-12 text-center">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4">
                    Our card database is being updated. Please check back
                    shortly.
                  </p>
                  <Link
                    href="/credit-cards"
            ...
            <p className="text-xs text-gray-500 mt-3">
              Lounge access is subject to change. Verify current benefits with
          ...
          <section id="how-to-activate" className="scroll-mt-24">
            ...
            <p className="text-base text-gray-600 dark:text-gray-400 mb-8">
              Lounge access activation varies by bank. Below are step-by-step
              instructions for the six major credit card issuers in India.
            </p>
          ...
          <section id="limits-and-charges" className="scroll-mt-24">
            ...
            <p className="text-base text-gray-600 dark:text-gray-400 mb-8">
              Understanding the fine print of lounge access can save you from
              unexpected charges. Here are the key things every cardholder
              should know.
            </p>
            ...
            <div className="space-y-8">
                    ...
                    <Table>
                      ...
                      <TableBody>
                        <TableRow>
                          ...
                          <TableCell>
                            No complimentary guest; Rs 2,000-2,500 per guest
                          </TableCell>
                        </TableRow>
                        <TableRow>
                          <TableCell className="font-medium">
                          ...
                          <TableCell>
                            1 guest uses 1 visit; additional guests Rs
                            2,000-2,500
                          </TableCell>
                        </TableRow>
                        <TableRow>
                          ...
                          <TableCell>
                            1-2 complimentary guests; additional guests charged
                          </TableCell>
                        </TableRow>
                      </TableBody>
                    </Table>
              ...
              <div className="text-base text-gray-700 dark:text-gray-300 leading-relaxed space-y-4">
                <p>
                  ...
                  are one of the most common surprises for lounge users. When
                  you bring a guest, most cards deduct one visit from your
                  complimentary quota. If you have exhausted your quota or your
                ...
                <p>
                  <strong className="text-gray-900 dark:text-white">
                    Spending-based eligibility
                  </strong>{" "}
                  is becoming more common. Banks like HDFC and Axis now require
                  a minimum quarterly spend (typically Rs 50,000 to Rs 1,00,000)
                  on certain mid-tier cards to unlock lounge access for that
                  quarter. Check your card&apos;s terms to confirm if this
                  applies to you.
                </p>
                <p>
                  <strong className="text-gray-900 dark:text-white">
                    International vs domestic limits
                  </strong>{" "}
                  are tracked separately on most cards. A card offering &ldquo;8
                  lounge visits per year&rdquo; might mean 4 domestic + 4
                  international, not 8 total that you can split any way you
                  like. Always confirm the split with your bank.
                </p>
              </div>
            </div>
          </section>
          ...
          <section id="rupay-changes-2026" className="scroll-mt-24">
            ...
            <Card className="border-red-200 dark:border-red-800 bg-red-50/30 dark:bg-red-950/10 mb-8">
              <CardHeader className="pb-3">
                <CardTitle className="text-lg font-semibold text-red-800 dark:text-red-300 flex items-center gap-2">
                  ...
                  Breaking Change: NPCI Discontinues RuPay Platinum Debit Card
                  Lounge Access
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
                  In April 2026, the National Payments Corporation of India
                  (NPCI) officially removed complimentary airport lounge access
                  for RuPay Platinum debit card holders. This was one of the
                  most popular free lounge access options in India, used by
                  millions of bank customers who held RuPay Platinum debit
                  cards.
                </p>
              </CardContent>
            </Card>
            ...
            <div className="text-base text-gray-700 dark:text-gray-300 leading-relaxed space-y-4">
              ...
              <p>
                This impacts millions of Indians who relied on their Jan Dhan,
                savings, or salary account RuPay Platinum debit cards for free
                lounge access. Particularly affected are customers of SBI, Bank
                of Baroda, PNB, and other PSU banks that issue RuPay Platinum
                debit cards by default on salary and savings accounts.
              </p>
              ...
              <div className="grid gap-4 sm:grid-cols-2 mt-4">
                <Card>
                  <CardContent className="pt-6 space-y-3">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                      Credit cards remain the most reliable way to access
                      airport lounges. Even entry-level cards like HDFC
                      Millennia and SBI SimplyCLICK offer 2-4 domestic lounge
                      visits per quarter. Premium cards like HDFC Regalia
                      provide 6+ visits per quarter.
                    </p>
                    <Link
                      href="/credit-cards"
                ...
                <Card>
                  <CardContent className="pt-6 space-y-3">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                      If you prefer debit cards, ask your bank to upgrade to a
                      RuPay Select or RuPay Platinum+ debit card. These higher
                      tiers may still retain some lounge access benefits, though
                      with reduced visit counts. Not all banks offer these
              ...
              <div className="mt-6 p-4 bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-800 rounded-lg">
                <p className="text-sm text-green-800 dark:text-green-300">
                  <strong>InvestingPro Recommendation:</strong> If you travel
                  more than 2-3 times a year and valued the free RuPay lounge
                  access, a mid-tier credit card with no joining fee (like HDFC
                  Millennia or Axis Ace) is the most cost-effective replacement.
                  These cards also offer cashback and rewards that offset the
                  annual fee.
                </p>
              </div>
            </div>
          ...
          <section id="faqs" className="scroll-mt-24">
            ...
            <p className="text-base text-gray-600 dark:text-gray-400 mb-8">
              Answers to the most common questions about airport lounge access
              via credit cards in India.
            </p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="space-y-2 text-xs text-gray-600 dark:text-gray-400">
                  <p>
                    ...
                    Lounge access benefits, visit limits, and charges mentioned
                    in this guide are subject to change at any time without
                    prior notice. Always verify current lounge access terms
                    directly with your bank or card issuer before travelling.
                  </p>
                  <p>
                    <strong className="text-gray-800 dark:text-gray-300">
                      Affiliate Disclosure:
                    </strong>{" "}
                    We may earn a commission when you apply for a credit card
                    through our links. This does not affect our editorial
                    independence or the information presented in this guide.
                  </p>
                  <p>
                    ...
                    . Data accuracy is maintained through regular reviews, but
                    real-time changes by banks and lounge networks may not be
          ...
          <div className="flex items-center gap-4 p-4 bg-gray-50 dark:bg-gray-900/50 rounded-xl border border-gray-200 dark:border-gray-800">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400">
                Our team researches and compares financial products across
                India. This guide is reviewed by personal finance experts and
                updated regularly to reflect the latest bank policies and lounge
                access rules.
              </p>
            </div>
          </div>
