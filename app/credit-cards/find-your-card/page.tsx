...
import { CreditCard as CardIcon, TrendingUp, Shield, Sparkles, ArrowRight, CheckCircle2 } from 'lucide-react';
import Link from 'next/link';
import AffiliateLink from '@/components/common/AffiliateLink';

export default function FindYourCardPage() {
    const [activeTab, setActiveTab] = useState<'spending' | 'lifestyle' | 'eligibility'>('spending');
    ...
    if (engine) {
        if (activeTab === 'spending' && spendingInput.monthlySpending > 0) {
            spendingRecommendations = engine.getSpendingBasedRecommendations(spendingInput, 3);
        }
        if (activeTab === 'lifestyle') {
            lifestyleRecommendations = engine.getLifestyleBasedRecommendations(lifestyleInput, 3);
        }
    ...
    const updateSpendingTotal = () => {
        const total = spendingInput.groceries + spendingInput.fuel + spendingInput.travel + 
                     spendingInput.onlineShopping + spendingInput.dining + spendingInput.utilities + spendingInput.other;
                ...
                <div className="container mx-auto px-6">
                    <div className="max-w-3xl mx-auto text-center">
                        ...
                        <p className="text-xl text-primary-100 mb-8">
                            Get personalized recommendations based on your spending, lifestyle, and eligibility
                        </p>
                    </div>
                </div>
            </div>
                ...
                <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as any)} className="max-w-6xl mx-auto">
                    ...
                    <TabsContent value="spending" className="space-y-6">
                            ...
                            <CardContent className="space-y-4">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <Input
                                            ...
                                            onChange={(e) => {
                                                setSpendingInput(prev => ({ ...prev, groceries: parseFloat(e.target.value) || 0 }));
                                    ...
                                    <div>
                                        ...
                                        <Input
                                            ...
                                            onChange={(e) => {
                                                setSpendingInput(prev => ({ ...prev, fuel: parseFloat(e.target.value) || 0 }));
                                                setTimeout(updateSpendingTotal, 0);
                                            }}
                                            placeholder="3000"
                                        />
                                    ...
                                    <div>
                                        ...
                                        <Input
                                            ...
                                            onChange={(e) => {
                                                setSpendingInput(prev => ({ ...prev, travel: parseFloat(e.target.value) || 0 }));
                                                setTimeout(updateSpendingTotal, 0);
                                            }}
                                            placeholder="10000"
                                        />
                                    ...
                                    <div>
                                        <Label htmlFor="onlineShopping">Online Shopping (₹/month)</Label>
                                        <Input
                                            id="onlineShopping"
                                            type="number"
                                            value={spendingInput.onlineShopping || ''}
                                            onChange={(e) => {
                                                setSpendingInput(prev => ({ ...prev, onlineShopping: parseFloat(e.target.value) || 0 }));
                                                setTimeout(updateSpendingTotal, 0);
                                            }}
                                            placeholder="8000"
                                        />
                                    ...
                                    <div>
                                        ...
                                        <Input
                                            ...
                                            onChange={(e) => {
                                                setSpendingInput(prev => ({ ...prev, dining: parseFloat(e.target.value) || 0 }));
                                                setTimeout(updateSpendingTotal, 0);
                                            }}
                                            placeholder="5000"
                                        />
                                    ...
                                    <div>
                                        ...
                                        <Input
                                            ...
                                            onChange={(e) => {
                                                setSpendingInput(prev => ({ ...prev, utilities: parseFloat(e.target.value) || 0 }));
                                                setTimeout(updateSpendingTotal, 0);
                                            }}
                                            placeholder="3000"
                                        />
                                    ...
                                    <div>
                                        ...
                                        <Input
                                            ...
                                            onChange={(e) => {
                                                setSpendingInput(prev => ({ ...prev, other: parseFloat(e.target.value) || 0 }));
                                                setTimeout(updateSpendingTotal, 0);
                                            }}
                                            placeholder="2000"
                                        />
                                ...
                                <div className="pt-4 border-t">
                                    <div className="flex items-center justify-between">
                                        <span className="text-lg font-semibold">Total Monthly Spending:</span>
                        ...
                        {spendingRecommendations.length > 0 && (
                            <div className="space-y-4">
                                <h2 className="text-2xl font-bold">Recommended Cards for Your Spending</h2>
                                {spendingRecommendations.map((rec, idx) => (
                                    <Card key={rec.card.id} className="border-2 border-primary-200">
                    ...
                    <TabsContent value="lifestyle" className="space-y-6">
                            ...
                            <CardContent className="space-y-4">
                                <div>
                                    ...
                                    <select
                                        ...
                                        onChange={(e) => setLifestyleInput(prev => ({ ...prev, lifestyle: e.target.value as any }))}
                                ...
                                <div>
                                    ...
                                    <select
                                        ...
                                        onChange={(e) => setLifestyleInput(prev => ({ ...prev, frequency: e.target.value as any }))}
                                        className="w-full px-4 py-2 border rounded-lg mt-2"
                                    >
                        ...
                        {lifestyleRecommendations.length > 0 && (
                            <div className="space-y-4">
                                <h2 className="text-2xl font-bold">Recommended Cards for Your Lifestyle</h2>
                            ...
                            <CardContent className="space-y-4">
                                <div>
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) => setEligibilityInput(prev => ({ ...prev, monthlyIncome: parseFloat(e.target.value) || 0 }))}
                                        placeholder="50000"
                                    />
                                </div>
                                <div>
                                    ...
                                    <select
                                        ...
                                        onChange={(e) => setEligibilityInput(prev => ({ ...prev, employmentStatus: e.target.value as any }))}
                                        className="w-full px-4 py-2 border rounded-lg mt-2"
                                    >
                                ...
                                <div>
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) => setEligibilityInput(prev => ({ ...prev, creditScore: parseFloat(e.target.value) || undefined }))}
                                        placeholder="750"
                                        min="300"
                                        max="900"
                                    />
                                ...
                                <div>
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) => setEligibilityInput(prev => ({ ...prev, existingCards: parseFloat(e.target.value) || 0 }))}
                                        placeholder="0"
                                    />
                                </div>
                            </CardContent>
                                                    ...
                                                    <div className="flex items-center gap-4">
                                                        <div className="text-right">
                                                            <div className={`text-lg font-bold ${
                                                                ...
                                                                result.probability >= 50 ? 'text-yellow-600' : 'text-red-600'
                                                            }`}>
                                                                {result.probability}%
                                                            </div>
