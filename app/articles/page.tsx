...
export default function ArticlesPage() {
    ...
    const categories = Array.from(new Set((Array.isArray(articles) ? articles : []).map(a => a.category).filter(Boolean)));
    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            {/* Header */}
            <div className="bg-gradient-to-br from-primary-50 to-blue-50 border-b border-slate-200">
