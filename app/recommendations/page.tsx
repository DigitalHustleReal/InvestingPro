                           ...
                           {[
                               ...
                               >
                                   <CardContent className="p-8 flex flex-col items-center text-center">
                                       <item.icon className={`w-12 h-12 mb-4 ${prefs.productType === item.id ? 'text-primary-600' : 'text-gray-600'}`} />
            ...
            <div className="container mx-auto px-4 sm:px-6 -mt-20 relative z-20">
                ...
                {step < 3 ? (
                    ...
                    <div className="bg-white rounded-2xl shadow-xl max-w-3xl mx-auto p-8 md:p-12 min-h-[500px] flex flex-col justify-center relative">
                        {step > 0 && (
                            <button onClick={handleBack} className="absolute top-8 left-8 text-gray-600 hover:text-gray-600 flex items-center gap-1 text-sm font-semibold">
