    ...
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-8 pt-6 pb-8">
          <nav aria-label="Breadcrumb" className="mb-5">
            <ol className="flex items-center gap-1.5 text-sm text-ink-60 dark:text-gray-300">
              ...
              <li className="text-ink font-medium">Demat Accounts</li>
            </ol>
          </nav>
          ...
          <div className="flex gap-2 overflow-x-auto pb-1 scrollbar-hide">
            {[
              ...
              <Link
                ...
                className={`inline-flex items-center px-4 py-2 text-sm font-medium whitespace-nowrap transition-colors rounded-full ${i === 0 ? "bg-authority-green text-white rounded-full" : "bg-gray-100 text-ink-60 hover:bg-gray-100"}`}
              >
                {p}
              </Link>
            ))}
      ...
      <section className="bg-white border-t-2 border-ink/10 py-10">
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
          <WeeklyChanges category="demat-accounts" />
        </div>
      </section>
