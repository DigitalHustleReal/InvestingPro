...
export const metadata: Metadata = {
  ...
  description:
    "Our editorial standards, content review process, and commitment to transparency and accuracy in financial information.",
};
              ...
              <div className="space-y-4">
                <div className="p-6 md:p-8 bg-gray-50 rounded-lg">
                  <p className="text-sm text-gray-700 mb-3">
                    <strong>Important:</strong> InvestingPro is NOT an AI
                    content generator. We are an authoritative financial
                    comparison and ranking engine. AI is used ONLY as a support
                    tool under strict limitations.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-sm text-gray-600">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        Drafting summaries from verified data (human review
                        required)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="w-4 h-4 text-primary-600 mt-0.5 flex-shrink-0" />
                      <span>
                        FAQ extraction from source documents (human review
                        required)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="w-4 h-4 text-primary-600 mt-0.5 flex-shrink-0" />
                      <span>
                        Metadata generation (titles, descriptions) (human review
                        required)
                      </span>
                    </li>
                  </ul>
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-sm text-gray-600">
                    ...
                    <li className="flex items-start gap-2">
                      <AlertTriangle className="w-4 h-4 text-danger-600 mt-0.5 flex-shrink-0" />
                      <span>
                        Claims of expertise or regulatory registration
                      </span>
                    </li>
                  </ul>
                </div>
            ...
            <CardContent>
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    All data points are verified against source documents with
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    If AI is used for drafting, it must be based on verified
                    data and include citations.
                  </p>
                </div>
                <div>
                  <h3 className="font-semibold text-gray-900 mb-2">
                  ...
                  <p className="text-sm text-gray-600">
                    All content, including AI-generated drafts, must be reviewed
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Content is checked for compliance with informational
                    language requirements and disclaimers.
                  </p>
                </div>
                <div>
                  <h3 className="font-semibold text-gray-900 mb-2">
                  ...
                  <p className="text-sm text-gray-600">
                    Only reviewed and approved content is published. All
                    published content includes data provenance.
                  </p>
                </div>
              </div>
            </CardContent>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-gray-600 mb-2">
                    All content uses informational, educational language. We do
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    We do not claim to be registered investment advisors. All
                    content is clearly marked as informational.
                  </p>
                </div>
              </div>
            </CardContent>
          ...
          <Card className="mb-8">
            ...
            <CardContent>
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="w-4 h-4 text-primary-600 mt-0.5 flex-shrink-0" />
                  <span>Contact us at contact@investingpro.in</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="w-4 h-4 text-primary-600 mt-0.5 flex-shrink-0" />
                  <span>
                    We will investigate and correct verified errors promptly
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="w-4 h-4 text-primary-600 mt-0.5 flex-shrink-0" />
