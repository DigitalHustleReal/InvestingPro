                                ...
                                <Card key={i} className="bg-white/5 backdrop-blur-3xl border-white/10 rounded-[2.5rem] shadow-2xl overflow-hidden group hover:bg-white/10 transition-all cursor-pointer">
                                    <CardContent className="p-6">
                                        <div className="flex items-center justify-between mb-2">
                                            <span className="text-[10px] font-semibold text-gray-600 uppercase tracking-st">{index.name}</span>
                                            {index.isUp ? (
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-16 relative z-20">
                    ...
                    <Card className="rounded-[3rem] border-0 shadow-2xl bg-white dark:bg-gray-900 p-6 md:p-8 group overflow-hidden border border-gray-200 dark:border-gray-800">
                        <div className="flex items-center justify-between mb-8">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h3 className="text-xl font-bold text-gray-900 dark:text-white tracking-tight">Top Gainers</h3>
                                    <p className="text-xs font-bold text-gray-600 dark:text-gray-500 uppercase tracking-widest">Investment Partners</p>
                                </div>
                            </div>
                        ...
                        <div className="space-y-4">
                            {topGainers.map((stock, i) => (
                                <div key={i} className="flex items-center justify-between p-5 bg-gray-50/50 dark:bg-gray-800/50 rounded-2xl border border-transparent dark:border-gray-700 hover:border-primary-100 dark:hover:border-primary-800 hover:bg-white dark:hover:bg-gray-800 transition-all group/item">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <p className="font-bold text-gray-900 dark:text-white">{stock.name}</p>
                                            <p className="text-[10px] font-bold text-gray-600 dark:text-gray-500 uppercase">{stock.sector}</p>
                                        </div>
                                    </div>
                    ...
                    <Card className="rounded-[3rem] border-0 shadow-2xl bg-white p-6 md:p-8 group overflow-hidden">
                        <div className="flex items-center justify-between mb-8">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h3 className="text-xl font-bold text-gray-900 tracking-tight">Top Losers</h3>
                                    <p className="text-xs font-bold text-gray-600 uppercase tracking-widest">Market Laggards</p>
                                </div>
                            </div>
                        ...
                        <div className="space-y-4">
                            {topLosers.map((stock, i) => (
                                <div key={i} className="flex items-center justify-between p-5 bg-gray-50/50 rounded-2xl border border-transparent hover:border-danger-100 hover:bg-white transition-all group/item">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-[10px] font-bold text-gray-600 uppercase">{stock.sector}</p>
                                        </div>
                                    </div>
                                    <div className="text-right">
                ...
                <div className="mb-24">
                    <div className="flex items-center justify-between mb-12">
                        <div>
                            <h2 className="text-4xl font-bold text-gray-900 dark:text-white tracking-tight">IPO Mainboard Pulse</h2>
                            <p className="text-gray-500 font-bold mt-1 text-sm uppercase tracking-widest opacity-60">Live GMP & Subscription Levels</p>
                        </div>
                        <Link href="/calculators">
                            <Button variant="outline" className="rounded-2xl border-gray-200 h-12 px-8 font-semibold text- uppercase tracking-widest">IPO Lot Calculator</Button>
                        </Link>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {ipoLoading ? (
                            ...
                            <Card key={idx} className="rounded-[3rem] border-0 shadow-xl overflow-hidden group hover:shadow-2xl transition-all bg-white dark:bg-gray-900 p-8 border border-gray-200 dark:border-gray-800">
                                <div className="flex justify-between items-start mb-8">
                                    <div className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${ipo.color || 'from-gray-800 to-gray-900'} flex items-center justify-center text-white font-bold text-2xl shadow-lg`}>
                                        {ipo.name.substring(0, 1)}
                                    </div>
                                    <Badge className={`border-0 rounded-xl px-3 py-1 text-[9px] font-bold uppercase tracking-widest ${ipo.status === 'Open' ? 'bg-primary-100 text-primary-700' : 'bg-gray-100 text-gray-600'}`}>
                                        {ipo.status}
                                    </Badge>
                                </div>

                                <h3 className="text-2xl font-bold text-gray-900 mb-2 leading-tight">{ipo.name}</h3>
                                <p className="text-[10px] font-bold text-gray-600 uppercase tracking-widest mb-8">Premium Mainboard Issuer</p>

                                <div className="grid grid-cols-2 gap-6 p-6 bg-gray-50 rounded-3xl mb-8 border border-white">
                                    <div>
                                        <p className="text-[9px] font-semibold text-gray-600 uppercase tracking-st mb-1">Issue Price</p>
                                        <p className="font-semibold text- text-gray-900">{ipo.price}</p>
                                    </div>
                                    <div>
                                        <p className="text-[9px] font-semibold text-gray-600 uppercase tracking-st mb-1">Subscription</p>
                                        <p className="font-semibold text- text-primary-600">{ipo.subscription}</p>
                                    </div>
                                    <div>
                                        <p className="text-[9px] font-semibold text-gray-600 uppercase tracking-st mb-1">Lot Size</p>
                                        <p className="font-semibold text- text-gray-900">{ipo.lot}</p>
                                    </div>
                                    <div>
                                        <p className="text-[9px] font-semibold text-gray-600 uppercase tracking-st mb-1">Listing Date</p>
                                        <p className="font-semibold text- text-gray-900">{ipo.listing}</p>
                                    </div>
                                </div>
                ...
                <div className="mb-24">
                    <div className="flex items-center justify-between mb-12">
                        <div>
                            <h2 className="text-4xl font-bold text-gray-900 tracking-tight">Best Stock Brokers 2024</h2>
                            <p className="text-gray-500 font-bold mt-1 text-sm uppercase tracking-widest opacity-60">Conflict-Free Benchmarking</p>
                        </div>
                        ...
                        {brokersLoading ? (
                            ...
                            <Card key={idx} className="rounded-[3.5rem] border-0 shadow-2xl bg-white overflow-hidden group hover:-translate-y-1 transition-all p-8 lg:p-6 md:p-8">
                                <div className="flex flex-col sm:flex-row items-center gap-8 mb-8">
                                    <div className={`w-20 h-20 rounded-[2rem] bg-gradient-to-br ${broker.color || 'from-gray-800 to-gray-900'} flex items-center justify-center text-white font-bold text-3xl shadow-2xl shrink-0 group-hover:rotate-6 transition-transform`}>
                                        {broker.logo}
                                    </div>
                                    <div className="text-center sm:text-left flex-1">
                                        ...
                                        <div className="flex flex-wrap items-center justify-center sm:justify-start gap-4">
                                            ...
                                            <Badge className="rounded-xl border-gray-100 bg-gray-50 text-gray-600 text-[9px] font-bold uppercase">{broker.bestFor}</Badge>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-2 gap-4 mb-10 p-6 bg-gray-50 rounded-[2.5rem] border border-white">
                                    <div>
                                        <p className="text-[9px] font-semibold text-gray-600 uppercase tracking-st mb-1">Account Opening</p>
                                        <p className="font-extrabold text-gray-900">{broker.pricing?.account_opening || '₹0'}</p>
                                    </div>
                                    <div>
                                        <p className="text-[9px] font-semibold text-gray-600 uppercase tracking-st mb-1">Equity Delivery</p>
                                ...
                                <div className="space-y-4 mb-10 pl-2">
                                    {broker.pros?.slice(0, 3).map((pro: string, pIdx: number) => (
                                        <div key={pIdx} className="flex items-start gap-3">
                                            ...
                                            <span className="text-sm font-bold text-gray-600 leading-tight">{pro}</span>
                                        </div>
                                    ))}
                                </div>
