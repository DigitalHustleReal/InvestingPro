      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="prose prose-slate max-w-none">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-slate-800 mb-3 mt-6">4.1 Account Creation</h3>
            <p className="text-slate-700 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-slate-900 mb-4">7. Affiliate Relationships & Compensation</h2>
            
            <h3 className="text-xl font-semibold text-slate-800 mb-3 mt-6">7.1 Affiliate Disclosure</h3>
            <p className="text-slate-700 mb-4">
            ...
            <h3 className="text-xl font-semibold text-slate-800 mb-3 mt-6">7.2 How We Make Money</h3>
            <p className="text-slate-700 mb-4">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-slate-800 mb-3 mt-6">8.1 Our Content</h3>
            <p className="text-slate-700 mb-4">
            ...
            <h3 className="text-xl font-semibold text-slate-800 mb-3 mt-6">8.2 User-Generated Content</h3>
            <p className="text-slate-700 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-slate-900 mb-4">9. Data Accuracy and Updates</h2>
            <p className="text-slate-700 mb-4">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-slate-800 mb-3 mt-6">14.2 Arbitration</h3>
            <p className="text-slate-700 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-slate-900 mb-4">15. Modifications to Service</h2>
            <p className="text-slate-700 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-slate-900 mb-4">16. Privacy</h2>
            <p className="text-slate-700 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-slate-900 mb-4">18. Contact Us</h2>
            <p className="text-slate-700 mb-4">
              If you have questions about these Terms, please contact us:
            </p>
            <div className="bg-slate-50 p-6 rounded-lg">
              <p className="text-slate-700 mb-2"><strong>InvestingPro</strong></p>
              <p className="text-slate-700 mb-2">Email: <a href="mailto:legal@investingpro.in" className="text-primary-600 hover:text-primary-700 underline">legal@investingpro.in</a></p>
              <p className="text-slate-700 mb-2">Support: <a href="mailto:support@investingpro.in" className="text-primary-600 hover:text-primary-700 underline">support@investingpro.in</a></p>
              <p className="text-slate-700 mb-2">Address: Bangalore, Karnataka, India</p>
            </div>
          </section>
