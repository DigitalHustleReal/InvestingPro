...
const employmentTypes = [
  ...
  },
  {
    ...
    icon: Building2,
    description: "Running a registered business",
  },
];
...
export default function LoanEligibilityPage() {
  ...
  const calculateEligibility = () => {
    ...
    const eligibilityResults: EligibilityResult[] = loans.map((loan) => {
      ...
      const interestRate =
        loan.features?.interest_rate || loan.interest_rate || "10.5% - 16%";
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-white/90 mb-6">
              Check approval probability across 30+ lenders without affecting
              your credit score.
            </p>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto space-y-6">
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                  <div>
                    ...
                    <p className="text-white/80">
                      Requested: {formatCurrency(loanAmount)} | Income:{" "}
                  ...
                  <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 text-center">
                    ...
                    <p className="text-4xl font-black">
                      {formatCurrency(results[0]?.maxAmount || 0)}
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            <Card className="rounded-2xl">
              <CardContent className="p-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
                    {getFactorIcon(
                      results[0]?.factors.creditScore || "neutral",
                    )}
                    <div>
            ...
            <div className="space-y-4">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white">
                Matching Loans (
                {results.filter((r) => r.probability >= 50).length} High
                Probability)
              </h3>
