                                    ...
                                    <div className="divide-y divide-white/5">
                                        {articles.map((article: any) => (
                                            <button
                                                ...
                                                className={cn(
                                                    "w-full text-left px-6 py-4 hover:bg-card/50 dark:bg-card/50 transition-colors flex items-center justify-between gap-4",
                                            ...
                                            >
                                                ...
                                                <Search className="w-4 h-4 text-muted-foreground/70 dark:text-muted-foreground/70 flex-shrink-0" />
                                            </button>
                                        ))}
                                    </div>
                                ) : (
                    ...
                    <div className="lg:col-span-7">
                        {selectedArticleId ? (
                            <div className="space-y-4">
                                <div className="flex items-center justify-between">
                                    <h3 className="text-sm font-bold uppercase tracking-widest text-muted-foreground dark:text-muted-foreground">
                                        Analysis Results
                                    </h3>
                                    <Button
                                        size="sm"
                            ...
                            <div className="h-full flex items-center justify-center">
                                <div className="text-center">
                                    <Search className="w-12 h-12 mx-auto text-muted-foreground/50 dark:text-muted-foreground/50 mb-4" />
                                    <h3 className="text-lg font-bold text-muted-foreground dark:text-muted-foreground mb-2">
                                        Select an Article
                                    </h3>
                                    <p className="text-sm text-muted-foreground/70 dark:text-muted-foreground/70 max-w-xs">
