            ...
            <div className="p-8 space-y-8">
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-slate-400">Monitor and manage the AI-powered content management system</p>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                    ...
                    <Card className="bg-white/[0.03] border-white/5">
                        <CardContent className="p-6">
                            ...
                            <p className="text-sm font-medium text-slate-400 mb-1">Budget Status</p>
                        ...
                        <Card className="bg-white/[0.03] border-white/5 hover:border-primary-500/30 transition-all cursor-pointer">
                            <CardContent className="p-6">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <h3 className="font-bold text-white mb-1">Budget Management</h3>
                                        <p className="text-sm text-slate-400">Configure spending limits</p>
                                    </div>
                                </div>
                            </CardContent>
                        </Card>
                            ...
                            <CardContent className="p-6">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-slate-400">Generate articles</p>
                                    </div>
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="bg-white/[0.03] border-white/5 hover:border-primary-500/30 transition-all cursor-pointer">
                            <CardContent className="p-6">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <h3 className="font-bold text-white mb-1">Health Monitor</h3>
                            ...
                            <CardContent className="p-6">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-slate-400">Manage data scrapers</p>
                                    </div>
                                </div>
                            </CardContent>
                        </Card>
