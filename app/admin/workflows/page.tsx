...
export default function WorkflowsPage() {
  ...
  const getTriggerColor = (type: string) => {
    const colors: Record<string, string> = {
      ...
      webhook: "bg-emerald-500/20 text-emerald-400",
    };
          ...
          <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6 p-8">
            <div className="flex items-center gap-6">
              ...
              <div>
                ...
                <p className="text-gray-300 max-w-md">
                  Automate content operations and pipeline routing with premium
                  AI logic.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              <Button
                onClick={() => refetch()}
                variant="outline"
                className="bg-white/5 border-amber-500/20 text-amber-500 hover:bg-amber-500/10"
              >
            ...
            <Button
              ...
              className={cn(
                ...
                filter === f
                  ...
                  : "border-amber-500/20 text-gray-300 hover:text-amber-500",
              )}
            >
            ...
            {isLoading ? (
              ...
              <div className="text-center py-20">
                ...
                <p className="text-gray-300 mb-6 text-lg">
                  No active workflows orchestration found
                </p>
                <Link href="/admin/workflows/new">
                            ...
                            <div className="flex items-center gap-4 text-sm">
                              <Badge
                                className={cn(
                                  ...
                                  getTriggerColor(workflow.trigger_type),
                                )}
                              >
                        ...
                        <div className="flex items-center gap-2 ml-4">
                          {workflow.trigger_type === "manual" && (
                            <Button
                              ...
                              disabled={
                                runMutation.isPending || !workflow.is_enabled
                              }
                          ...
                          <Link href={`/admin/workflows/${workflow.id}`}>
                            <Button
                              variant="outline"
                              size="sm"
                              className="bg-white/5 border-gray-700 text-gray-300 hover:bg-white/10 h-9"
                            >
        ...
        <div className="mt-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              >
                <h4 className="font-bold text-white mb-2 group-hover:text-amber-500">
                  {template.name}
                </h4>
                ...
                <Badge
                  className={cn(
                    "border-none",
                    getTriggerColor(template.trigger),
                  )}
                >
...
function StatBox({ label, value, icon: Icon, color }: any) {
  const colors: Record<string, string> = {
    ...
    teal: "text-green-400 bg-green-400/10",
  };
