                    ...
                    <Card className="bg-danger-500/10 border-danger-500/30 mb-6">
                        <CardContent className="p-4">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <h4 className="font-medium text-danger-400 mb-1">Please fix the following:</h4>
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center gap-3">
                                        <input
                                            ...
                                            className="flex-1"
                                        />
                                        <span className="text-sm text-muted-foreground w-8">{priority}</span>
                                    </div>
                                ...
                                <div>
                                    <label className="flex items-center gap-2">
                                        <input
                                            ...
                                            className="rounded"
                                        />
                                        <span className="text-sm text-foreground">Enable workflow immediately</span>
                                    </label>
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="bg-primary-500/10 border-primary-500/20">
                            <CardContent className="p-4">
                                ...
                                <ul className="text-sm text-muted-foreground space-y-2">
                                    ...
                                    <li>• <strong>Conditions</strong>: Filter when to run (optional)</li>
                                    <li>• <strong>Actions</strong>: What to do when triggered</li>
