            ...
            return [
                {
                    ...
                    anomalies: [
                        { type: 'compliance_risk', severity: 'medium', message: 'Missing disclaimer', requiresReview: true }
                    ],
                ...
                },
                {
                    ...
                    anomalies: [
                        { type: 'sensitive_content', severity: 'high', message: 'Regulatory', requiresReview: true }
                    ],
