                ...
                <ContentSection>
                    <div className="relative max-w-md">
                        ...
                        <input
                            ...
                            className="w-full pl-10 pr-4 py-2.5 bg-slate-800/50 border border-white/10 rounded-lg text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-amber-500/50"
                        />
                    </div>
                </ContentSection>
                                    ...
                                    {filteredTags.map((tag) => {
                                        ...
                                        return (
                                            <tr key={tag.id} className="group hover:bg-white/5 transition-colors">
                                                ...
                                                <td className="px-4 py-4">
                                                    {usage > 0 ? (
                                                        <span className="inline-flex items-center gap-1 px-2 py-1 rounded-lg text-xs font-medium bg-teal-500/20 text-teal-400 border border-teal-500/30">
                ...
                <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
                    <DialogContent className="bg-slate-900 border-slate-700 text-white">
                        ...
                        <DialogFooter className="gap-2">
                            ...
                            <button onClick={handleCreate} className="px-4 py-2 bg-amber-500 hover:bg-amber-600 text-white rounded-lg text-sm">Create</button>
                        </DialogFooter>
                    </DialogContent>
                </Dialog>
                ...
                <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
                    <DialogContent className="bg-slate-900 border-slate-700 text-white">
                        ...
                        <DialogFooter className="gap-2">
                            ...
                            <button onClick={handleUpdate} className="px-4 py-2 bg-amber-500 hover:bg-amber-600 text-white rounded-lg text-sm">Update</button>
                        </DialogFooter>
                    </DialogContent>
                </Dialog>
