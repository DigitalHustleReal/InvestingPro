            ...
            <div className="h-full flex flex-col px-10 py-8">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8 border-b border-white/5 pb-8 mt-4">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        >
                            <option value="overall" className="bg-slate-900">Overall Rank</option>
                            <option value="revenue" className="bg-slate-900">Revenue</option>
                            <option value="articles" className="bg-slate-900">Article Count</option>
                            <option value="quality" className="bg-slate-900">Quality Score</option>
                        </select>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {isLoading ? (
                        <div className="col-span-full p-20 text-center text-slate-400">Loading authors...</div>
                    ) : personas.length === 0 ? (
                        ...
                        personas.map((persona: AIPersona) => (
                            <Card key={persona.id} className="bg-white/[0.03] border-white/5 hover:border-primary-500/30 transition-all group">
                                ...
                                <CardContent className="p-6 space-y-4">
                                    {/* Bio */}
                                    <div>
                                        <p className="text-xs text-slate-500 font-bold uppercase tracking-wider mb-2">Bio</p>
                                    ...
                                    {/* Specialization */}
                                    <div>
                                        <p className="text-xs text-slate-500 font-bold uppercase tracking-wider mb-2">Specialization</p>
                                        <div className="flex flex-wrap gap-2">
                                            ...
                                            )) || <span className="text-xs text-slate-500">No specialization</span>}
                                        </div>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-2 gap-3 pt-4 border-t border-white/5">
                                        <div className="text-center p-3 bg-white/[0.02] rounded-xl">
                                            <div className="text-2xl font-bold text-white">{persona.total_articles_published}</div>
                                            <div className="text-[10px] text-slate-500 uppercase tracking-wider mt-1">Published</div>
                                        </div>
                                        <div className="text-center p-3 bg-white/[0.02] rounded-xl">
                                            <div className="text-2xl font-bold text-success-400">₹{persona.total_revenue?.toLocaleString() || 0}</div>
                                            <div className="text-[10px] text-slate-500 uppercase tracking-wider mt-1">Revenue</div>
                                        </div>
                                        <div className="text-center p-3 bg-white/[0.02] rounded-xl">
                                            <div className="text-lg font-bold text-primary-400">{persona.avg_quality_score?.toFixed(1) || 0}</div>
                                            <div className="text-[10px] text-slate-500 uppercase tracking-wider mt-1">Quality</div>
                                        </div>
                                        <div className="text-center p-3 bg-white/[0.02] rounded-xl">
                                            <div className="text-lg font-bold text-accent-400">{persona.avg_seo_score?.toFixed(1) || 0}</div>
                                            <div className="text-[10px] text-slate-500 uppercase tracking-wider mt-1">SEO</div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center justify-between pt-4 border-t border-white/5">
                                        <div className="text-center">
                                            ...
                                            <div className="text-sm font-bold text-white">#{persona.revenue_rank}</div>
                                        </div>
                                        <div className="text-center">
                                            <div className="text-xs text-slate-500 uppercase tracking-wider mb-1">Articles</div>
                                            <div className="text-sm font-bold text-white">#{persona.article_count_rank}</div>
                                        </div>
                                        <div className="text-center">
                                            <div className="text-xs text-slate-500 uppercase tracking-wider mb-1">Quality</div>
                                            <div className="text-sm font-bold text-white">#{persona.quality_rank}</div>
                                        </div>
                                    </div>
