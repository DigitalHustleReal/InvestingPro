                        ...
                        {[...Array(5)].map((_, i) => (
                            <div key={i} className="flex items-center gap-4 py-3 border-t border-slate-50">
                                ...
                                <div className="flex-1 space-y-2">
                                    <div className="h-4 bg-slate-200 rounded animate-pulse" style={{ width: `${40 + Math.random() * 30}%` }} />
                                    <div className="h-3 bg-slate-50 rounded animate-pulse" style={{ width: `${30 + Math.random() * 20}%` }} />
                                </div>
