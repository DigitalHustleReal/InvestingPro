              ...
              <div className="flex gap-4">
                {author.social.twitter && (
                  <a
                    ...
                    className="p-2 rounded-full bg-gray-100 dark:bg-gray-800 text-gray-500 hover:text-primary-600 hover:bg-primary-50 transition-colors"
                  >
          ...
          <div className="lg:col-span-4 space-y-8">
            ...
            <Card className="border-gray-200 dark:border-gray-800 shadow-sm">
              <CardContent className="p-6 space-y-8">
                {/* Expertise */}
                <div>
                  <h3 className="text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-300 mb-4">
                    Areas of Expertise
                  </h3>
                ...
                <div>
                  ...
                  <ul className="space-y-4">
                    {author.experience.map((exp, i) => (
                      ...
                      >
                        <span className="text-gray-700 dark:text-gray-200 block font-medium">
                          {exp.split(",")[0]}
                        </span>
            ...
            <Card className="bg-primary-600 text-white border-none">
              <CardContent className="p-6">
                ...
                <h3 className="font-bold text-lg mb-2">
                  Get {author.name.split(" ")[0]}'s Best Tips
                </h3>
                <p className="text-primary-100 text-sm mb-4">
                  Get {author.name.split(" ")[0]}'s weekly financial breakdown
                  delivered free.
                </p>
