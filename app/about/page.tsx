...
export default async function AboutPage() {
  ...
  const members = teamMembers || [
    { name: 'Shiv Pratap', role: 'Founder & CEO', slug: 'shiv-pratap', avatar: null },
    { name: 'Rohan Sharma', role: 'Head of Research', slug: 'rohan-sharma', avatar: null },
  ];
    ...
    <div className="flex flex-col min-h-screen bg-slate-50 dark:bg-slate-950">
      ...
      <section className="py-24 bg-primary-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-5xl font-extrabold mb-8 tracking-tight">Join the Revolution in Personal Finance</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/credit-cards">
              <Button size="lg" variant="outline" className="w-full sm:w-auto border-white text-white hover:bg-white/10 font-bold px-8 h-12">
                Explore Products
              </Button>
            </Link>
          </div>
