...
import ProductScoreBadges, { calculateProductTags } from '@/components/products/ProductScoreBadges';
  ...
  it('renders correct number of badges respecting maxBadges', () => {
    const { container } = render(
      <ProductScoreBadges
        ...
        tags={['Best for Travel', 'Top for Shopping', 'Lifetime Free', 'Low Cost Gem']}
        maxBadges={2}
      />
    );
